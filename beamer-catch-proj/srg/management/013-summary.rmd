...
* Projections strongly influenced by size of the above-average 2021 and 2022
  cohorts, but data suggests a large 2023 cohort as well which is not accounted
  for in this model (slide 10)
...
* There is `r prob_decl_yr1_zero_catch`% chance that spawning biomass will
  ...
  and >99% chance of decline for all other catch streams (slide 15)
