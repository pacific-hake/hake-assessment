...
* March `r last_assess_yr`
  ...
  - TAC implemented by management was `r last_yr_tac` t
\item[]
* When Default HR suggests a large catch, the TAC implemented by management
  is often set less
\item[]
* In the last 10 years, attainment of the TAC was lowest in `r rng_tac_catch_yr_lo`
  at `r rng_tac_catch_txt[1]`% and highest in `r rng_tac_catch_yr_hi` at
  `r rng_tac_catch_txt[2]`%
:::
