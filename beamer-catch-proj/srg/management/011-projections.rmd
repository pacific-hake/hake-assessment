...
* Single projection year, to the start of `r end_yr + 1`
...
* Alternative catch levels for `r end_yr` explored
...
**\text{\small 2025 age data is not included in the model so age 2's seen in data are not represented}**
