...
## Explanation for not Extending
* Data from both the fishery and acoustic survey are complimentary to provide a more informative representation of the population. Including the 2025 fishery age compositions without including the 2025 survey biomass estimate (and age compositions) risks introducing biases. In recent years, a tension has been observed between fishery age composition data (suggesting high recruitment from shifts to large proportions of young fish) and the acoustic survey biomass index (suggesting decreasing overall biomass). 
\item[]
