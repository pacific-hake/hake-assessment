...
d<- tibble(month = c("May", "Jun", "Jul", "Aug", "Sep", "Oct", "Total"),
           num_age = c(250, 135, 0, 0, 0, 170, ),
           num_length = c(507, 269, 0, 0, 0, 541, ),
            num_weight = c(507, 269, 0, 0, 0, 266, ))
...
d <- tibble(month = c("May", "Jun", "Jul", "Aug", "Sep", "Oct", "Total"),
            num_age = c(0, 134, 164, 177, 150, 38, 0),
            num_length = c(0, 266, 311, 319, 276, 64, 0),
            num_weight = c(0, 266, 311, 319, 276, 64, 0))
table_sampling_by_month(d,
                        font_size = 8,
                        header_font_size = 9)
```
