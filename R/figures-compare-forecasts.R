...
#' Plots several forecasts against each other
#'
#' @param model The model for which mcmc runs with different forecasts have been made
#' @param models.inds A vector of model indices for the forecast models you want to
...
#' @return The plot
#' @export
make.forecast.depletion.comparison.plot <- function(model,
                                                    models.inds,
                                                    models.names,
                                                    start_yr,
                                                    model.end.yr,
