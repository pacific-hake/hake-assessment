...
table_reference_points <- function(model,
  ...
  descr <- c("Unfished female spawning biomass ($\\Bzero$, kt)",
             "Unfished recruitment ($\\Rzero$, millions)",
             paste0("Reference points (equilibrium) based on ",
                    "$\\bm{\\FSPRforty}$"),
             "Female spawning biomass at $\\FSPRforty$ ($\\BSPRforty$, kt)",
             "SPR at $\\FSPRforty$",
             "Exploitation fraction corresponding to $\\FSPRforty$",
             "Yield associated with $\\FSPRforty$ (kt)",
             paste0("Reference points ",
                    "(equilibrium) based on $\\bm{\\Bforty}$ ",
                    "(40\\% of $\\bm{\\Bzero}$)"),
             "Female spawning biomass ($\\Bforty$, kt)",
             "SPR at $\\Bforty$",
