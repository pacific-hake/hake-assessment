...
# source(here::here("R/all.R"));source(here::here("doc/load-models.R"));source(here::here("R/custom-knitr-variables.R"))
...
src_lst <- c("utilities.R", "add-alt-text.R", "catches.R",
             ...
             "fetch-forecasts.R", "calc-risk.R", "table-param-est.R")
source_all(src_lst)
