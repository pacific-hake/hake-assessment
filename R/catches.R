...
#' Make summary of catch for given country for Executive Summary (can combine
#' with above one at some point, just need the options)
#'
#' @param ct Output from [load_catches()]
#' @param country 1 for Canada, 2 for US, anything else for both
#' @param start_yr Start year in table
...
#' @return An [xtable::xtable()]
#' @export
make_catch_table_es <- function(ct,
                             country = 3,
                             start_yr,
                             end_yr,
                             xcaption = "default",
