...
## Assessment cycle (January - March)

* Model runs are done on an Ubuntu 22.04 LTS server with 80 Xeon Gold CPUs
  and 404 GB of RAM.

* All model runs, including the base, bridging, sensitivities, and
  retrospectives, are run using the **main** branch of the
...
### Server setup for the hake assessment
...
* TexLive version: 2025 (tlmgr revision 75204 (2025-05-13 23:48:24 +0200))
