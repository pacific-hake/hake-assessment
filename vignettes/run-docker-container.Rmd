...
1. You must link the directory on your computer from the download with the
   ...
   type this to get your name: `echo $USERNAME`. Change your name to what
   was printed by the `echo` command in the `if` statement.
...
1. Once the Docker Bash terminal starts, it will update the hake repository
   ...
   - In the Bash terminal, run the folowing command:
