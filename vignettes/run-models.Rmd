...
described here as the *base model* as that is the usual case.
...
steps concurrently (for example numbers 2 & 3 can be done at the same time in
two different `Bash` sessions, as can 4 & 5):
