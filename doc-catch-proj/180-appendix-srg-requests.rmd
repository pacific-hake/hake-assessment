...
(ref:srg-catch-by-month-alt) The figure shows the catch by month for all sectors
...
cap <- paste0("Canadian sampling by month for ", last_data_yr, " in the Freezer trawler fleet")
...
cap <- paste0("Canadian sampling by month for ", last_data_yr, " in the Shoreside fleet.")
...
d <- tibble(month = c("April", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Total"),
            ...
            num_length = c(6, 258, 480, 680, 680, 640, 508, 60, 3323),
            num_weight = c(6, 167, 420, 560, 560, 490, 448, 40, 2708))
...
(ref:srg-age-comp-forecast-cap) Vulnerable projected age compositions for `r assess_yr`. The left panel shows the proportions by number; the right panel shows the proportions by weight. Selectivity for `r assess_yr` was not available in the model output so `r last_data_yr` was used instead.

(ref:srg-age-comp-forecast-alt) This figure shows that age 5 and 6 fish will be dominant in the stock in `r assess_yr`

```{r srg-age-comp-forecast-fig, fig.cap = "(ref:srg-age-comp-forecast-cap)", fig.height = 4, fig.asp = 0.8, out.height = "4in"}
...
**SRG request**:
Present two new time series tables of spawning biomass, age 2+ biomass and other quantities as in Table 23 from the 2025 assessment. The first should be base case with stochastic recruitment and the second table is base model with no additional variance on the survey.

**Justification:**
No official justification given.

#### Request Results:

```{r srg-sens1-median-posterior-2026-tab, results = "asis", echo = FALSE}
...
table_median_posteriors(
  ...
  end_yr = end_yr,
  digits = 1,
  caption = "Time series of median posterior population estimates from the model with stochastic
recruitment in the projection year.",
  font_size = 8,
  header_font_size = 9,
  longtable = TRUE)
```

```{r srg-sens3-median-posterior-2026-tab, results = "asis", echo = FALSE}
...
table_median_posteriors(
  ...
  end_yr = end_yr,
  digits = 1,
  caption = "Time series of median posterior population estimates from the model with no additional
variance on the survey.",
  font_size = 8,
  header_font_size = 9,
  longtable = TRUE)
```
