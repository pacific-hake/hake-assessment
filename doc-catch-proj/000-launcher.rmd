...
output:
 hake_pdf:
   ...
   figures_dir: "../doc/image-files"
   title_page_image: "../doc/image-files/hake-line-drawing.png"
   ...
   footer_right: "DRAFT - Do not circulate"  # did not show up in 2026
   # footer_right: " " 
...
bibliography: ../doc/bib/refs.bib # Do not modify
csl: ../doc/csl/csas.csl # Do not modify
---
...
^2^ *Northwest Fisheries Science Center, National Marine
...
^4^ *Office of Science and Technology, National Marine Fisheries
  Service, National Oceanic and Atmospheric Administration, U.S.~Department of
...
Edwards, A.M., A.M. Berger, C.J. Grandin, C.R. Wetzel, Johnson, K.F., and K.L. Oken.
