...
- The stock assessment for `r assess_yr` uses the model and parameter estimates
  ...
  `r assess_yr` using the coast-wide fishery catch from `r last_data_yr`. Unlike the
  usual `r sp` stock assessment, there is no updated fitting of the model to data. 

- This was done because the biomass estimate and age data from the 2025 Joint 
...
- The `r last_assess_yr` model was fit to an acoustic survey index of biomass,
  ...
  which informed fecundity. Available data for `r last_data_yr`, such as from
  the commercial fishery, are presented here for information.
...
change of falling below  `r b_40` at the start of
