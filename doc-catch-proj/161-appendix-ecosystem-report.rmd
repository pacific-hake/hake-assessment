...
current recruitment estimates are unchanged from the 2025 assessment, we omit
them from the figures. This highlights that the stock assessment model has no
...
\begin{itemize}
  ...
  \item For 2026 the was not refit to new data, but rather based on the
...
Climate, ocean, and ecological indicators suggest that ocean productivity was
