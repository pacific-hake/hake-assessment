...
Contributed by Mary E. Hunsicker and Andrew M. Edwards
...
information, and what is presented here is not exhaustive. This approach was
introduced in the 2025 stock assessment [@JTC2025], and is updated here.
It should be considered as an incrementally-improving operational
(updatable and expanded upon every year) hake-specific ecosystem summary.
...
California, Santa Cruz Regional Ocean Modeling System (ROMS) hindcast. In 2025 we conducted a preliminary update using
...
Overall, this resulted in 11 ecosystem indices described in
Table~\@ref(tab:app-ecosystem-report-indicators-tab) that have been found
previously to correlate with recruitment deviations of `r sp`. These include three of the five indices included in
...
calculated from updated results [@DFO2025] of the stock assessment, which is conducted using
...
Malick, pers.~comm.), though 2025 values are not yet available.
...
The Pacific Herring, PDO and NPGO variables all have an extra year of
values compared to those shown in the 2025 `r sp` stock assessment [@JTC2025].

The estimates of age-1 `r sp` are taken from the current assessment model. Since
the current base model did not involve updated data, the recruitment estimates
are unchanged from the 2025 base model, and so the index of age-1 `r sp` is the
same as for the 2025 assessment.

The six further indices were calculated for the 2025 stock assessment from
GLORYS outputs by K.~Marshall, with assistance of several colleagues in the
extraction of model results, wrangling, and analysis. 
For 2026 we have streamlined the process of obtaining outputs from GLORYS, such
that three of the GLORYS products used here can now be extracted purely using R
code (soon to be available in pacea), rather than requiring use of a more
complex python and R setup
(thanks to Megan Feddern, Nick Tolimieri, and Eric Ward, all NOAA, for sharing their code
for this). Thus, three indices are updated this year (namely 
TEMP$_{\mbox{spawn}}$,
MLD$_{\mbox{yolk}}$, and 
MLD$_{\mbox{latelarv}}$), 
with the other three anticipated to be updatable for future assessments.
...
competition effect (not a predator-prey effect as originally hypothesised, based
...
In the analogous figures in the 2025 `r sp` stock assessment we showed
recruitments for recent years (specifically 2023, 2024, and 2025). But in
hindsight these should not be shown because they were not fit to data and so just
represented median hake recruitment with no recruitment deviations. Given our
current recruitment estimates are based on those from the 2025 assessment, we omit
the recent years from the figures. This highlights that the stock assessment model has no
information on recruitment in those years (whereas relevant ecosystem
information is available) and motivates continued investigation
into potential drivers of recruitment. 

We have not yet conducted further analyses on these time series, but present them as
an updated attempt to compile varied ecosystem information into single figures that
can
...
an up-to-date index of this was not easily available, though should be for next
year (in collaboration with Wei Cheng, NOAA).
...
```{r app-ecosystem-summary-from-pacea-fig, fig.cap = "(ref:app-ecosystem-summary-from-pacea-cap)", results = "asis", fig.width = 6, out.width = "6in", fig.height = 8, out.height = "8in"}
...
```{r app-ecosystem-summary-from-glorys-fig, fig.cap = "(ref:app-ecosystem-summary-from-glorys-cap)", results = "asis", fig.width = 6, out.width = "6in", fig.height = 8, out.height = "8in"}
...
Climate, ocean, and ecological indicators suggest that ocean productivity off
California was
near to above average in 2025. The ecosystem experienced a mild La Niña in
winter and spring, strong and consistent upwelling from winter through summer,
and cool coastal water temperatures throughout much of the year. A strong marine
heatwave caused widespread warmer-than-normal surface temperatures in offshore
waters during the summer, that moved onshore in the late summer and
fall. However, the anomalously warm temperatures are not reflected in the
ecological indices. The biomass of lipid-rich northern copepods and indicators
of krill abundance were near to above average levels in the central and northern
regions of the California Current. Overall, environmental conditions in winter
and spring were likely favorable for hake productivity in summer and
fall. Observations of larval hake off southern California remained above average
from 2021 to 2025 and juvenile hake from central California were near or above
average over the same period. 

In 2026, the ecosystem is expected to remain neutral with respect to El Niño
conditions through summer. However, warmer-than-average temperatures are still
prevalent along the coast and a marine heatwave is forecasted to continue in
offshore waters until early spring. It is uncertain whether these conditions will
negatively impact hake recruitment. 

**Hake distribution**

Seasonal forecasts of hake distribution in the northern region of the California
Current Ecosystem [@MalickHunsickerEtAl2020] were not available at the time of writing
this summary, however these temperature-driven forecasts will be presented at
the 2026 SRG meeting. Given what we know about the influence of temperature on
hake distribution and the role of temperature as a proxy for prey availability
[@MalickHunsickerEtAl2020; @Phillips2022],
we would have expected a normal
extent of the northern migration of hake in the spring of 2025 as feeding
conditions were favorable in the central and northern regions of the California
Current. 

**Predators and prey**

`r sp` are common in many predators' diets (e.g., Bluefin Tuna, Swordfish,
...
has been well above average in recent years, with record high levels of hake in
bluefin diets in 2024. 
The spawning biomass of these
species has increased over this period as well (Leising et al., in prep).

However, indices of prey abundance have been
favorable over the past few years. Krill is a
dominant diet item for juvenile and adult hake
[@WippelEtAl2017; @Phillips2022; @BizzarroEtAl2023]. 
The CCIEA regional indicators show that krill has been abundant in
the central CCE in recent years, and increased in waters off Oregon, Washington,
and British Columbia in 2026 compared to lower abundances in those regions in
2021 and 2023. 
