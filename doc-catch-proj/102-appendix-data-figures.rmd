...
```{r main-catches-fig, fig.cap = "(ref:main-catches-cap)", fig.asp = 0.8, out.height = "4in"}
...
```{r main-us-depths-fig, fig.cap = "(ref:main-us-depths-cap)", fig.asp = 0.8, out.height = "4in"}
...
```{r main-can-depths-fig, fig.cap = "(ref:main-can-depths-cap)", fig.asp = 0.8, out.height = "5in"}
