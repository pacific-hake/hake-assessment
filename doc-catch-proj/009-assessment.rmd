...
10--14th, 2024, as a virtual meeting.

The following are the 'SRG Recommendations and Conclusions for the Stock
Assessment' from the 2025 SRG report and the associated responses from the
JTC:
...
*Response -- The recommended set of sensitivity model runs were not applicable for the 2026 base model, which is based soley on a projection of the 2025 base model where the realized total catch in 2025 is specifically used. The standard set of senstivity model runs will be incorporated into next year's stock assessment.*
...
*Sensitivity analyses using alternative input sample sizes, following the
Stewart and Hamel (2014) approach, will continue to be evaluated in subsequant full assessments.*
