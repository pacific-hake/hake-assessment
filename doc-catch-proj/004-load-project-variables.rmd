...
ct_limit_quantiles <- f(as.numeric(quantile(base_model$mcmc[[paste0("ForeCatch_",
                                                                    assess_yr)]],
                                            probs = probs)))
...
perc_diff_catch_last_10_yrs <- f((1 - (ct_last1 |> pull(Total)) / mean(ct_last_10yrs$Total)) * 100)
