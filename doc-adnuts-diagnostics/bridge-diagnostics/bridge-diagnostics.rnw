%% bridge-diagnostics.Rnw. Diagnostics for the bridge models.
%% Pacific Hake Joint technical committee.
%% knitr::knit("bridge-diagnostics.rnw")
...
%%  just deleting the knitr-cache-bridge/ folder doesn't always seem to fix it,
...
opts_chunk$set(
             ...
             comment = "#>",
             results = 'hide',
             fig.path = 'knitr-cache-bridge/',
             cache.path = 'knitr-cache-bridge/',
             cache = TRUE)
...
\title{Diagnostics plots of ADNUTS results for bridging models for the \Sexpr{assess_yr} \fishname\ (whiting) stock assessment
%% Uncomment for DRAFT:
...
\lfoot{Bridge diagnostics -- hake \Sexpr{assess_yr}}

\rfoot{Introduction}
\chapter{Introduction}
\label{chap:introduction}

This document automatically generates the MCMC diagnostic plots for the bridging
...
if(!(length(bridge_models_1) == 5 &
     length(bridge_models_2) == 2
     )
   ){ stop("Need to update diagnostic.model in bridge-diagnostics.rnw")
  }
...
diagnostic.model <- c("bridge_models_1[[1]]",
                      "bridge_models_1[[2]]",
                      "bridge_models_1[[3]]",
                      "bridge_models_1[[4]]",
                      "bridge_models_1[[5]]",
