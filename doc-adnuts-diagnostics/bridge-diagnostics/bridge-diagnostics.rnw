...
\title{Diagnostics plots of ADNUTS results for bridging models for the \Sexpr{assess.yr} \fishname\ (whiting) stock assessment
%% Uncomment for DRAFT:
...
\lfoot{Bridge diagnostics -- hake \Sexpr{assess.yr}}
