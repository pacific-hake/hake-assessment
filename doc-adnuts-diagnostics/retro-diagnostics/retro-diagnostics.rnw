...
\title{Diagnostics plots of ADNUTS results for retrospective models for the \Sexpr{assess.yr} \fishname\ (whiting) stock assessment
%% Uncomment for DRAFT:
...
\lfoot{Retro diagnostics -- hake \Sexpr{assess.yr}}
