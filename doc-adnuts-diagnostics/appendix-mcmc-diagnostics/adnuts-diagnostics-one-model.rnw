...
\caption{Posterior correlations among recruitment deviations from recent years
  and mean unfished equilibrium recruitment. Numbers refer to the absolute correlation
