...
# TODO:
# maybe switch to .eps since quicker?
# see make.mcmc.diag.plot:   m <- ....  - put a check in each call here to see if
#  posterior.regex column exists
# Do right footers here
...
make.mcmc.diag.plot(this.model, key.posteriors[1], key.posteriors.titles[1])
make.mcmc.diag.plot(this.model, key.posteriors[2], key.posteriors.titles[2])
par <- oldpar
@
\end{center}
...
par(mar=c(4.1, 4.1, 3.1, 0.1))
layout(matrix(c(1,2), nrow = 2, ncol = 1, byrow=TRUE))
make.mcmc.diag.plot(this.model, key.posteriors[3], key.posteriors.titles[3])
make.mcmc.diag.plot(this.model, key.posteriors[4], key.posteriors.titles[4])
par <- oldpar
@
\end{center}
...
par(mar=c(4.1, 4.1, 3.1, 0.1))
layout(matrix(c(1,2), nrow = 2, ncol = 1, byrow=TRUE))
make.mcmc.diag.plot(this.model, key.posteriors[5], key.posteriors.titles[5])
make.mcmc.diag.plot(this.model, key.posteriors[6], key.posteriors.titles[6])
par <- oldpar
@
\end{center}
...
make.mcmc.diag.hists.plot(this.model,
                          labelstrings = "all")
@
\end{center}
