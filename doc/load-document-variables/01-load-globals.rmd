...
sp <- rmarkdown::metadata$`params`$sp
assess_yr <- rmarkdown::metadata$`params`$assess_yr
last_assess_yr <- rmarkdown::metadata$`params`$last_assess_yr
model_version <- rmarkdown::metadata$`params`$model_version
last_yr_model_version <- rmarkdown::metadata$`params`$last_yr_model_version
