...
us_last_yr_age_shore <-
  us_last_yr_age_shore[order(unlist(us_last_yr_age_shore[1, , drop = TRUE]), decreasing = TRUE)]
us.age.1.prop.age.shore <- as.numeric(gsub("^a", "", names(us_last_yr_age_shore)[1]))
us.age.1.prop.shore <- f(us_last_yr_age_shore[1] * 100, 1)
us.age.2.prop.age.shore <- as.numeric(gsub("^a", "", names(us_last_yr_age_shore)[2]))
us.age.2.prop.shore <- f(us_last_yr_age_shore[2] * 100, 1)
us.age.3.prop.age.shore <- as.numeric(gsub("^a", "", names(us_last_yr_age_shore)[3]))
us.age.3.prop.shore <- f(us_last_yr_age_shore[3] * 100, 1)
us.age.4.prop.age.shore <- as.numeric(gsub("^a", "", names(us_last_yr_age_shore)[4]))
us.age.4.prop.shore <- f(us_last_yr_age_shore[4] * 100, 1)
