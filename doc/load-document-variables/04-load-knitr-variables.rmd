...
\newcommand{\Fforty}{\mathrm{F}_{\text{SPR}=40\%}}
\newcommand{\BSPRforty}{\mathrm{B}_{\text{SPR}=40\%}}
\newcommand{\Ffortyten}{$\Fforty$--40:10}
\newcommand{\FishingRate}{(1 - $\mathrm{SPR(F)}$)/(1 - $\mathrm{SPR_{40\%}}$)}
...
\newcommand{\Bmsy}{\mathrm{B}_{\text{MSY}}}
\newcommand{\Fmsy}{\mathrm{F}_{\text{MSY}}}
\newcommand{\Fspr}{\mathrm{F}_{\text{SPR}}}
