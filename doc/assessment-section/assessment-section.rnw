...
\emph{Response -- The JTC agreed with the SRG recommendation to calculate spawning
  ...
  Historical weight-at-age data was re-examined to ensure that all relevant data,
  ...
  Regarding the assumption of pre-1975 weight-at-ages, the JTC conducted an analysis
  ...
  with age-4, 13, and 14 being slightly positive and all others being slighty negative
  (Figure Here?), which wasn't unexpected given the large amount of inter-annual variability
  ...
  Regarding forecast year weight-at-ages, the JTC used the weighted
  ...
  During the 2018 SRG meeting it was further realised that: ``An inconsistency
  ...
  Several alternative weight-at-age (and time-varying fecundity) data configurations
  ...
  Regarding evaluating other methods of deriving biological reference points
...
(Figure~\ref{fig:main-recruit-base-tv-increase-1}) and provides the worst
fit to the recent survey biomass estimates
(Figure~\ref{fig:main-index-base-tv-increase-1}).
