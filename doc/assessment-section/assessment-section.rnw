...
sets the target average acceptance probability and was set to 0.95 for all models presented in this assessment. The choice of {\tt adapt\_delta} of 0.95 was made based on less divergence of the posterior and higher effective sample size. A full explanation of the NUTS algorithm and the {\tt adnuts} package,
...
In particular, having all of the code under {\\t git} version control \citep{JTC2016} has ensured delivery of the assessment document within a contracted timeframe.
...
\emph{Response -- Research being led by Adam Luckenbach at the Northwest Fisheries
