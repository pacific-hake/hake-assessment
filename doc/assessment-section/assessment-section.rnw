...
values of $\phi$ explored in the previous assessment were 0.03, 0.10, 
...
change to the new version of Stock Synthesis required an adjustment to the
interpretation of these values, with a multiplier of 7.0 resulting in
approximately equivalent dynamics. Thus, the base model value is 1.40, and
...
and worse fits to the recent survey biomass estimates (Figures~
\ref{fig:main-biomass-base-alternative-4}-
\ref{fig:main-index-base-alternative-4}). Increasing $\sigma_s$ to 1.0
...
similar to other large cohorts (1999, 2008, and 2010).  One major difference between the 2010 and 2014
