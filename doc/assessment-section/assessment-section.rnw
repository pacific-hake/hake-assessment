...
effects of all changes from the \Sexpr{last_assess_yr} base model to
the \Sexpr{assess_yr} base model.

In short, steps that went into developing these models included the following:
\begin{itemize}
  \item Update to the latest version of Stock Synthesis, version \Sexpr{ss_version};
  \item Update catch and age-composition data from years prior to \Sexpr{last_data_yr};
  \item Add new catch and age-composition data for \Sexpr{last_data_yr};
  ...
  \item Add weight-at-age data for \Sexpr{last_data_yr} as well as update data for years prior.
...
The bridging steps can be grouped into two main sets of changes,
...
This primarily included minor adjustments in catch, fishery age compositions,
%the 2019 acoustic survey biomass estimate,
and weight-at-age values as databases are continually updated.
...
The addition of \Sexpr{last_data_yr} catch and weight-at-age data extends the model
to the start of \Sexpr{assess_yr}. Recruitment estimates and historical stock
trajectory were relatively unchanged with the addition of these data, but did
result in a slight increase in spawning
biomass from \Sexpr{last_data_yr-1} to \Sexpr{assess_yr}
...
The final bridging step was the addition of \Sexpr{last_data_yr} fishery age compositions.
...
\Sexpr{last_data_yr} because of the addition of fishery data in \Sexpr{last_data_yr}.
...
Recruitment estimates in 2019 were shifted downwards, while estimates in 2020 were shifted
upwards. The increase in 2020 recruitment contributes to a considerable increase
in spawning biomass by the start of \Sexpr{assess_yr}, as these fish are now mostly mature.
...
decrease once these fish have been observed by the acoustic survey, as well as the
