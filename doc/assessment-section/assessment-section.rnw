...
\Sexpr{round(sens.models.4[[which(sens.model.names.4=="Natural mortality SD
0.3")]]$parameters$Value[1],3)} for the sensitivity run with the prior standard
...
\Sexpr{round(sens.models.4[[which(sens.model.names.4=="Steepness prior mean
0.5")]]$parameters["SR_BH_steep","Value"],3)}. However, neither steepness
