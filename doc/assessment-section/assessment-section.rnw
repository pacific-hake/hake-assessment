...
\emph{Response -- **Refer to Aaron's new sampling heatmap figure. Due to time constraints,
  the JTC was unable to analyse the potential influence of changes in sampling.}
...
\emph{Response -- This was done for the published version of the 2018
  assessment, and for the 2019 (and future) assessments.}
...
Table~\ref{tab:tab:main-ci-posterior}).
