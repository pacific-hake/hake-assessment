...
\emph{Response -- Bring up Kelli's new Table: Table~\ref{tab:tab:main-assessment-changes}; and sections in
the document that discuss data weighting.}
...
\subsection{Sensitivity analyses }\label{sec:assessment-sensitivity-analyses}
 % Manual 2016 done
**UPDATE WHOLE SUBSECTION (much will stay the same)
...
% Manual 2018: updated the "Bratio" years in paragraph below
% Done KFJ 2019
