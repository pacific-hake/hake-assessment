...
per \citet{LudwigWalters1981}. Maturity is assumed to be time-invariant and fixed
values were recently updated using the new maturity ogive discussed earlier.
Fecundity is time-varying across years with empirical weight-at-age data (1975--
...
Section~\ref{sec:assessment-response-review} for more details).
