...
**For 2018 assessment -- 2017 responses to 2016 SRG comments are still copied
below for now.
...
\item The next priority for 2018 is processing the archived ovary collections of
  ...
  based on information more than 20 years old from Dorn and Saunders (1997); and
