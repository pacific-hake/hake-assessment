...
{\bf ** The SRG recommends exploring alternative methods to simulate recruitment
...
-- ** \fishname\ dynamics are highly variable even without fishing
...
** last year was the same, and we had:
...
steepness, natural mortality, σ R , excluding the age-1 index, alternative standard
deviations for time-varying selectivity, and down-weighting fishery age-composition
data.}

** Same as last year, except we now excluding age-1 index as a normal sensitivity,
dropping the requirement for it to be a full Appendix. Woo-hoo.

\emph{**2022 we said: Response -- The JTC has conducted all of the requested sensitivities (and many
...
-- Based on the preliminary results shown, previous assessments have `correctly'
...
** same as last year, for which we replied:
...
compositions. Previous work of **[add ref] Stewart and Hamel (2014) may be useful for this
purpose.}
...
\emph{**[can keep last year's:] Response -- Teamwork is an attribute of great interest and pride within the JTC, thank you.}
