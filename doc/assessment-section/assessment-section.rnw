...
Preliminary investigations suggest that on average there is about 2 hauls conducted per shore-based trip in the U.S., and combined those hauls on average contain about half as much in catch weight as a single at-sea haul.}
...
MCMC samples to descirbe posterior distributions for model parameters and derived
quantities.  This is near a four-fold increase in samples from
...
The median posterior density for numbers, biomass,
...
2021 and 2021 medians is not the same as the median of the 2021 and 2022 differences.
The median difference between 2021 and 2022
...
\Sexpr{pfmc.prob.next.year.below.b40}\% estimated probability of the biomass
...
otherwise estimates (Figures~\ref{fig:main-age-one-index} and\ref{fig:main-index-base-alternative-2}).
