...
(rwMH) sampler (details described in \citep{JTC2021}).
% \ref{chap:rwmh}).
...
Catchability associated with the acoustic survey and the age-1 index were
...
acoustic survey and the age-1 index, which were
