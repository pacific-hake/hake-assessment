...
\emph{Research being led by Adam Luckenbach at the Northwest Fisheries
  ...
  triacylglycerols and phospholipids, in the livers of Pacific Hake are inversely related and predictive
  ...
  which can reduce the effective spawning stock biomass. Data analyses will continue in 2023.
  New developments are expected to inform maturity in future Pacific Hake stock assessments.}
...
estimated above-average 2020 cohort has already begun to play a large role in determining spawning
stock biomass during the forecast years presented here.
...
led to minor changes in relative spawning stock biomass, recruitment estimates, and increased uncertainty
...
model. With the addition of the age-1 index time series, recruitment
strength estimates now come closer to the long-term stable estimate by age-2 in some cases
(Figure~\ref{fig:main-retrospective-recruitment}) compared to models without the age-1 index
\citep{JTC2022}.
However, some cohort recruitments still are over or under-estimated at age-2.
Over-estimation can be seen most clearly with the 2014, 2015, 2017, and 2018 cohorts.  The 2014 cohort
...
can be seen with the 2017 and 2018 cohorts. Even With the addition of new data, the size of the 2015
cohort has not fully stabalized, with estimates suggesting it was a poor recruitment year.
Under-estimation is slight, but apparent, for the 2016 cohort as recruitment estimates have risen
since the estimate at age-2. Cohort strength is further informed once at least one year of biomass
index (age-2+) age-composition data are available for the cohort, which for even year recruitment typically
does not occur until the cohort reaches age-3 with odd year acoustic surveys.

The stability of the recruitment estimates seen in this plot is also evident in the uncertainty estimates of
each cohort. Uncertainty around the 2016--2019 cohort has been substantially reduced compared
to previous models (Figure~\ref{fig:main-biomass-recruitment-retrospective}, bottom figure).
Whereas the uncertainty around the 2020 cohort has actually increased with the addition of
...
slight year-specific positive and negative bias in spawning stock biomass, some minor adjustments to
...
The level of uncertainty associated with estimates of current spawning biomass (i.e., the biomass
in the current assessment year used to convey current stock status and inform management advice)
...
second largest (behing the 2017 assessment) since 2012, the relative amount of dispersion
...
the 2019 assessment \citep{JTC2019} gave the estimated probability of the spawning stock
