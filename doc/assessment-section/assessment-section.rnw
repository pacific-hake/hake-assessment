...
\emph{The JTC is conducting and collaborating on simulation projects looking into the concurrent
...
\emph{The near completion of the Management Strategy Evaluation framework for \fishname\ creates
...
\emph{The JTC conducted an analysis looking into autocorrelation of recruitment deviations over
...
\emph{The JTC is following work being conducted by Dr. Cathleen Vestfals and colleagues at
...
\emph{The JTC plans to continue to work towards evaluating and testing best practices
...
\emph{A clear change in protocol was initiated in 1999 for the U.S. at-sea fishery with the
...
\emph{In Canada, target sample size (n=50) has not changed over time for at-sea observers aboard
...
\emph{In 2016, dockside observers were asked to change their protocols based on JTC input.
Samples changed from being collected during dedicated weeks to the landing level.}

\emph{A more complete summary of the changes in the sampling protocol over time will be
