...
and the model fit indicates a decline in biomass relative to the stable 2013--2019 period.
...
The base model fit to the index of age-1 fish (Figure~\ref{fig:main-mcmc-age1-fit})
