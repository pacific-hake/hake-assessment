...
sensitivity analyses took a few minutes. The longest retrospective analysis using NUTS took 74~hours.
...
Overall, the 2001 survey biomass index continues to be well below any model predictions that were evaluated,
...
The MCMC diagnostics were examined by creating a document
