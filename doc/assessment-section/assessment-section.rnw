...
The high value, $\sigma_r = 1.8$, resulted in a model with a higher 
standard deviation for the estimated recruitment deviations, at 
\Sexpr{round(sens.models.1[[which(sens.model.names.1=="Sigma R 1.0")]]$sigma_R_info$SD_of_devs[1],2)}.
The high $\sigma_r$ model had a larger difference between the unfished
...
status-quo base-model value of 1.4.
