...
\emph{Response -- Developing best practices for modeling equilibrium recruitment ($R_0$)
  ...
  The JTC is conducting and collaborating on simulation projects looking into the concurrent
  ...
  The near completion of the Management Strategy Evaluation framework for \fishname creates
  ...
  The JTC conducted an analysis looking into autocorrelation of recruitment deviations over
  ...
  The JTC is following work being conducted by Dr. Cathleen Vestfals and colleagues at
  ...
  The JTC is also following work being conducted by the International Council for
...
**THIS next sentence doesn't make sense, especially given have just been talking about data;
suggest deleting (AME).
