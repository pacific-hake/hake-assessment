...
NUTS, initiated to achieve a minimum of 12,000
...
classes (Figure~\ref{fig:main-bridge-5-panel-2}). In turn, this results in slightly higher
trajectory of spawning stock biomass from 2013--2022 and a change in 2022 stock status
(relative spawning stock biomass) from
