...
Stock Synthesis \citep{MethotWetzel2013} version \Sexpr{ss.version} was used, at
Git commit \Sexpr{ss.commit} which was compiled on \Sexpr{ss.commit.date}.
...
\begin{itemize}
  \item Update to the latest version of Stock Synthesis, version \Sexpr{ss.version}, at Git commit \Sexpr{ss.commit};
...
Stock Synthesis version \Sexpr{ss.version} (at Git commit \Sexpr{ss.commit}) includes
