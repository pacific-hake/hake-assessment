...
(Table~\ref{tab:main-median-posterior-table} and
Figures~\ref{fig:main-fishing-intensity} and~\ref{fig:main-phase}).
The median female spawning biomass was
above the $\Bforty$ reference point in all years except 1999 and 2007-2010
(Table~\ref{tab:main-median-posterior-table} and Figures~\ref{fig:main-relative-spawning-biomass} and~\ref{fig:main-phase}).
...
Biomass increased from the lows in 2007--2010 with
