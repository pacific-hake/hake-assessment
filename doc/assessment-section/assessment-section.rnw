...
\emph{Response -- Specifying projected recruitment as the median of a given year range
  is not currently an option in Stock Synthesis.
  To work around this, the JTC calculated the median of estimates of recruitment from
  the main time period (1970--2020) and scaled this value to the estimate of $R_0$.
  Scaled median recruitment was then used as in input value to Stock Synthesis
  which does allow for scaling forecasted recruitment in terms of virgin recruitment.
  The standard suite of catch projections were then conducted using
  mean recruitment from the main time period and scaled virgin recruitment based on
  the median estimates of recruitment relative to $R_0$.
  Results were presented during the 2022 SRG review meeting.}
...
\emph{Response -- A project was initiated at the Northwest Fisheries Science Center just
  ...
  samples were collected during the 2021 \surveyname.
...
\emph{Response -- Genetic work headed by Gary Longo at the Northwest Fisheries Science
  Center using samples from throughout the United States west coast and
  British Columbian coast, including the Strait of Georgia and Puget Sound, is ongoing.
  Across two rounds of sequencing, DNA were extracted from 2,311 individuals
  across a range of spatio-temporal grid locations from 2015--2019. A total of
  2,008 were sequenced based on sufficient DNA concentrations, and 1,417 passed quality
  filters. Population genetic analyses generally corroborate the
  single-stock hypothesis with little to no differentiation among the spatio-temporal grids.
  ...
  some spatio-temporal grid locations (across years and location), which may be due to weak differentiation
  among cohorts. This pattern was corroborated with weak, but statistically
  significant, pairwise fixation index
...
\emph{Response -- In 2021, the JTC explored the absence of 2020 Canadian
  freezer-trawler age data and came to the conclusion that the loss of these data had little
...
\emph{In 2021, there were almost no biological data available for the Canadian fishery.
  ...
  average of 55 trips, and no freezer-trawlers provided age data.
  ...
  2021 fishing year. Whereas age-composition information from U.S. fisheries
  typically includes fewer older fish relative to information from the Canadian fisheries.}
...
\emph{The JTC is  concerned about multi-year changes in sampling and, in particular,
  ...
  medium- to long-term impacts on the stock assessment due to the loss of Canadian age data.
  Starting with the most recent year and working back to 2008,
  ...
  except only Canadian age data were removed.
...
\emph{Response -- It is important to capture key, mechanistic and/or stochastic population processes
  ...
  the age-1 index in the \Sexpr{assess_yr} base model and other related analyses mentioned in this section.}
