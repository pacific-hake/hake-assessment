...
In the \Sexpr{last_data_yr} fishery, \Sexpr{top.coh(base.model, last_data_yr, 3, cap = FALSE)}.
Age compositions from the \Sexpr{survey_end_yr} acoustic survey suggest a similar age
structure, i.e., \Sexpr{top.coh(base.model, survey_end_yr, 3, cap = FALSE, fleet = 2)}.
