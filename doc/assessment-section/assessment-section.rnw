...
examples). **(this sentence still needs checking)Table~\ref{tab:main-parameter-estimates} shows that most key derived
...
biomass levels and the predicted probability of dropping below 10\% in 2019 is
...
The age composition of the catch in 2018 is forecast to be 42\% age-4 fish from
