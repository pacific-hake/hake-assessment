...
fecundity \citep{JTC2018}. We have done this in the 2019 base model, and 
plus three model runs with alternative assumptions about the weights-at-age
...
runs 34, 35 and 38 also use time-varying fecundity.
Non-time-varying fecundity is examined in sensitivity runs 32, 33, 36 and~37.
...
1975-1979 is examined in sensitivity runs 35, 36, 37 and 38.
...
in 1976 is the heaviest fish on record (by 360g). Our JTC notes say that:
...
Sensitivity runs 33, 34, 35 and 37 tested the alternative assumption of setting
