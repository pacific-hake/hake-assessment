...
section~\ref{sec:data-maturity}.

The first few bridging steps had relatively little impact on model results,
with only subtle differences visible in the time series of spawning biomass
