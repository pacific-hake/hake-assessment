...
\emph{**[may just show the figure, Issue \#977] We again include Appendix~\ref{chap:rec-plot} to promote continued discussion on ideas
  for visualising annual recruitment relative to the largest recent recruitment
  to avoid misunderstanding of how large some recruitment
