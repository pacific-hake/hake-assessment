...
\Sexpr{fore.catch.prop$Age6}\% age-6 fish from the \Sexpr{forecast_yrs[1] - 6} year-class,
\Sexpr{fore.catch.prop$Age2}\% age-2 fish from the \Sexpr{forecast_yrs[1] - 2} year-class,
\Sexpr{fore.catch.prop$Age8}\% age-8 fish from the \Sexpr{forecast_yrs[1] - 8} year-class,
\Sexpr{fore.catch.prop$Age5}\% age-5 fish from the \Sexpr{forecast_yrs[1] - 5} year-class,
% \Sexpr{fore.catch.prop$Age4}\% age-4 fish from the \Sexpr{forecast_yrs[1] - 4} year-class,
% \Sexpr{fore.catch.prop$Age7}\% age-7 fish from the \Sexpr{forecast_yrs[1] - 7} year-class and
and only
\Sexpr{fore.catch.prop$Age12}\% age-12 fish from the large \Sexpr{forecast_yrs[1] - 12} year-class
% \Sexpr{fore.catch.prop$Age11}\% age-11 fish from the \Sexpr{forecast_yrs[1] - 11} year-class
