...
states. Both sensitivities resulted in standard deviations of the estimates of
recruitment deviations from the period with the most informative data that were
...
\Sexpr{sigma_r_sens[2]}, respectively. However, the high $\sigma_r$ model had a
