...
biomass estimate and reasonable fits to the fishery age composition data, while maintaining that  
there is considerable uncertainty associated with spatial changes in fish availability (due to movement) and recent
...
was similar to that for the 1999 and 2010 large cohorts (age-3 in 2002 and 2013, respectively; 
...
The likely cause of this zig-zag pattern is the 
