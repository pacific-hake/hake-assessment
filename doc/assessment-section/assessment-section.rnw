...
(Figure~\ref{fig:main-mcmc-age1-fit}). In particular, age-1 fish from the 2008 and 2014
cohorts were under estimated relative to the index, while the 1995 and 2016 were
over estimated. The 2010 cohort was closely fit.  Age-1 fish in 2021 (2020 cohort)
were slightly under estimated and had the largest amount of uncertainty in the time
series.  The model indicates that the 2020 year class may be similar in
