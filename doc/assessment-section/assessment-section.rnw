...
The \Sexpr{survey_end_yr} survey biomass estimate resulted in a slight upward shift
...
At the time, the addition of 2021 fishery data
...
of this above average cohort. Even though the
