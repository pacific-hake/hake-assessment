...
compositions. The base model was compared to a sensitivity model that down-weighted
...
Down-weighting fishery composition data using the McAllister-Ianelli method
...
(Figure~\ref{\ref{fig:main-biomass-base-alternative-4}}). It also
