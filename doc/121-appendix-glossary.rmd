...
Integrated West Coast Pelagic Survey (IWCPS): A fisheries-independent survey that began in 2025 to inform both Pacific hake and several coastal pelagic species in one survey design. The IWCPS continues to collect acoustic, biological, and ecosystem data, as did previous independent acoustic-trawl surveys. The IWCPS utilizes a contemporary multifunction net designed cooperatively with industry that can complete mid-water and surface trawl tows.
