...
$\Fforty$: The rate of fishing mortality estimated to give a spawning
...
```{r fishing-intensity-illustration-fig, fig.cap = "(ref:fishing-intensity-illustration-cap)", fig.height = 5, fig.width = 5, is.fig = TRUE, alt.text = "(ref:fishing-intensity-illustration-alt)"}
...
```{r spr-illustration-fig, fig.cap = "(ref:spr-illustration-cap)", fig.height = 7, fig.width = 6, is.fig = TRUE, alt.text = "(ref:spr-illustration-alt)"}
