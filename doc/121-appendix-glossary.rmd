...
Integrated West Coast Pelagic Survey (IWCPS): A fisheries-independent survey that began in 2025 to inform both Pacific hake and several coastal pelagic species in U.S. waters. The IWCPS continues to collect acoustic, biological, and ecosystem data, as did previous species-independent acoustic-trawl surveys. The IWCPS utilizes a contemporary multifunction net designed cooperatively with industry that can complete mid-water and surface trawl tows. The IWCPS and the Department of Fisheries and Oceans, Canada, acoustic-trawl survey are carefully coordinated and joined to develop the Joint U.S. and Canadian Integrated Acoustic and Trawl Survey for Pacific hake.
...
```{r glossary-fishing-intensity-illustration-fig, fig.cap = "(ref:glossary-fishing-intensity-illustration-cap)", out.height = "4in"}
...
model used in the `r base_model$endyr + 1` assessment. The light blue bars
represent unfished values, the dark blue bars represent fished values.
The numbers per recruit are scaled to be 1 at age-0, and biomass values are in
...
```{r glossary-spr-illustration-fig, fig.cap = "(ref:glossary-spr-illustration-cap)", fig.height = 7, fig.width = 6, out.height = "7in"}
