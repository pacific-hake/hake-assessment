...
@
\end{center}
\caption{Base model from the \Sexpr{last.assess.yr} assessment compared with a model with the same parameterization
  but including updated weight-at-age data.}
...
@
\end{center}
\caption{Base model from the \Sexpr{last.assess.yr} assessment compared with models with the same parameterization
  but using survey biomass estimates with extrapolation and fishery age compositions with extrapolation.}
...
\end{center}
\caption{Base model from the \Sexpr{last.assess.yr} assessment compared with models with the same parameterization
  but using an adjusted bias ramp, modified survey age composition weights, and modified age composition weights.}
