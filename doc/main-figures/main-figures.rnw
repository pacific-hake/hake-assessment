...
\end{center}
%\vspace{0mm}
\caption{Empirical weight-at-age (kg) used in the assessment (numbers, with colors
  given by the scale at the bottom). Numbers shown in bold were interpolated or
  extrapolated from adjacent areas or years.}
