...
\caption{Age compositions for the acoustic survey (top) and the aggregate fishery (bottom, all sectors combined)
  ...
  The largest bubble in the survey data is \Sexpr{fmt0(max.survey.age.prop[3] / 100, 2)} for age \Sexpr{max.survey.age.prop[5]}
  in \Sexpr{max.survey.age.prop[4]} and in the fishery is \Sexpr{fmt0(max.fishery.age.prop[3] / 100, 2)} for age \Sexpr{max.survey.age.prop[5]}
...
@
\end{center}
\caption{Maximum likelihood estimates of spawning biomass for the base model and alternative sensitivity runs representing changes age of maximum selectivity from the value of 6 in the base model.}
...
\end{center}
%\vspace{0mm}
\caption{Maximum likelihood estimates of recruitment for the base model and alternative sensitivity runs representing changes age of maximum selectivity from the value of 6 in the base model.}
...
@
\end{center}
\caption{Maximum likelihood estimates of spawning biomass for the base model and alternative sensitivity runs representing changes to $\sigma_r$, steepness, and natural mortality parameters.}
...
\end{center}
%\vspace{0mm}
\caption{Maximum likelihood estimates of stock status (relative spawning biomass) for the base model and alternative sensitivity runs representing changes to $\sigma_r$, steepness, and natural mortality parameters.}
