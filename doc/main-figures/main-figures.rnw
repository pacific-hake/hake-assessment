...
\vspace{-5mm}
\begin{center}
%\includegraphics[max size={\paperwidth}{\paperheight}]{main-figures/hake_survey_1995-17_sA_squareroot_bin_narrow-panel.eps} %% width=\maxwidth,
...
\caption{Bridging models showing the difference between the
  ...
  shown in Figure~\ref{} above, and the sequential addition of the new
