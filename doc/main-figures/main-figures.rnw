...
\begin{figure}[H]
\begin{center}
<<main-historical-dispersion, fig.height=4.5, fig.width=6.5, is.fig = TRUE, alt.text = "This figure shows the amount of absolute
and scaled variability present with terminal year estimates of spawning biomass from assessments dating back to 2012">>=
