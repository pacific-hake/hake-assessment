...
\begin{figure}[H]
\begin{center}
<<main.total.catches, fig.height=8, fig.width=9>>=
...
\begin{figure}[H]
\begin{center}
<<main.forecast.depletion.comparison.plot, fig.height=5, fig.width=8>>=
...
\begin{figure}[H]
\begin{center}
<<main.forecast.risk.comparison.plot.year.1, fig.height=5, fig.width=8>>=
...
\begin{figure}[H]
\begin{center}
<<main.forecast.risk.comparison.plot.year.2, fig.height=5, fig.width=8>>=
make.forecast.risk.comparison.plot(base.model,
                                   forecast.yrs = forecast.yrs,
