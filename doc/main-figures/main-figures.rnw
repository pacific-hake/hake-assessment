...
\pdftooltip{\includegraphics[max size={1.15\paperwidth}{1.15\paperheight}]
  {main-figures/hake_survey_1995-21_NASCTimeSeries_BiomassAtAgeHistograms_grayblue}}{This
...
\pdftooltip{\includegraphics[max size={1.10\paperwidth}{1.10\paperheight}]
   {main-figures/age1hake_03-21_sA_squareroot_bin_narrow-panel_grayblue}}{This
