...
\caption{**Maximum likelihood estimates of spawning biomass for the base model and alternative 
  sensitivity run that sets the full bias ramp adjust period to 2014 instead of 2013.}
...
\caption{**Maximum likelihood estimates of stock status (relative spawning biomass) for the base 
  model and alternative sensitivity run that sets the full bias ramp adjust period to 2014 instead of 2013.}
...
@
\end{center}
\caption{**[Presumably won't need changing]Maximum likelihood estimates of spawning biomass
  and selectivity for the base model and alternative sensitivity runs representing changes
  in the age of maximum selectivity from the value of 6 in the base model. Selectivity panels
  are a) Base model, b) \Sexpr{sens.model.names.3[1]}, c) \Sexpr{sens.model.names.3[2]},
...
@
\end{center}
\caption{**Maximum likelihood estimates of spawning biomass for the base model and 
  alternative sensitivity run representing changes in the standard deviation of the 
  selectivity parameters from the base model's value of $\phi=0.20$.} % Manual done 2017.
...
@
\end{center}
\caption{**Density plot showing the MLE recruitment estimates for the
  2014 cohort for the base model and alternative sensitivity run representing
  changes in the standard deviation of the selectivity parameters from the
  base model's value of $\phi=0.20$.} % Manual done 2017.
...
\caption{**Maximum likelihood estimates of spawning biomass for the base model
  and alternative sensitivity runs representing changes to the standard 
  deviation of recruitment variability from the base model's
  $\sigma_r=$\Sexpr{sigma.r}.}
...
\caption{**Maximum likelihood estimates of stock status (relative
  spawning biomass) for the base model and alternative sensitivity
  runs representing changes to the standard deviation of recruitment
  variability from the base model's $\sigma_r=$\Sexpr{sigma.r}.
  See Figure~\ref{fig:main-biomass-base-alternative-1} for legend.}
...
\caption{**Maximum likelihood estimates of spawning biomass for the base 
  ...
  the prior for steepness from 1.0 to 0.5, fixing steepness at 1.0, and 
  changing the standard deviation of the prior for natural mortality from 
  0.1 to 0.2 or 0.3.}
...
\caption{**Maximum likelihood estimates of stock status (relative 
  ...
  fixing steepness at 1.0, and changing the standard deviation of the prior 
  for natural mortality from 0.1 to 0.2 or 0.3. See 
  Figure~\ref{fig:main-biomass-base-alternative-4} for legend.}
...
\end{center}
\caption{**Maximum likelihood estimates of spawning biomass for the base 
  model and alternative sensitivity runs representing time/cohort-invariant 
  ageing error (no downward adjustments for large labelled cohorts), not 
  adjusting the 2014 cohort ageing error downwards (i.e., labelling it a 
  not-very-large cohort at this point) and adding in the age-1 index as a 
  separate data source on recruitment strength.}
...
\end{center}
%\vspace{0mm}
\caption{**Maximum likelihood estimates of stock status (relative spawning 
  biomass) for the base model and alternative sensitivity runs representing 
  time/cohort-invariant ageing error (no downward adjustments for large 
  labelled cohorts), not adjusting the 2014 cohort ageing error downwards 
  (i.e., labelling it a not-very-large cohort at this point) and adding in 
  the age-1 index as a separate data source on recruitment strength. See 
  Figure~\ref{fig:main-biomass-base-alternative-5} for legend.}
