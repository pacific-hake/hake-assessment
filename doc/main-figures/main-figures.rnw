...
\vspace{-5mm}
\begin{center}
\includegraphics[max size={\paperwidth}{\paperheight}]{main-figures/hake_survey_1995-17_NoArrow.eps} % width=\maxwidth,
\end{center}
\vspace{-5mm}
\caption{Spatial distribution of acoustic backscatter attributable to \fishname\
