...
%%%%%%%%%%%%%%%%%%%%%%%  % Call figure directly
\begin{figure}[H]
\vspace{-5mm}  % Chris will hate this
\begin{center}
\includegraphics[angle=90,origin=c]{main-figures/backscatter2smaller2.eps} % width=\maxwidth,
\end{center}
\vspace{-5mm}
...
\begin{figure}[H]
\begin{center}
<<main.data.overview.map, fig.height=6, fig.width=8>>=
...
\begin{figure}[H]
\begin{center}
<<main.total.catches, fig.height=6, fig.width=9>>=
make.catches.plot(catches,
                  leg.y.loc=450) ## leg.y.loc is y-coord to place legend at
@
\end{center}
%\vspace{0mm}
...
% \begin{figure}[H]
% \begin{center}
% <<main.us.at.sea.depths, fig.height=6, fig.width=8>>=
% plot(1:10, main="Placeholder dummy figure")
% @
% \end{center}
% %\vspace{0mm}
% \caption{Distribution of bottom depths (left) and fishing depths (right), in fathoms, of Pacific Hake catches in the U.S. at-sea fleet from 2008--\Sexpr{last.data.yr}.}
...
% \begin{figure}[H]
% \begin{center}
% <<main.us.catch-rates, fig.height=6, fig.width=8>>=
% plot(1:10, main="Placeholder dummy figure")
% @
% \end{center}
% %\vspace{0mm}
% \caption{Unstandardized (raw) catch-rates (t/hr) of Pacific Hake catches in the U.S. at-sea fleet in \Sexpr{last.data.yr}.}
...
\includegraphics[width=\maxwidth]{main-figures/fishDepthsUS}
\end{center}
...
\begin{center}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\maxwidth]{main-figures/fishCatchRatesUS}
\end{center}
...
%% \begin{figure}[H]
\begin{center}
<<main.recruitment.base.alternative.1, fig.height=4.5, fig.width=8>>=
make.comparison.plot(models[c(base.model.ind, sens.model.inds.1)],
                     subplots = 8,
                     model.names = c(paste0("Base model ", end.yr), sens.model.names.1),
                     legendloc = "topleft",
