...
weight.at.age.heatmap(sens.models.5[[5]], proj.line.yr=2017)
@
\end{center}
...
@
\end{center}
\caption{**Maximum likelihood estimates **Can do MCMC plots** of spawning biomass for the base
...
\end{center}
%\vspace{0mm}
\caption{**Maximum likelihood estimates **Can do MCMC of stock status (relative
