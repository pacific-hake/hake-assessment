...
\includegraphics[max size={1.08\paperwidth}{1.08\paperheight}]
  {main-figures/hake_survey_1995-19_NASCTimeSeries_BiomassAtLengthHistograms_v2.eps}
...
\includegraphics[max size={\paperwidth}{\paperheight}]
   {main-figures/age1hake_03-19_sA_squareroot_bin_narrow-panel_bw.eps}     % Download from Google Drive
\end{center}
\vspace{-5mm}
