...
\end{center}
%\vspace{0mm}
\caption{Density plot showing the MLE recruitment deviate estimates for the \Sexpr{sens.density.yr} cohort for the base model and alternative sensitivity runs representing no extrapolation on the acoustic survey estimate and inclusion of an age-1 index.}
...
@
\end{center}
\caption{Maximum likelihood estimates of spawning biomass for the base model and alternative sensitivity run representing an increase of the standard error of the deviations of the selectivity parameters.}
...
\end{center}
%\vspace{0mm}
\caption{Maximum likelihood estimates of stock status (relative spawning biomass) for the base model and alternative sensitivity run representing an increase of the standard error of the deviations of the selectivity parameters. See Figure~\ref{fig:main-biomass-base-tv-increase-1} for legend.}
...
\end{center}
%\vspace{0mm}
\caption{Maximum likelihood estimates of stock status (relative spawning biomass) for the base model and alternative sensitivity runs representing changes to $\sigma_r$, steepness, and natural mortality parameters. See Figure~\ref{fig:main-biomass-base-alternative-1} for legend.}
