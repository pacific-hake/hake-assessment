...
\end{center}
%\vspace{0mm}
\caption{Empirical weight-at-age (kg) used in the assessment. Numbers shown in
  bold were interpolated or extrapolated from adjacent areas or years. Values above the
  blue line were used in projection years.}
