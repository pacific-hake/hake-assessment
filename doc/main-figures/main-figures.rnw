...
\end{center}
%\vspace{0mm}
\caption{Summary of historical Pacific Hake assessment estimates of spawning biomass. Shading represents the approximate 95\% confidence range from the \Sexpr{end.yr} base model.}
