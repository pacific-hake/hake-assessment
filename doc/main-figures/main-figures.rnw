...
## tv.selex <- calc.tv.selex(base.model, start.yr = tv.selex.start.yr, end.yr = end.yr, ages = 1:8, probs = c(0.025, 0.975))
tv.selex <- calc.tv.selex(base.model, start.yr = tv.selex.start.yr, end.yr = end.yr - 1, ages = 1:8, probs = c(0.025, 0.975))
...
tv.selex.left <- calc.tv.selex(base.model, start.yr = tv.selex.start.yr, end.yr = 2001, ages = 1:8, probs = c(0.025, 0.975))
tv.selex.right <- calc.tv.selex(base.model, start.yr = 2002, end.yr = end.yr-1, ages = 1:8, probs = c(0.025, 0.975))
...
% Figures referenced in introduction-section.rnw:



% Figures referenced in data-section.rnw:



% Figures referenced in assessment-section.rnw:



% Figures referenced in research-section.rnw:
