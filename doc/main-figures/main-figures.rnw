...
\end{center}
\caption{Unstandardized (raw) catch-rates (t/hr) of \fishname\ catches by tow in the U.S. at-sea fleet from 2014--\Sexpr{last.data.yr}.}
...
# Run 32 (same as base)
weight.at.age.heatmap(alt.base.model.2)
@
\end{center}
%\vspace{0mm}
...
weight.at.age.heatmap(alt.base.model.1)
@
\end{center}
%\vspace{0mm}
