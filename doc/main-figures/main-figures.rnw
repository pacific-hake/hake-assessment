...
\end{center}
\caption{Maximum likelihood estimates of spawning biomass for the base
  model and alternative sensitivity models 52, 53 (base 2018), and 54 that all set
  the pre-1975 (1966-1974) weights-at-age to the long term mean (1975--2018).
  Model 52 has non-time-varying fecundity and the short term mean (2016--2018)
  as the post-2017 weights-at-age. Model 53 is the base model from 2018 without
  time-varying fecundity and with long term (1975--2018) mean as the post-2018
  weights-at-age. Model 54 has time-varying fecundity and the short term mean
  (2016--2018) as the post-2017 weights-at-age.
  See Table~\ref{tab:main-wtatage-runs}.}
...
\caption{Maximum likelihood estimates of stock status for the base
  model and alternative sensitivity models 52, 53 (base 2018), and 54.
...
\end{center}
\caption{Maximum likelihood estimates of spawning biomass for the base
  model and alternative sensitivity models 55, 56, 57, and 58 that all set
  the pre-1975 (1966-1974) weights-at-age to the short term mean (1975--1979).
  Model 55 has time-varying fecundity and the long term mean (1975--2018)
  as the post-2017 weights-at-age. Model 56 has non-time-varying fecundity
  and with short term (2016--2018) mean as the post-2017 weights-at-age.
  Model 57 has non-time-varying fecundity and the long term mean
  (1975--2018) as the post-2018 weights-at-age. Model 58 has time-varying
...
\end{center}
\caption{MCMC median posterior estimates with 95\% credible interval of spawning
  biomass for the base model and alternative sensitivity models 55, 56, 57, and 58.
...
\end{center}
\caption{Maximum likelihood estimates of stock status for the base
  model and alternative sensitivity models 55, 56, 57, and 58.
  See Figure~\ref{fig:main-biomass-base-alternative-6} and
  Table~\ref{tab:main-wtatage-runs} for descriptions of models.}
