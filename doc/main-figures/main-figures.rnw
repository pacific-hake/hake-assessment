...
\caption{Maximum likelihood estimates of spawning biomass for the base model and alternative
  ...
  weight composition data, and accounting for seasonal age sampling in the aggregation of age
...
\caption{Maximum likelihood estimates of stock status (relative spawning biomass) for the base
  model and alternative sensitivity runs that represent changes in data: adding an age-1 index of abundance,
  incorporating ageing error that is cohort invariant, using the harmonic mean approach to
  weight composition data, and accounting for seasonal age sampling in the aggregation of age
  composition information.}
...
make.selex.plot(base.model, pan.letter = "a", years = end.yr-1)
make.selex.plot(sens.models.3[[1]], pan.letter = "b", years = end.yr-1)
make.selex.plot(sens.models.3[[2]], pan.letter = "c", years = end.yr-1)
make.selex.plot(sens.models.3[[3]], pan.letter = "d", years = end.yr-1)
par <- oldpar
mtext("Age", side = 1, line = 1, outer = TRUE)
@
\end{center}
\caption{Maximum likelihood estimates of spawning biomass
  ...
  deviation ('phi') associated with time-varying selectivity. Selectivity panels
