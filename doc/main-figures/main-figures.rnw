...
% \vspace{-5mm}
\begin{center}
\includegraphics[max size={1.1\paperwidth}{1.1\paperheight}]
  {main-figures/hake_survey_1995-17_sA_squareroot_bin_narrow-panel.eps}
\end{center}
% \vspace{-5mm}
...
% \vspace{-5mm}
\begin{center}
\includegraphics[max size={0.92\paperwidth}{0.92\paperheight}]
  {main-figures/age1hake_2003-17_timeseries.eps}
\end{center}
% \vspace{-5mm}
...
\begin{center}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=6.5in, height=6.5in]{main-figures/maturity_plots}
\end{center}
\caption{Fraction of fish mature at age North and South of 34.44$^\circ$N 
  ...
  maturity at length reported by \citet{DornSaunders1997} and the weight
  at length estimated in 2011, converted to age using a parametric 
  growth curve estimated in 2011. 
  The new fecundity relationship (purple line in lower plot) is the product 
  of the mean weight at age
  averaged across all years (green line) and the maturity at age (blue line).
  Samples from South of 34.44$^\circ$N were not included in the estimates.}
