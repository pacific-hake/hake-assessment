...
plist <- list()
plist[[1]] <-
  plot_biomass(bridge_models[[1]],
               bridge_models_names[[1]])
plist[[2]] <-
  plot_rel_biomass(bridge_models[[1]],
                   bridge_models_names[[1]],
                   ylim = c(0, 2.5),
                   ...
                   leg_pos = "none")
plist[[2]] <-
  plot_recdevs(bridge_models[[1]],
               bridge_models_names[[1]],
               leg_pos = "none")

cowplot::plot_grid()

make.comparison.plot(bridge_models[[1]],
                     subplots = 2,
                     model.names = bridge_models_names[[1]],
                     densitynames = bridge.density.names,
                     legend = TRUE,
                     plot_mcmc = TRUE,
                     end_yr = bridge_model_end_yr)
make.comparison.plot(bridge_modelsbridge_models[[1]],
                     subplots = 4,
                     model.names = bridge_models_names[[1]],
                     densitynames = bridge.density.names,
                     legend = FALSE,
