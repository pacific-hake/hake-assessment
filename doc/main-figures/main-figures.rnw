...
\caption{Spatial distribution of acoustic backscatter attributable to age-2 and older \fishname\
  ...
  \Sexpr{survey.start_yr}--\Sexpr{survey.end_yr}. Area of the circle is roughly
...
\caption{Spatial distribution of acoustic backscatter attributable to age-1 \fishname\
  from the Joint U.S.~and Canada acoustic surveys 2003--\Sexpr{survey.end_yr}. Age-1 \fishname\ are not fully sampled
