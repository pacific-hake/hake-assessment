...
\begin{figure}[H]
\begin{center}
<<main-can-fishery-depths, is.fig = TRUE, alt.text = "This figure shows that in Canada, freezer trawlers tend to fish deepoer than the shoreside boats">>=
...
\begin{figure}[H]
\begin{center}
<<maturity-ogive-figure, fig.height=7.5, fig.width=7.5, is.fig = TRUE>>=
...
<<main-weight-at-age, fig.height=9, fig.width=8, is.fig = TRUE>>=
...
\begin{figure}[H]
\begin{center}
<<main-weight-at-age-numbers, fig.height=9, fig.width=8, is.fig = TRUE>>=
weight.at.age.heatmap(base.model,
                      proj.line.yr = base.model$endyr,
                      extrap.mask = weight_age_extrapolation_mask,
...
\begin{figure}[H]
\begin{center}
<<main-bridge-5-panel-1, fig.height=8, fig.width=8, is.fig = TRUE>>=
...
@
\end{center}
\caption{**[update] Bridging models showing the \Sexpr{last.assess.yr} base model
...
\begin{figure}[H]
\begin{center}
<<main-bridge-5-panel-2, fig.height=8, fig.width=8, is.fig = TRUE>>=
oldpar <- par(no.readonly=TRUE)
par(mar = c(2.1, 4.1, 1.1, 1.1), oma = c(2.1, 0, 0, 0))
layout(matrix(c(1,1,2,3,4,5), nrow = 3, ncol = 2, byrow=TRUE))
bridge.density.names <- c("SSB_Virgin",
...
@
\end{center}
\caption{**[update] Bridging models starting with the addition of simple recruitment deviations (shown
...
\begin{figure}[H]
\begin{center}
<<main-mcmc-survey-fit, fig.height=6, fig.width=8, is.fig = TRUE, alt.text = "This figure shows many posterior trajectories and their median compared with the M L E estimate">>=
...
@
\end{center}
\caption{**[Remove the MLE? Maybe clarfiy final sentence.] Fits to the acoustic survey with 95\% confidence intervals around the index points.
...
\begin{figure}[H]
\begin{center}
<<main-prior-posterior, fig.height=6, fig.width=8, is.fig = TRUE>>=
...
%% \begin{figure}[H]
\begin{center}
<<main-relative-spawning-biomass, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
...
%% \begin{figure}[H]
\begin{center}
<<main-recruitment-devs, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
...
\begin{figure}[H]
\begin{center}
<<main-projected-catch-density, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
...
%% \begin{figure}[H]
\begin{center}
<<main-forecast-depletion-comparison-plot, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
...
\begin{figure}[H]
\begin{center}
<<main-age-comp-forecast, fig.height=4.5, fig.width=6.5, is.fig = TRUE>>=
...
\begin{figure}[H]
\begin{center}
<<main-biomass-base-alternative-1, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
...
@
\end{center}
\caption{**[check] MCMC estimates of spawning biomass for the base
...
%% \begin{figure}[H]
\begin{center}
<<main-status-base-alternative-1, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
make.comparison.plot(c(list(base.model), sens.models.1),
                     subplots = 4,
                     model.names = c(base.model.name, sens.model.names.1),
                     legend = FALSE,
...
\end{center}
%\vspace{0mm}
\caption{**[check] MCMC estimates of stock status (relative
...
\begin{figure}[H]
\begin{center}
<<main-biomass-base-alternative-2, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
...
@
\end{center}
\caption{**[check] MCMC estimates of spawning biomass for the base model and alternative
...
%% \begin{figure}[H]
\begin{center}
<<main-status-base-alternative-2, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
make.comparison.plot(c(list(base.model), sens.models.2),
                     subplots = 4,
                     model.names = c(base.model.name, sens.model.names.2),
                     legend = FALSE,
...
\end{center}
%\vspace{0mm}
\caption{**[check] MCMC estimates of stock status (relative spawning biomass) for the base
...
\begin{figure}[H]
\begin{center}
<<main-index-base-alternative-2, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
make.comparison.plot(c(list(base.model), sens.models.2),
                     subplots = 14,
                     model.names = c(base.model.name, sens.model.names.2),
                     legend = FALSE,
...
@
\end{center}
\caption{**[check] MCMC estimates of the fit to the survey index of abundance for the base
  model and alternative sensitivity runs that represent changes in data.
  See Figure~\ref{fig:main-biomass-base-alternative-2} for sensitivity descriptions.}
...
%% \begin{figure}[H]
\begin{center}
<<main-recruit-base-alternative-2, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
make.comparison.plot(c(list(base.model), sens.models.2),
                     subplots = 12,
                     model.names = c(base.model.name, sens.model.names.2),
                     legend = FALSE,
...
@
\end{center}
\caption{**[check] MCMC estimates of recruitment deviations for the base
  model and alternative sensitivity runs that represent changes in data.
  See Figure~\ref{fig:main-biomass-base-alternative-2} for sensitivity descriptions.}
...
\begin{figure}[H]
\begin{center}
<<main-biomass-base-alternative-4, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
...
@
\end{center}
\caption{**[check] MCMC estimates of spawning biomass for the base model
...
%% \begin{figure}[H]
\begin{center}
<<main-status-base-alternative-4, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
make.comparison.plot(c(list(base.model), sens.models.4),
                     subplots = 4,
                     model.names = c(base.model.name, sens.model.names.4),
                     legend = FALSE,
...
\end{center}
%\vspace{0mm}
\caption{**[check] MCMC estimates of stock status (relative spawning biomass) for the base model
  and alternative sensitivity runs representing different standard
  deviations ($\Phi$) associated with time-varying selectivity and the use of a
  semi-parametric approach for implementing time-varying selectivity ($\sigma_s$).
...
\begin{figure}[H]
\begin{center}
<<main-recruitment-base-alternative-4, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
make.comparison.plot(c(list(base.model), sens.models.4),
                     legend = FALSE,
                     subplots = 10,
                     model.names = c(base.model.name, sens.model.names.4),
...
@
\end{center}
\caption{**[check] MCMC estimates of recruitment for the base model
  and alternative sensitivity runs representing different standard
  deviations ($\Phi$) associated with time-varying selectivity and the use of a
  semi-parametric approach for implementing time-varying selectivity ($\sigma_s$).
  See Figure~\ref{fig:main-biomass-base-alternative-4} for legend.}
...
%% \begin{figure}[H]
\begin{center}
<<main-recruitment-devs-base-alternative-4, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
make.comparison.plot(c(list(base.model), sens.models.4),
                     legend = FALSE,
                     subplots = 12,
                     model.names = c(base.model.name, sens.model.names.4),
...
@
\end{center}
\caption{**[check] MCMC estimates of recruitment deviations for the base model
  and alternative sensitivity runs representing different standard
  deviations ($\Phi$) associated with time-varying selectivity and the use of a
  semi-parametric approach for implementing time-varying selectivity ($\sigma_s$).
  See Figure~\ref{fig:main-biomass-base-alternative-4} for legend.}
...
\begin{figure}[H]
\begin{center}
<<main-index-base-alternative-4, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
make.comparison.plot(c(list(base.model), sens.models.4),
                     subplots = 14,
                     model.names = c(base.model.name, sens.model.names.4),
                     legend = FALSE,
...
\end{center}
%\vspace{0mm}
\caption{**[check] MCMC estimates of the fit to the survey index of abundance
...
\begin{figure}[H]
\begin{center}
<<main-selectivity-illustration, fig.height=9, fig.width=8, is.fig = TRUE>>=
...
\begin{figure}[H]
\begin{center}
<<main-biomass-base-alternative-5, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
...
\end{center}
\caption{**[check] MCMC estimates of spawning biomass for the base
  model and alternative sensitivity run with cohort-based ageing error removed.}
...
%% \begin{figure}[H]%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
<<main-status-base-alternative-5, fig.height=4.5, fig.width=8, is.fig = TRUE>>=
make.comparison.plot(c(list(base.model), list(sens.models.5)),
                     subplots = 4,
                     model.names = c(base.model.name, sens.model.names.5),
                     legend = TRUE,
...
\end{center}
%\vspace{0mm}
\caption{**[check] MCMC estimates of stock status for the base
  model and alternative sensitivity run with cohort-based ageing error removed.}
...
\begin{figure}[H]
\begin{center}
<<main-biomass-recruitment-retrospective, fig.height=8, fig.width=8, is.fig = TRUE>>=
oldpar <- par()
par(mar = c(2.1, 4.1, 1.1, 1.1), oma = c(2.1, 0, 0, 0))
layout(matrix(c(1, 2), nrow = 2, ncol = 1, byrow = TRUE))
...
\begin{figure}[H]
\begin{center}
<<main-retrospective-recruitment, fig.height=6, fig.width=8, is.fig = TRUE>>=
...
\begin{figure}[H]
\begin{center}
<<main-relative-retrospective-recruitment, fig.height=6, fig.width=8, is.fig = TRUE>>=
make.squid.plot(retro.list,
                subplot = 2,
                cohorts = retro.cohorts)
@
...
\begin{figure}[H]
\begin{center}
<<historical-assessments, fig.height=4.5, fig.width=6.5, is.fig = TRUE>>=
