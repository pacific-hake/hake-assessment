...
models.names <- catch.levels[models.inds][[2]] ## [[2]] corresponds to pretty text catch level name
...
make.comparison.plot(c(base.model, sens.models.2),
                     subplots = 2,
...
par(mar = c(2.1, 4.1, 1.1, 1.1), oma = c(2.1, 0, 0, 0))
layout(matrix(c(1,1,2,3,4,5), nrow = 3, ncol = 2, byrow=TRUE))
make.comparison.plot(c(base.model, sens.models.3),
                     subplots = 2,
...
make.comparison.plot(c(base.model, sens.models.1),
                     subplots = 2,
