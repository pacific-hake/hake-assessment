...
@
\end{center}
\caption{Total Pacific Hake catch used in the assessment by sector, \Sexpr{start.yr}--\Sexpr{last.data.yr}.
...
\begin{figure}[p]
\begin{center}
<<age.one.index, fig.height=4, fig.width=6.5>>=
make.survey.age1.plot(age1index, models, modelnum=base.model.ind)
@
\end{center}
%\vspace{0mm}
...
\begin{center}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=6.5in, height=5in]{main-figures/maturityNS}
\end{center}
%\vspace{0mm}
