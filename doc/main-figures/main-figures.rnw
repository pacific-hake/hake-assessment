...
\caption{Estimated historical path followed by medians of relative fishing 
  intensity and relative spawning biomass for \fishname. Start and end years are
  labelled, as is the year with the highest relative fishing intensity.
  Gray bars span the 95\% credibility 
  intervals for \Sexpr{end.yr-1} relative fishing intensity (vertical) 
