...
@
\end{center}
\caption{Time-series of estimated relative spawning biomass to \Sexpr{end.yr} from the base model, and forecast trajectories
  to \Sexpr{forecast.yrs[length(forecast.yrs)]} for several management options from the decision table, with 95\% posterior
