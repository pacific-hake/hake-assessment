...
\end{center}
%\vspace{0mm}
\caption{Empirical weight-at-age (kg) used for sensitivity run 32 and the base
...
\end{center}
%\vspace{0mm}
\caption{Empirical weight-at-age (kg) used for sensitivity runs 33 and 34.
  Numbers shown in
  bold were interpolated or extrapolated from adjacent ages or years. Data are
  only available from 1975-2017 (between the two blue lines). Remaining values
  are used for the early and late years.}
...
\end{center}
%\vspace{0mm}
\caption{Empirical weight-at-age (kg) used for sensitivity runs
...
\end{center}
\caption{Maximum likelihood estimates of spawning biomass for the base
  model and alternative sensitivity run that sets the unfished and
