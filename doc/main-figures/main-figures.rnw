...
@
\end{center}
\caption{A comparison of MLE estimates with 95\% confidence intervals determined from asymptotic variance estimates (red)
...
\end{center}
%\vspace{0mm}
\caption{Maximum likelihood estimates (MLEs) of expected survey biomass for the base model (black, same as red line in Figure~\ref{fig:main-mcmc-survey-fit}) and the alternative sensitivity run (red) which ***ONCE WE DECIDE ON ONE.}
...
@
\end{center}
\caption{MLE estimates of spawning biomass for the base model and alternative sensitivity runs representing changes to selectivity, $\sigma_r$, and steepness parameters.}
...
\end{center}
%\vspace{0mm}
\caption{MLE estimates of recruitment for the base model and alternative sensitivity runs representing changes to selectivity, $\sigma_r$, and steepness parameters.}
...
\end{center}
%\vspace{0mm}
\caption{MLE estimates of recruitment for the base model and alternative sensitivity runs representing no extrapolation on the acoustic survey estimate and inclusion of an age-1 index.}
