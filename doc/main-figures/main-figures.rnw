...
\caption{** Bridging models showing the sequential addition of updating
  pre-\Sexpr{last_data_yr} fishery data, pre-\Sexpr{last_data_yr} survey data,
  adding \Sexpr{last_data_yr} survey data, and adding
  \Sexpr{last_data_yr} weight-at-age information.
