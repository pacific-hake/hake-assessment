...
\end{center}
%\vspace{0mm}
\caption{Empirical weight-at-age (kg) used for the base model. Numbers shown in
  bold were interpolated or extrapolated from adjacent ages or years. Data are
  only available from 1975--\Sexpr{max.fishery.age.prop[2]} (between the two blue lines). Remaining values
