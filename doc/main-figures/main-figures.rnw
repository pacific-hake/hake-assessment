...
plist <- list()
plist[[1]] <-
  plot_rel_biomass(d_obj = d_obj_bridge_rel_biomass,
                   ylim = c(0, 2.5),
                   y_labels = expression("0", "0.1B"[0], "0.4B"[0], "0.5",
                                         "B"[0], "1.5", "2", "2.5"),
                   leg_pos = "none")
plist[[2]] <-
  plot_recdevs(d_obj = d_obj_bridge_recdevs,
               leg_pos = "none")

plist[[3]] <-
  plot_survey_index_fits(d_obj = d_obj_bridge_survey_age2_index,
                         survey_type = "age2",
                         leg_pos = "none")

plist[[4]] <-
  plot_survey_index_fits(d_obj = d_obj_bridge_survey_age1_index,
                         survey_type = "age1",
                         xlim = c(1995, 2022),
                         ylim = c(0, 6.5),
                         leg_pos = "none")
...
full_plist <- list()
full_plist[[1]] <-
  plot_biomass(d_obj = d_obj_bridge_biomass)
...
# TODO: Change this to new plot function (Jan 18 2023)
make.comparison.plot(c(list(base_model), sens_models[[1]]),
                     subplots = 2,
...
make.comparison.plot(c(list(base_model), sens_models_1),
                     subplots = 4,
                     model.names = c(base_model_name, sens_model_names_1),
                     legend = FALSE,
                     end_yr = end_yr,
                     btarg = 0.4)
@
...
make.comparison.plot(c(list(base_model), sens_models_2),
                     subplots = 2,
                     model.names = c(base_model_name, sens_model_names_2),
                     end_yr = end_yr)
@
\end{center}
...
make.comparison.plot(c(list(base_model), sens_models_4),
                     subplots = 2,
                     model.names = c(base_model_name, sens_model_names_4),
                     end_yr = end_yr)
@
\end{center}
...
make.comparison.plot(c(list(base_model), sens_models_6),
                     subplots = 2,
                     model.names = c(base_model_name, sens_model_names_6),
                     legend = TRUE,
                     end_yr = end_yr)
@
\end{center}
