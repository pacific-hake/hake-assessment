...
@
\end{center}
\caption{Acoustic survey biomass indices with and without extrapolation (millions of metric tons). Approximate 95\% confidence intervals are based on only sampling variability (and squid/hake apportionment uncertainty in 2009).}
