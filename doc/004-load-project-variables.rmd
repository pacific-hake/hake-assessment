...
dm_weight_fishery_lower <- f(base_model$mcmcvals$dm_weight_fishery_lower,3)
dm_weight_fishery_median <- f(base_model$mcmcvals$dm_weight_fishery_median,3)
dm_weight_fishery_upper <- f(base_model$mcmcvals$dm_weight_fishery_upper,3)
dm_weight_survey_lower <- f(base_model$mcmcvals$dm_weight_survey_lower,3)
dm_weight_survey_median <- f(base_model$mcmcvals$dm_weight_survey_median,3)
dm_weight_survey_upper <- f(base_model$mcmcvals$dm_weight_survey_upper,3)
