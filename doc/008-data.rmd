...
and Figure~\@ref(fig:main-age-comp-bubbles-fig)). Currently, the 2020
cohort is the largest observed cohort in the U.S. at-sea sector (Tables~\@ref(tab:main-us-cp-age-data-tab)--\@ref(tab:main-us-ms-age-data-tab)),
the 2016 cohort is the largest observed cohort in the U.S. shore-based fleet (Table~\@ref(tab:main-us-sb-age-data-tab)) and both Canadian fleets (Tables~\@ref(tab:main-can-ss-age-data-tab)--
\@ref(tab:main-can-ft-age-data-tab)).
Age-1 fish were observed by the fishery this year
(Table~\@ref(tab:main-input-age-data-fishery-tab)) in the U.S. at-sea sector and
