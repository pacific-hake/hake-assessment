...
denominator for aggregating at-sea and shore-based fishery samples because
detailed haul-level information is not recorded for trips in the shore-based
fishery and hauls sampled in the at-sea fishery cannot be aggregated to a
comparable trip level. As a result, initial sample sizes are simply the
summed hauls and trips for fishery biological data.
