...
(Figures~\@ref(fig:main-weight-at-age-fig)--
\@ref(fig:main-weight-at-age-lines-fig)). Past investigations into calculating
...
samples (Figure \@ref(fig:main-sample-size-weight-at-age-fig)) is
...
(Figure~\@ref(fig:main-weight-at-age-fig)). Prior to 1975,
...
(Figure~\@ref(fig:main-weight-at-age-fig)). Both forecast
...
parametric models to represent growth relationships. Previous attempts to
explicitly model year- and cohort-specific growth were not successful for
`r sp` and have not been revisited since @StewartForrestEtAl2011. The
empirical weight-at-age method requires the assumption that observed values
are not biased by strong selectivity at length or weight and that the spatial
and temporal patterns of the data sources provide a representative view of the
underlying population. Simulations show that, in general, using empirical
