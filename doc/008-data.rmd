...
consists of approximately 100 fish in two separate bags. Bags are used to
separate the 50 fish taken from a given tow. Due to unforeseen circumstances
while at sea, some trips did not deliver any samples and some only brought
single bags.
...
and 300 lengths were sampled from the catch. Observed domestic haul-level
information is aggregated to the trip level to be consistent with the
unobserved trips that were sampled in ports.

When there has been a Canadian Joint-Venture fishery, length samples were
collected every second day of fishing operations and otoliths were collected
once per week. Length and age samples were taken randomly from a given codend.
The sample weight from which biological information is collected must be
