...
years (Figure~\@ref(fig:main-backscatter-map-fig)). This variability is due in
...
(Figure~\@ref(fig:main-backscatter-map-fig)). Weak 2019 El Ni\~no conditions
...
(Table~\@ref(tab:main-survey-history-tab) and
Figure~\@ref(fig:main-age-one-index-fig)). In 2021, some age-1 fish were found
...
samples (Figure \@ref(fig:main-empirical-weight-at-age-numbers-fig)) is
...
(Figure~\@ref(fig:main-empirical-weight-at-age-fig)). Prior to 1975,
...
(Figure~\@ref(fig:main-empirical-weight-at-age-fig)). Both forecast
...
(Figure~\@ref(fig:main-empirical-weight-at-age-fig)).
