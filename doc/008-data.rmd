...
(Table~\@ref(tab:main-ovaries-tab)). Samples from south of Point Conception
(34.44° N) were excluded from this analysis because they were thought
...
34.44° N are from the same stock as the rest of the coastal population.
...
ages 15-20 in the population dynamics model
(Figure~\@ref(fig:main-maturity-ogive-fig)).
...
A generalized linear model (GLM) with a lognormal distribution was used to
model weight-at-age data external to the assessment. Weight was thought to
