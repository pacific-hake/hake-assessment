...
\item Investigate links between hake biomass, its spatial distribution and how
these dynamics vary with ocean conditions and ecosystem variables such as
...
\item Continue development of the MSE tools to evaluate major sources of
...
from JMC/AP/SRG/MSE Advisory Panels into operating model
development. Specifically, make sure that the operating model is able to provide
...
\item Conduct research to improve the acoustic survey estimates of age and
...
analysis methods. Apply bootstrapping methods to the acoustic survey time-series
...
work with acousticians and survey personnel from the NWFSC, the SWFSC, and DFO
to determine an optimal design for the Joint U.S./Canada acoustic survey.
Develop automation and methods to allow for the availability of biomass and age
