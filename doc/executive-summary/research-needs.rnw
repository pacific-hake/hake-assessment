...
\item Continue investigation of links between hake biomass,
...
Regional Ocean Modeling System; ROMS) so that they are available stock-wide and can be
...
from interested parties into further development of operating and/or
estimation models, through the Pacific Hake MSE Working Group. Utilize and adapt
this simulation framework to address new and ongoing (see Section~\ref{sec:research})
stock assessment research and data needs.
...
\item Document existing acoustic survey methodologies, protocols, and adaptive survey
design decisions that lead to the development of \fishname biomass and age composition estimates
used in the stock assessment. Such a document will ensure transparency, enable repeatability, and
provide a record of changes in procedures over time. Continue to conduct research to improve
the acoustic survey estimates of age and
...
work with acousticians and survey personnel from the Northwest Fisheries Science Center and
