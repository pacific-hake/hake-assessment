...
Regional Ocean Modeling System; ROMS) so that they can be used on a reoccurring basis as
informative links in operational stock assessments.
...
estimation models, through the Pacific Hake MSE Working Group.
