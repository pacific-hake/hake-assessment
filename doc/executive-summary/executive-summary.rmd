...
predictive skill (e.g., Vestfals et al, under review). Explorations should
...
from J-SCOPE (\href{http://www.nanoos.org/products/j-scope/home.php}
{http://www.nanoos.org/products/j-scope/home.php}). The existing management
strategy evaluation framework should be used, or further developed, to
examine how information on recruitment can inform robust management decisions.

1. Document the existing survey methodologies, protocols, and adaptive
...
limited to, research on species identification, target verification, target
...
U.S. Re-Envisioning West Coast Surveys Initiative) and Fisheries and Oceans
