...
(relative to the $\Fforty$ management level) through `r end_yr - 1`} with
95% posterior credibility intervals. The $\Fforty$ management level defined
...
the 95% posterior credibility interval reaching above the $\Fforty$ management
...
The benchmark quantities, $\Fforty$ and $\Bforty$, result in different median
...
```{r reference-points-table, results = "asis", echo = FALSE}
