...
\item Continue to investigate fecundity and maturity, including 
  trying to undestand links between fecundity and size, age, weight, and batch 
  spawning.
  
\item Explore the use of genetics and other methods to explore potential
  stock differences north and south of Point Conception that may be related to
  the observed differences in maturity.
