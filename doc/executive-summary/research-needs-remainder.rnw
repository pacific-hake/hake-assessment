...
\item Explore potential recruitment indices for juvenile or young (0 and/or
  ...
  linkages. Also investigate alternative ways to model and forecast recruitment, given
  the uncertainty present.

\item Develop a set of candidate ecosystem indicator variables that are potentially
...
\item Conduct an inter-laboratory otolith exchange and ageing comparison
  analysis to update ageing error calculations used in the stock assessment.
...
\item Continue to collect and analyze life-history data, including weight,
  ...
  growth and population density. Improve understanding of links between fecundity
