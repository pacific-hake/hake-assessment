...
\Sexpr{last.data.yr} fishery catch and fishery age compositions. The mean 
weight-at-age for \Sexpr{last.data.yr} was added and minor refinements to historical
