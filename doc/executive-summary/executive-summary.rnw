...
have low recruitment with occasional large year-classes
...
2008 year class. The current assessment continues to estimate a very strong
...
target SPR of 40\%; it is reported here interchangeably as a decimal proportion or a percentage.
...
highly dynamic nature of the stock due to high variation in recruitment strength.
...
catch.  However, comparable results in terms of catch may be achieved with a
