...
**Mention time-varying fecundity here maybe. And likely earlier as a major
change to 2018 base model. SRG-requested fecundity run was mentioned here last year.
