...
\Sexpr{curr.depl.upper}\% (Table~\ref{tab:es-biomass}), due to high uncertainty about the size
...
(\Sexpr{prev.bio.lower}--\Sexpr{prev.bio.upper})~million~t. This is
higher than the \Sexpr{prev.bio.median.last.assess}
