...
assessment. The increase appears to be due to the information in the 2021 survey data.
% Manual 2022 done (updated numbers in final sentence and revised text).
