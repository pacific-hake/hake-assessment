...
\begin{itemize}
   ...
   \item set pre-1975 weight-at-age where empirical data are not available to the mean 
   weight-at-age over 1975--1979;
   \item set equilibrium weight-at-age conditions to the mean weight-at-age from 1975--1979; and
   \item set forecast year (including 2017 due to current configurations in Stock Synthesis) 
   weight-at-age to the mean weight-at-age over 2015--2017. 
