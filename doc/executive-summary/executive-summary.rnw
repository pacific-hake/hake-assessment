...
\end{center}
%\vspace{0mm}
\caption{Relative age-1 index (numbers of fish)
...
landings (\Sexpr{start.yr}--\Sexpr{last.data.yr}), an acoustic survey biomass
index (Figure~\ref{fig:es-survey-biomass}) and age compositions
...
biomass index, acoustic survey age-composition data, the age-1 index, and fishery
