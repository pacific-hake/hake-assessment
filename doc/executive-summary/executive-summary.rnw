...
an agreement on a coast-wide 2020 TAC. The U.S. allotment was
\Sexpr{us.allotment.percent.last.year}\% of the coast-wide TAC and the Canada allotment was
\Sexpr{can.allotment.percent.last.year}\%, compared to the usual
\Sexpr{us.allotment.percent}\% and \Sexpr{can.allotment.percent}\% as specified
in the Joint U.S.-Canada Agreement for \fishname.
