...
Due to staffing issues, age data from \Sexpr{end.yr-1} were unavailable from the Canadian
freezer-trawler fleet and minimally available for the shoreside fleet.
...
\Sexpr{f(((recruitment.med.to.compare - prev.assess.recruitment.med)["2014"])*1000, 0)}~million
...
(\Sexpr{f(((recruitment.med.to.compare - prev.assess.recruitment.med)["2018"])*1000, 0)}~million fish),
...
informed by the \Sexpr{last.survey.year} survey and fishery data, but has no age-1 index.
...
fraction was the highest in 2017 followed closely by 2020 and 2021 (Table~\ref{tab:es-fishing-intensity}).
