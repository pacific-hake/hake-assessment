...
median and narrower credibility interval than the \Sexpr{prev.bio.median.last.assess}
...
this assessment's median estimate of the 2010 recruitment is
...
assessment model results would have otherwise suggested given mortality.
...
**The 2014 year class is likely larger than average but has only a
...
make.landings.tac.table(landings.vs.tac,
                        ...
                        xcaption = "Recent trends in \\fishname\\ landings and
                                     management decisions. **Mention 2020 TAC not the usual ratio??",
