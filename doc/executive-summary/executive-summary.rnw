...
an agreement on a coast-wide 2020 TAC. The U.S. caught
\Sexpr{us.allotment.percent.last.year}\% and Canada 
\Sexpr{can.allotment.percent.last.year}\% of the total \Sexpr{end.yr-1}
coast-wide \fishname catch.
