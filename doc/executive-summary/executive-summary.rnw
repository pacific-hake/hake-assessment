...
Auto-Differentiation No-U-Turn-Sampling (AD-NUTS) algorithm \citep{Monnahan2018, Monnahan2019} for efficient MCMC sampling
...
numerous sampling, which may not be the case for the existing age-1 index and
...
As the large 2010 and 2014 cohorts continue to age, biomass is expected to decrease
