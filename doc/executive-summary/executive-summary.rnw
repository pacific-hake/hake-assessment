...
age-compositions (1975--\Sexpr{last.age.yr}). The 2011 survey index value
...
Figure~\ref{fig:es-exploitation-fraction}). Note that in earlier assessments the
exploitation fraction was defined in terms of fish age-3 and above, but in
the 2018 assessment (and here) we revised the definition year because age-2
