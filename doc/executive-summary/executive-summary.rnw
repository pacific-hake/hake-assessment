...
in 2015, and then it leveling off around 75\% from 2016 to 2019 before dropping to
\Sexpr{exploitation.med.2020}\% in \Sexpr{end.yr-1}.
...
make.landings.tac.table(landings.vs.tac,
                        ...
                        xcaption = "Recent trends in \\fishname\\ landings and
                                     ...
                                     agreement on a coastwide 2020 TAC.",
