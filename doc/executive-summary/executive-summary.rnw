...
shown relatively similar patterns (Figure~\ref{fig:es-exploitation-fraction}). Fishing intensity is estimated to have declined from **100.3\% in 2010 to 61.6\% in 2014 while
