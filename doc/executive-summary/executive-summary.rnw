...
(Figure~\ref{fig:es-survey-biomass}). 

**
New data for this \Sexpr{assess.yr}
...
weight-at-age for \Sexpr{last.data.yr} was also added and minor refinements to historical
catch estimates were also made. 
%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[tbp]
\begin{center}
