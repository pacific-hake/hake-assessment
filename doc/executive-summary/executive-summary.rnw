...
During the 2018 Scientific Review Group meeting (SRG), an additional sensitivity model was
evaluated at the request of the SRG that resulted in a plausible alternative to the
base model.  This alternative model includes the following changes from the base model
...
the sensitivity of the alternative model to removing this inconsistency showed
relatively little change to this difference.
