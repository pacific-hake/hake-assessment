...
\subsection*{Stock} \label{sec:es-stock} \addcontentsline{toc}{subsection}{Stock}
...
\subsection*{Catches} \label{sec:es-catches} \addcontentsline{toc}{subsection}{Catches}
...
\subsection*{Data and Assessment} \label{sec:es-data-and-assessment} \addcontentsline{toc}{subsection}{Data and Assessment}
...
\subsection*{Stock Biomass} \label{sec:es-stock-biomass} \addcontentsline{toc}{subsection}{Stock Biomass}
...
\subsection*{Recruitment} \label{sec:es-recruitment} \addcontentsline{toc}{subsection}{Recruitment}
...
\subsection*{Exploitation Status} \label{sec:es-exploitation-status} \addcontentsline{toc}{subsection}{Exploitation Status}
...
\subsection*{Management Performance} \label{sec:es-management-performance} \addcontentsline{toc}{subsection}{Management Performance}
...
\subsection*{Reference Points} \label{sec:es-reference-points} \addcontentsline{toc}{subsection}{Reference Points}
...
\subsection*{Unresolved Problems and Major Uncertainties} \label{sec:es-unresolved-problems} \addcontentsline{toc}{subsection}{Unresolved Problems and Major Uncertainties}
...
\subsection*{Forecast Decision Table} \label{sec:es-forecast-decision-table} \addcontentsline{toc}{subsection}{Forecast Decision Table}
The median catch for \Sexpr{end.yr} based on the default harvest policy (F\subscr{40\%} -- 40:10) is \textbf{FIX..804,576} t, but has a
...
represented from within the base model. The decision table (split into \textbf{FIX..Table g.1 and Table g.2}) is organized such that
...
The first table (Table g.1) shows projected relative spawning biomass outcomes, and the second (Table \textbf{FIX..g.2}) shows projected
...
\subsection*{Research and Data Needs} \label{sec:es-research-data-needs} \addcontentsline{toc}{subsection}{Research and Data Needs}
