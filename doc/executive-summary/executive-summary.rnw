...
removals were from foreign or joint-venture fisheries.
...
the last five years, catches were above the long-term average catch
...
in 2012, 2013, and 2015; the 2019 estimate is the fourth highest of the series.
...
inter-annual variability in catch compared to assessment models that force
...
We retain the Dirichlet-Multinomial approach to weighting
composition data with the addition of an almost uniform prior placed on
the Dirichlet-Multinomial parameters.
...
Although, the weight-at-age information for the forecast period
was changed to be a representation of the last five years rather than
all years such that the year range matched that used for selectivity and
other processes.
...
declined since 2017, during a time of record catches.
% Manual 2020 done.
