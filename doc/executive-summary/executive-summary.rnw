...
\section*{Executive Summary}\addcontentsline{toc}{chapter}{Executive Summary}
...
<<results='asis', echo=FALSE>>=
make.biomass.table(models[[base.model.ind]], start.yr=2006, end.yr=2015, weight.factor=1000,
