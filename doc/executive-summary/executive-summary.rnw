...
cohorts, has resulted in a fairly flat trajectory over the past 6 years.
% Manual 2018 done.
...
$B_0$) is \Sexpr{curr.depl.median}\%. However, the uncertain around that median
is large, wwith a 95\%
...
\Sexpr{curr.bio.upper}~million~t). The median estimate of the \Sexpr{end.yr-1} female
