...
comprising \Sexpr{year.class.2010.in.2013}\% of the coast-wide commercial catch in 2013, \Sexpr{year.class.2010.in.2014}\% of the 2014 catch, and \Sexpr{year.class.2010.in.2015}\% of the 2015 catch. 

**AE not sure where to get the uncertainties from for the next sentence. I think for same reason that CG couldn't get error bars on the rainbow cohort plot -- see issue number 9.
% Andy got to here with automating and flagging.

** Its size is still more uncertain than cohorts
