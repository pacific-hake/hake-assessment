...
of the 2020 cohort, which has not been sampled by the acoustic survey. The median estimate of
...
$(1-\mbox{SPR}(F))/(1-\mbox{SPR}_{40\%})$, where $\mbox{SPR}_{40\%}$ is specified in the
Agreement; it is reported here interchangeably as a proportion or a percentage.
...
with the 95\% posterior credibility interval reaching above $\Fforty$ management level
...
The median relative fishing intensity was below $\Fforty$ in all years
...
intensity was below the $\Fforty$ management level
...
joint probability of being both above the $\Fforty$ relative fishing intensity
