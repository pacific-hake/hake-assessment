...
\Sexpr{f(cohort_catch.1999/1e6,2)}~million~t. Through \Sexpr{last_data_yr}, the
cumulative catch of the 2010, 2014, and 2016 year classes is estimated to be about
\Sexpr{f(cohort_catch.2010/1e6,2)}~million~t,
\Sexpr{f(cohort_catch.2014/1e6,2)}~million~t, and
\Sexpr{f(cohort_catch.2016/1e6,2)}~million~t,
respectively.
