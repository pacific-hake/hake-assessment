...
The addition of \Sexpr{last_data_yr} data for this assessment does not significantly change the
...
high chance (\Sexpr{prob.percent.2014.rec.gt.2016.rec}\%) that 2014 is
larger than 2016 but zero chance that it is larger than 2010. % prob.percent.2014.rec.gt.2010.rec
With the addition of the relative age-1 index, there is information beyond just fishery encounters in
