...
commercial catch in 2014, \Sexpr{top.coh(base.model, 2016, spec.yr=2010)}\% of the 2016 catch, and
\Sexpr{top.coh(base.model, 2018, spec.yr=2010)}\% of the catch in 2018. The smaller proportion of
