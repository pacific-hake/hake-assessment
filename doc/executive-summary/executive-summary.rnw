...
Over the last decade, the average coast-wide utilization rate (i.e., utilization = landings/quota) has been \Sexpr{tot.last.10.years.attainment}\%.
...
2007, median fishing intensity was below target and female spawning biomass was near or above target (**says tab: Figure~\ref{tab:es-landings-tac}).
