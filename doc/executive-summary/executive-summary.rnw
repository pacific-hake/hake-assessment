...
pattern of recruitment estimated in recent assessments. **[NEED TO EXPLAIN THIS
NEXT BIT, see Issue \#629,
and make sure shows up clearly in bridging recruitment plot] However, estimated
recruitments for some years have changed. For example, this year's median assessment
of the 2010 recruitment is
\Sexpr{f((recruitment.med.to.compare - prev.assess.recruitment.med)["2010"], 1)}~billion
more fish than last year's assessment.
