...
The biomass estimate and age composition from the acoustic survey conducted in 2015 has been added to the model survey time series. The only other new data included
