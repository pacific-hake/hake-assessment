...
\begin{enumerate}[noitemsep,nolistsep]
  ...
  \item Continue to investigate maturity observations of Pacific Hake and explore additional sampling sources to determine fecundity and
    ...
    \end{enumerate}
    NGT: i think the item below, as edited should move up in prominence to be number 1 or 2.
  \item Investigate links between hake biomass, its spatial distribution and how these dynamics vary with ocean conditions and ecosystem variables such as temperature
