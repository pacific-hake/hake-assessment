...
%% assessment, that were not in the \Sexpr{last.assess_yr} assessment,
%% are the
...
as the base assessment model from \Sexpr{last.assess_yr} as well as many of the previous
elements as configured in Stock Synthesis. The main change from \Sexpr{last.assess_yr} is
...
is a representation of the last five years, as for the \Sexpr{last.assess_yr} assessment.
...
10\% higher than in the \Sexpr{last.assess_yr} assessment.
