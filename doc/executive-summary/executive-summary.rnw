...
\begin{figure}[tbp]
\begin{center}
<<recruitment, fig.height=5, fig.width=8, is.fig = TRUE, alt.text = "This figure shows recruitment for 2010 2014 and 2016 cohorts which are the largest in the stock with 2020 possibly being large but highly uncertain">>=
