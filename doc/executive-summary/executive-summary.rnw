...
2015 and 2017 year classes (median recruitment below the mean of all median recruitments).
...
The 2014 year class is likely larger than average though not as large as 
the 2010 year class.
