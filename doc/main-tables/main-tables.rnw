...
make.decision.table(base.model,
                    xcaption = paste0("Decision table of forecast quantiles ",
                                      ...
                                      "--",
                                      max(forecast_yrs),
                                      " catch alternatives presented in Table \\ref{tab:main-decisions-biomass}. Values greater than 100\\% indicate fishing intensities greater than the F\\subscr{40\\%} harvest policy calculated using baseline selectivity."),
...
make.short.parameter.estimates.table(base.model,
  ...
  xcaption = paste0("Select parameters, derived quantities, ",
                     ...
                     "MLE and posterior median (MCMC) estimates with ",
                     "an additional comparison to posterior median ",
                     "estimates from the Automatic Differentiation (AD) No-U-Turn ",
                     "Sampler (NUTS)."),
