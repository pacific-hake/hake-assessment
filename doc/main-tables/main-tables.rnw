...
make.catches.table.US(catches, start.yr=start.yr, end.yr=end.yr,
                   weight.factor=1000,
                   xcaption = paste("Annual catches of \\fishname\\ (t) in U.S. waters by sector, ", start.yr, "-", end.yr, ". Tribal catches are included in the sector totals.", sep=""),
...
make.catches.table.Can(catches, start.yr=start.yr, end.yr=end.yr,
                   weight.factor=1000,
                   xcaption = paste("Annual catches of \\fishname\\ (t) in Canadian  waters by sector, ", start.yr, "-", end.yr, ".", sep=""),
...
make.catches.table.total(catches, start.yr=start.yr, end.yr=end.yr,
                   weight.factor = 1000,
                   xcaption = paste("Total U.S., Canadian and coastwide catches  of \\fishname\\ (t) from ", start.yr, "-", end.yr, ". The percentage of the total catch from each country's waters is also given.", sep=""),
