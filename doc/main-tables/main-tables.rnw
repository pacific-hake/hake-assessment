...
make.us.age.data.table(us.cp.age,
                       fleet = 1,
                       xcaption = "Age proportions used in the assessment for the U.S. Catcher-processor fleet.",
...
make.us.age.data.table(us.ms.age,
                       fleet = 2,
                       xcaption = "Age proportions used in the assessment for the U.S. Mothership fleet.",
...
make.us.age.data.table(us.shore.age,
                       fleet = 3,
                       xcaption = "Age proportions used in the assessment for the U.S. Shoreside fleet.",
...
make.can.age.data.table(can.ages,
                        fleet = 1,
                        start.yr = 2008,
                        xcaption = "Age proportions used in the assessment for the Canadian Shoreside fleet.",
                        xlabel = "tab:main-can-age-data",
                        font.size = 8,
                        space.size = 10,
                        decimals = 4)
@
...
make.can.age.data.table(can.ages,
                        fleet = 2,
                        start.yr = 2008,
                        xcaption = "Age proportions used in the assessment for the Canadian Freezer Trawler fleet.",
                        xlabel = "tab:main-can--age-data",
                        font.size = 8,
                        space.size = 10,
                        decimals = 4)
