...
make.catches.table.total(catches,
                         ...
                         xcaption = paste("Total U.S., Canadian and coast-wide
...
make.sampling.history.table(sampling.history,
                            xcaption =
                              "**[2020 row needs updating; disagrees with next table] Annual summary of U.S. and Canadian
...
make.maturity.ogives.table(maturity.ogives,
                           xcaption = paste0("**Information on maturity and fecundity used in this assessment as
                                       ...
                                       "--",
                                       last.data.yr,
                                       " were used in the stock assessment. The values reported for ages 15 and above                                                represent the average across all samples in this range."),
...
make.maturity.samples.table(ovary.samples,
                            xcaption = "**[final row need updating?] Number of \\fishname\\ ovaries collected for histological analysis.
...
make.parameters.estimated.summary.table(
  ...
  digits = 2,
  xcaption = paste0("**sigmaR currently rendering wrong Summary of estimated model parameters and priors in the base model.
...
make.short.parameter.estimates.sens.table(retro.list,
                                          ...
                                          digits = 3,
                                          xcaption =
                                            paste0("**[fix thetas, still MLE for base?] Select parameters, derived quantities,
...
\newgeometry{hmargin=0.95in,vmargin=1in}
\thispagestyle{lscape}
\begin{landscape}
  \centering
...
make.short.parameter.estimates.table(
  ...
  digits = 3,
  xcaption =
    paste0("**[currently missing first two values in penultimate row; checked that 2020 base model values are correct] Select parameters, derived quantities, ",
...
make.decision.table(base.model,
                    xcaption = paste0("**[check, though caption is automated] Forecast quantiles of \\fishname\\
...
make.short.parameter.estimates.sens.table(sens.models.1.for.table,
                                          ...
                                          age.1 = TRUE,
                                          digits = 3,
                                          xcaption = paste0("**Maximum likelihood
...
%                      "MLE and posterior median (MCMC) estimates with ",
%                      "an additional comparison to posterior median ",
%                      "estimates from the No-U-Turn ",
%                      "Sampler (NUTS)."),
%   xlabel = "tab:main-parameter-estimates-sens-4",
%   font.size = 9,
%   space.size = 10,
%   last.yr.model.name = c("AD", "NUTS"))
% @
% \end{landscape}
% \restoregeometry
% \pagestyle{fancy}
