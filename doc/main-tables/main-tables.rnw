...
atage_table(
  ...
  xcaption = paste0("Estimated catch-at-age in biomass ",
                    "for each year from the base model (MCMC medians; metric tons)."),
...
param_est_table(list(base.model, last.yr.base.model),
                ...
                xcaption =
                  paste0("Select parameters, derived quantities, ",
                         ...
                         "posterior median (MCMC) estimates with ",
                         "compared to posterior median ",
                         "estimates from the previous assessment's (",
                         end.yr - 1, ") base model."),
