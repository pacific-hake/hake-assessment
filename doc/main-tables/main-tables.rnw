...
make.survey.summary.table(survey.summary,
                          digits = 3,
                          xcaption = paste0("Biomass index estimates from the acoustic survey (million~t) used in the 2016 and 2017 assessments."),
