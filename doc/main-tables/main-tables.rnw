...
make.assessment.changes.table(assessment.changes,
                              xcaption = paste0("**[Add 2022] Annual changes in the modeling framework used to assess ",
                                                "\\fishname\\ since 2011. ",
...
make.median.posterior.table(
  ...
  csv.dir = output.csv.dir,
  xcaption = paste0("[**Check total biomass; copy table from errata?]Time series of median posterior population estimates from the base
...
<<main-decisions-biomass-table-old, results='asis', echo=FALSE>>=
make.decision.table(base.model,
                    xcaption = paste0("**[NEW FORMAT IN NEXT TABLE] Forecast quantiles of
                     ...
                     max(forecast_yrs),
                     "."),
                    xlabel = "tab:main-decisions-biomass-old",
                    font.size = 10,
                    space.size = 11,
                    type = "biomass")
@
...
make.decision.table(base.model,
                    xcaption =
                      paste0("**[For new format use type equals spr in new.decision.table; so some of previous table and some options from here, including caption] Decision table of forecast quantiles ",
