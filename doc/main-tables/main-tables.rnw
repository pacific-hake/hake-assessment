...
make.short.parameter.estimates.table(base.model,
                                     ...
                                     digits = 3,
                                     xcaption <- paste0("Select parameters, derived quantities, and reference point estimates for the base model MLE and posterior median (MCMC) estimates with a additional comparison to posterior median estimates from the previous (",end.yr-1,") base model."),
...
make.short.parameter.estimates.sens.table(sens.models.1.for.table,
                                          ...
                                          digits = 3,
                                          xcaption <- paste0("Maximum likelihood estimates (MLE) of select parameters, derived quantities, and reference points for the base model and sensitivity runs (described
