...
<<main-biomass-table-new, results='asis', echo=FALSE>>=
new_decision_table(base.model,
                   xcaption =
                     paste0("**[NEW FORMAT - third row will get automatically added when base model run long enough; change xlabel to previous table's one when we delete previous table]. Forecast quantiles of \\fishname\\
                     relative spawning biomass at the beginning of the year.
