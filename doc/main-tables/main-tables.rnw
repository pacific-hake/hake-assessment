...
param_est_table(retro.list,
                ...
                xcaption = "Medians of the MCMC posteriors from the base model for
                            ...
                            analysis. Dashes indicate that the parameter or derived quantity was not estimated in the model.",
...
atage_table(
  ...
  xcaption = paste0("Estimated numbers-at-age at the beginning ",
                    "of the year from the base model (MCMC medians; million)."),
...
atage_table(
  ...
  xcaption = paste0("Estimated biomass-at-age at the beginning ",
                    "of the year from the base model (MCMC medians; thousand t)."),
...
atage_table(
  ...
  xcaption = paste0("Estimated exploitation-rate-at-age ",
                    ...
                    "for each year from the base model (MCMC medians; percentage of age class removed by fishing). ",
...
atage_table(
  ...
  xcaption = paste0("Estimated catch-at-age in numbers ",
                    "for each year from the base model (MCMC medians; thousands)."),
...
atage_table(
  ...
  xcaption = paste0("Estimated catch-at-age in biomass ",
                    "for each year from the base model (MCMC medians; t)."),
...
cohort_table(base.model,
             ...
             xcaption = paste0("For the strong cohorts, calculations of
                                    ...
                                    medians of the MCMC posteriors."),
...
make.median.posterior.table(
  ...
  xcaption = paste0("Time series of median posterior population estimates from the base
                     ...
                     Relative fishing intensity is (1-SPR)/(1-SPR\\subscr{40\\%}). Dashes in cells
                     for ", end.yr, " indicate quantities that are calculated using ", end.yr, " catch
...
make.ci.posterior.table(
  ...
  xcaption = paste0("Time-series of 95\\% posterior credibility intervals for the quantities
                     shown in Table \\ref{tab:main-median-posterior}. Dashes in cells
                     for ", end.yr, " indicate quantities that are calculated using ", end.yr, " catch
                    which has not yet occurred."),
...
param_est_table(list(base.model, last.yr.base.model),
                ...
                xcaption =
                  paste0("Select parameters, derived quantities, ",
                         "and reference point posterior median (MCMC) ",
                         "estimates for the (",
                         end.yr, ") base model ",
...
param_est_table(sens.models.1.for.table,
                ...
                digits = 3,
                xcaption = paste0("Medians of MCMC posteriors for select parameters, derived quantities,
                                  ...
                                  Dashes indicate that the parameter or derived quantity was not estimated in the model."),
...
param_est_table(sens.models.2.for.table,
                ...
                digits = 3,
                xcaption = paste0("Medians of MCMC posteriors for select parameters,
...
param_est_table(sens.models.3.for.table,
                ...
                xcaption = paste0("Medians of MCMC posteriors for select parameters,
                                   ...
                                   for the base model and further sensitivity runs (described in
                                   Section~\\ref{sec:assessment-sensitivity-analyses}).
                                  Dashes indicate that the parameter was not estimated in the model."),
