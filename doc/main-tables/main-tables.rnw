...
\caption{Summary of models runs that consider alternative assumptions concerning
  ...
  Results from the MCMC runs 52, 56 and 58
  are given in Appendices~\ref{chap:fecundity-52}, \ref{chap:fecundity-56},
  and \ref{chap:fecundity-58}. $^a$Due to the configuration of Stock Synthesis
