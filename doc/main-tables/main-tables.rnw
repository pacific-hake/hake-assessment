...
<<<<<<< HEAD
<<<<<<< HEAD
                   xcaption = paste("Annual catches of \\fishname\\ (t) in U.S. waters by sector, ", start.yr, "-", last.data.yr, ". Tribal catches are included in the sector totals. Research Catch includes landed catch associated with research-related activities. Unlanded catch associated with surveys and bycatch in fisheries not targetting hake are not currently included in the model.", sep=""),
=======
                   xcaption = paste("Annual catches of \\fishname\\ (t) in U.S. waters by sector, ", start.yr, "-", last.data.yr, ". Tribal catches are included in the sector totals. Research Catch includes landed catch associated with research-related activities. Catch associated with surveys and bycatch in fisheries not targetting hake is not currently included in the model.", sep=""),
>>>>>>> cgrandin/master
=======
                   xcaption = paste("Annual catches of \\fishname\\ (t) in U.S. waters by sector, ", start.yr, "-", last.data.yr, ". Tribal catches are included in the sector totals. Research Catch includes landed catch associated with research-related activities. Catch associated with surveys and bycatch in fisheries not targetting hake are not currently included in the model.", sep=""),
>>>>>>> cgrandin/master
...
make.us.age.data.table(us.cp.age,
                       ...
                       xcaption = paste0("Most recent 9 years ",
                                         "of age proportion data (as percentages) used in the assessment for ",
                                         "the U.S. Catcher-processor fleet."),
...
make.can.age.data.table(can.ages,
                        ...
                        xcaption = paste0("Most recent 9 years ",
                                          "of age proportion data (as percentages) used in the assessment for ",
                                          "the Canadian Freezer Trawler fleet."),
...
make.median.posterior.table(base.model,
                            ...
                            xcaption = paste0("Time-series of median posterior population estimates from the base model. Relative spawning biomass is spawning biomass relative to the unfished equilibrium ($\\Bzero$). Exploitation fraction is total catch divided by total age-3+ biomass. Relative fishing intensity is (1-SPR)/(1-SPR\\subscr{40\\%})."),
