...
make.maturity.ogives.table(maturity.ogives,
                           xcaption = "Information on maturity and fecundity used in this assessment as
                                       ...
                                       year-specific fecundities from **1975-2018 were used in the stock
                                       assessment. The values reported for ages 15 and above represent the
                                       average across all samples in this range.",
...
make.maturity.samples.table(ovary.samples,
                            xcaption = "Number of \\fishname\\ ovaries collected for histological analysis.
                                        ...
                                        (up to and including 2017) -- see \\citet{JTC2018}.
                                        **unchanged I think",
...
make.parameters.estimated.summary.table(
  ...
  xcaption = paste0("Summary of estimated model parameters and priors in the base model.
                     ...
                     deviation in log space.**ADD DM prior"),
...
make.ci.posterior.table(
  ...
  xcaption = paste0("Time-series of 95\\% posterior credibility intervals for the quantities
                     shown in Table \\ref{tab:main-median-posterior}."),
...
make.reference.points.table(base.model,
                            xcaption = paste0("Summary of median and 95\\% credibility
                                               intervals of equilibrium reference points for
                                               the \\fishname\\ base assessment model. **Equilibrium
                                               reference points were computed using 1975--",
                                              end.yr-1,
...
make.decision.table(base.model,
                    xcaption = paste0("Decision table of forecast quantiles ",
                                      "of \\fishname\\ relative fishing intensity ",
                                      "(1-SPR)/(1-SPR\\subscr{40\\%}), expressed as ",
                                      "a percentage, for the ",
                                      min(forecast_yrs),
                                      "--",
                                      max(forecast_yrs),
                                      " catch alternatives presented in Table \\ref{tab:main-decisions-biomass}.",
                                      "Values greater than 100\\% indicate fishing intensities greater than the",
                                      "F\\subscr{40\\%} harvest policy calculated using baseline selectivity."),
...
make.short.parameter.estimates.sens.table(sens.models.1.for.table,
                                          ...
                                          age.1 = TRUE,
                                          digits = 3,
                                          xcaption = paste0("**NEED more [and next two tables]?? Maximum likelihood
                                                            estimates (MLE) of select parameters, derived quantities,
...
make.short.parameter.estimates.sens.table(sens.models.2.for.table,
                                          ...
                                          age.1 = FALSE,
                                          digits = 3,
                                          xcaption = paste0("**Maximum likelihood estimates (MLE) of select parameters,
