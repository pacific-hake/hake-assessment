...
make.parameters.estimated.summary.table(
  ...
  digits = 2,
  xcaption =
    paste0("Summary of estimated model parameters and priors in the base model. The Beta prior is parameterized with a mean and standard deviation. The Lognormal prior is parameterized with the median and standard deviation in log space."),
