...
make.decision.table(base.model,
                    xcaption =
                      paste0("**[For new format use type=spr in new_decision_table; so some of previous table and some options from here, including caption] Decision table of forecast quantiles ",
