...
make_landings_tac_table(ct,
                        ...
                        xcaption = "\\fishname\\ landings and
                                     ...
                                     this assessment.
                                     Catch targets in 2020 and 2021 were specified unilaterally.",
...
make.assessment.changes.table(assessment.changes,
                              xcaption = paste0("**[add 2023] Annual changes in the modeling framework used to assess ",
                                                "\\fishname\\ since 2011. ",
...
decision_table(base_model,
               xcaption =
                 paste0("**[if labels change] Forecast quantiles of \\fishname\\
...
param_est_table(sens_models_1_for_table,
                model.names = sens_model_names_1_for_table,
                end_yr = end_yr,
                digits = 3,
...
param_est_table(sens_models_2_for_table,
                model.names = sens_model_names_2_for_table,
                end_yr = end_yr,
                digits = 3,
