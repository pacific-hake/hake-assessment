...
# -----------------------------------------------------------------------------
# source `doc/002-load-globals.Rmd` to get forecast_yrs defined
nf <- length(forecast_yrs)
ct_level_lst <- set_ct_levels(nf)
ct_levels <- ct_level_lst$ct_levels
ct_levels_vals <- ct_level_lst$ct_levels_vals
