...
pfmc_prob_next_yr_below_b40 <-
  f(pull(base_model$risks[[1]][ct_default_policy_ind, paste0("Bratio_",
                                                        assess_yr + 1,
                                                        "<0.40")]), 0)
...
same_catch_prob_next_year_below_b40 <-
  f(pull(base_model$risks[[1]][ct_actual_ind, paste0("Bratio_",
                                                assess_yr + 1,
                                                "<0.40")]), 0)
same_catch_prob_yr_after_next_below_b40 <-
  f(pull(base_model$risks[[2]][ct_actual_ind, paste0("Bratio_",
                                                assess_yr + 2,
                                                "<0.40")]), 0)
