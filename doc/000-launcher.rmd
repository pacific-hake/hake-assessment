...
subtitle: DRAFT for submission to Scientific Review Group
project_variables:
  sp: "Pacific Hake"
...
# Quick fix to work on Windows, Chris to use an existing function
...
<!-- Disclaimer: These materials do not constitute a formal publication and are for
...
^3^ *Northwest Fisheries Science Center, National Marine
