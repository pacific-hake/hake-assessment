...
output:
 hake::hake_pdf:
   ...
   # Footer text and title page picture ----------------------------------------
   #
   title_page_image: "../beamer/images/hake-line-drawing.png"
   #title_page_image: "main-figures/hake-picture.png"
   ...
   # to access the hake::hake_pdf object
