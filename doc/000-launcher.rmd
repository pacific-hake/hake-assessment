...
output:
 hake::hake_pdf:
   ...
   # If `toc_underline_links` is `true`, then `toc_link_text_color` below
   # is ignored and text will be black. You can have either colored links
   # of colored text, but not both
   toc_underline_links: true
   ...
   toc_underline_link_color: Burlywood2
   toc_link_text_color: WildStrawberry
   includes:
