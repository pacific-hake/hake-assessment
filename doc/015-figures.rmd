...
```{r main-maturity-ogive-fig, fig.cap = "(ref:main-maturity-ogive-cap)", fig.height = 5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-maturity-ogive-alt)"}
plot_maturity_ogives(base_model, maturity_samples_df)
```
