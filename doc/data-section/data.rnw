...
Estimated age-2+ biomass in the survey has increased steadily over the four most recent surveys conducted in 2011-2013 and 2015. The 2015 survey biomass estimate is \Sexpr{fmt0(survey.biomass["2015"], 2)} million metric tons, which is \Sexpr{fmt0(survey.biomass["2015"]/survey.biomass["2012"],2)} times the 2012 survey biomass estimate and \Sexpr{fmt0(survey.biomass["2015"]/survey.biomass["2011"],2)} times the 2011 acoustic survey biomass estimate (Table~\ref{tab:main-survey-history} and Figure~\ref{fig:main-survey-biomass}). The 2015 survey age composition was made up of \Sexpr{survey.comps["2015","a5"]}\% age-5 fish from the 2010 year-class.
