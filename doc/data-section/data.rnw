...
An acoustic survey of age 2$+$ hake was included in this assessment, while bottom trawl, pre-recruit, and age-1 acoustic data sources were not used. See the 2013 stock assessment \citet(JTC 2013) for a more thorough description and history of these fishery-independent data sources.
