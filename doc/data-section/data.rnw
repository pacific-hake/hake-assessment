...
Tissue samples for genetical analyses have been collected from many of the same fish from which ovaries were sampled which may help determine whether the fish south of 34.5 degrees latitude are from the same stock as the rest of the population.
