...
Estimated age-2+ biomass in the survey has increased steadily over the four most recent surveys conducted in 2011-2013 and 2015. The 2015 survey biomass estimate is 25.00 million metric tons, which is 1.3 times the 2013 survey biomass estimate and 2.0 times the 2012 acoustic survey biomass estimate (Figure~\ref{fig:main-survey-biomass}). The 2015 survey age composition was made up of 60\% age-5 fish from the 2010 year-class.

The acoustic survey biomass index included in the base model (Table~\ref{tab:main-survey-history}) includes an estimate of biomass outside the survey area that is expected to be present due to the occurrence of fish at or near the western end of some survey transects. The method of extrapolation has been the subject of some debate in recent reviews, hence the reanalysis of the entire time series using a more robust parameterization in the kriging analysis.  However, a time series without extrapolation is used as a sensitivity. The biomass series without extrapolation is shown in Figure \ref{fig:main-biomass-base-alternative-1} (key estimates are in Table \ref{tab:main-parameter-estimates-sens-2}) along with the extrapolated time series.  The largest percentage of extrapolated biomass in any year occurred in 2005 and was 25\% (average overall all years was 9\%).
