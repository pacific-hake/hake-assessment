...
Estimated age-2+ biomass in the survey has increased steadily over the four most recent surveys conducted in 2011-2013 and 2015. The 2015 survey biomass estimate is **???? million metric tons, which is **???? times the 2012 survey biomass estimate and **???? times the 2011 acoustic survey biomass estimate (Figure~\ref{fig:main-survey-biomass}). The 2015 survey age composition was made up of **???\% age-5 fish from the 2010 year-class.
