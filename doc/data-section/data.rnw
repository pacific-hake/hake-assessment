...
\item Age compositions composed of data from the U.S. fishery (\Sexpr{max.fishery.age.prop[1]}--\Sexpr{max.fishery.age.prop[2]}) and the Canadian fishery (1990--\Sexpr{max.fishery.age.prop[2]}). The last 8 years of these data are shown in Tables \ref{tab:main-us-cp-age-data}--\ref{tab:main-can--age-data}.
...
For the 2016 assessment \citep{JTC2015}, the data from all surveys since 1998 was scrutinized and reanalyzed using consistent assumptions. These include:
