...
\item Histological analysis of ovary samples collected during the 2009, and 2012--\Sexpr{last.assess.yr} NWFSC bottom trawl surveys, the 2012, 2013, and 2015 acoustic surveys, and the at-sea fishery from 2013 through 2015.
...
The net result of these changes is a consistent approach applied to all survey years from \Sexpr{survey.start.yr} onwards (Table~\ref{tab:main-kriging-parameters}). Therefore, the biomass indices (Table~\ref{tab:main-survey-history} and Figure~\ref{fig:main-survey-biomass}) and age compositions (Figure~\ref{fig:main-age-comp-bubbles}, top) are new for this assessment and differ from the 2015 assessment \citep{JTC2015}.
