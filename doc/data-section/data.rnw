...
****Haven't done references yet, so go through and see which are in .bib file already and tidy up.

Fishery-dependent and fishery-independent data sources used here (**Figure 3) include:

\begin{itemize}

\item Total catch from all U.S. and Canadian target fisheries (**1966-2014).
  
\item Age compositions composed of data from the U.S. fishery **(1975-2014) and the Canadian fishery **(1990-2014).

\item Biomass indices and age compositions from the Joint U.S.~and Canadian integrated acoustic and trawl survey **(1995, 1998, 2001, 2003, 2005, 2007, 2009, 2011-2013).
...
\item Mean observed weight-at-age from fishery and survey catches, **1975-2014.
...
Some data sources were not included but have been explored, were used for sensitivity analyses, or were included in previous stock assessments, but not in this stock assessment. These data sources are discussed in more detail in the 2013 stock assessment document \citep{JTC2013}.
...
\item Biomass indices and age compositions from the Joint U.S.~and Canadian integrated acoustic and trawl survey **(1977, 1980, 1983, 1986, 1989, 1992). %presume won't change, no need to automate.

\item NWFSC/SWFSC/PWCC coast-wide juvenile hake and rockfish survey (2001-2009).

\item Bycatch of Pacific Hake in the trawl fishery for pink shrimp off the coast of Oregon, **2004-2005, 2007-2008.
...
\item ** Histological analysis of ovary samples collected during the 2009, 2012, 2013, and 2014 NWFSC bottom trawl surveys, the 2012 and 2013 acoustic surveys, and the at-sea fishery in 2013 and 2014.
