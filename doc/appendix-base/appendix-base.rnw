...
make.mcmc.diag.plot(base_model, key_posteriors[1], key_posteriors.titles[1])
make.mcmc.diag.plot(base_model, key_posteriors[2], key_posteriors.titles[2])
par <- oldpar
@
\end{center}
...
par(mar=c(4.1, 4.1, 3.1, 0.1))
layout(matrix(c(1,2), nrow = 2, ncol = 1, byrow=TRUE))
make.mcmc.diag.plot(base_model, key_posteriors[3], key_posteriors.titles[3])
make.mcmc.diag.plot(base_model, key_posteriors[4], key_posteriors.titles[4])
par <- oldpar
@
\end{center}
...
par(mar=c(4.1, 4.1, 3.1, 0.1))
layout(matrix(c(1,2), nrow = 2, ncol = 1, byrow=TRUE))
make.mcmc.diag.plot(base_model, key_posteriors[5], key_posteriors.titles[5])
make.mcmc.diag.plot(base_model, key_posteriors[6], key_posteriors.titles[6])
par <- oldpar
@
\end{center}
...
make.mcmc.diag.pairs.plot(base_model,
                          ...
                          key_posteriors.names = key_posteriors.titles,
                          recr = c(2014, 2016),
                          bratio = end_yr,
