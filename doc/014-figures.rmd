...
<!-- ```{r main-prior-posterior, fig.height = 6, fig.width = 8, is.fig = TRUE, alt.text = "This figure shows how the posteriors shift from the priors for key parameters. The steepness parameter appears to have an almost identical prior and posterior distribution."} -->
