...
ammending older data sources, and adding new data.
...
biomass, middle left); recruitment deviation (middle right); and age-2$+$
...
(ref:main-bridge-summary-alt-1) The largest change amongst the models occurred when
data from the age-2$+$ survey was added to the model.

(ref:main-bridge-summary-alt-2) Including time-varying fecundity led to a smaller
spawning biomass in the terminal year of the model.
