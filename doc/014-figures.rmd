...
mean weight-at-age that is fit in the base model. Colors and transparency are
...
the model such that weights were predicted rather estimated.
...
for the acoustic survey index. The blue vertical line is the median of the
...
which is `r f(median(last_yr_base_model$extra_mcmc$Q_vector), 3)`.

(ref:main-catchability-density-alt) The distribution of the catchability
parameter posterior is shown with a median around 0.83 for this year's
assessment model.
...
for the age-1 index. The blue vertical line is the median of the
posterior for `r assess_yr`, which is
`r f(median(base_model$extra_mcmc$q_vector_age1), 3)`; the red line is
the median of the posterior for the last assessment year, `r last_data_yr`,
which is `r f(median(last_yr_base_model$extra_mcmc$Q_vector_age1), 3)`.

(ref:main-catchability-density-age1-alt) The distribution of the catchability
parameter posterior is shown with a median around 0.85 for this year's
assessment model.
