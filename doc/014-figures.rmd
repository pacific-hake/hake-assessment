...
a subsample of 1000 draws from the posterior distribution for the base model.

(ref:main-tv-selex-posteriors-alt) This plot shows individual median
selectivity trajectories for a subset of samples from the posteriors of fishery and
