...
(ref:main-recruit-base-alternative-2-cap) MCMC estimates of recruitment
...
(ref:main-recruit-base-alternative-2-alt) This figure shows the occasional
...
```{r main-recruit-base-alternative-2-fig, fig.caption = "(ref:main-recruit-base-alternative-2-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-recruit-base-alternative-2-alt)"}
...
sensitivity runs that represent changes in data. See Figure~\@ref(fig:main-biomass-base-alternative-2-fig) for sensitivity
descriptions.
...
plist[[2]] <- NA
plist[[3]] <- plot_recruitment(d_obj = d_obj_retro_recr,
                               leg_pos = "none",
                               rev_colors = TRUE,
                               clip_cover = 8)
