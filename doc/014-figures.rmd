...
of a random subset of individual Markov chain Monte Carlo samples. Thicker
uncertainty intervals around observed survey points indicate 95% lognormal
uncertainty intervals based on sampling variability and are used as input
to the assessment model. Thinner uncertainty intervals indicate estimated
95% uncertainty intervals that account for the model estimate of additional
uncertainty.
