...
when spawning biomass in year $t$ is compared to unfished equilibrium biomass, $B_0$
(static $B_0$, black; as in Figure~\@ref(fig:main-relative-biomass-fig)) and
when spawning biomass in year $t$ is compared to the unfished biomass time series
