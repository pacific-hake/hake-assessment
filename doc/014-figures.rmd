...
occurred when new fishery composition data from the current year and
...
eDNA survey as an index of abundance.
...
the baseline mortality is estimated or fixed and cannibalistic mortality is
added to the baseline mortality. Natural mortality is assumed to be equal for
all ages five and above in both sensitivities.

(ref:main-biomass-base-alternative-5-alt) This figure shows that recent
spawning biomass varies for some sensitivity runs. Fixing natural mortality
...
recruitment deviations are similar between the three model runs.
...
(ref:main-mortality-sens-cap) Mortality due to cannibalism for five
age groups (colors), where mortality is assumed to be equal for all
ages five and above.
