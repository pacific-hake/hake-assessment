...
credible interval from the `r end_yr` base model.
...
range specifies the width from quartile 1 (Q1: 25th percentile) to quartile
3 (Q3: 75th percentile) of terminal year spawning biomass from the posterior
...
p <- list()
p[[1]] <- plot_assessment_history_disp(base_model,
                                       assess_history_disp_df)
p[[2]] <- plot_assessment_history_disp(base_model,
                                       assess_history_disp_df,
                                       type = "coeff",
                                       y_lim = c(0, 0.6))
