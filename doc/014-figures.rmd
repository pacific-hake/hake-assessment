...
difference in growht over time.
...
The probability that the stock falls under B40 is between 10% and 35%
for examined catch scenarios.
...
above 50% for catches above approximately 400 kilotonnes.
