...
```{r main-overview-map-fig, fig.cap = "(ref:main-overview-map-cap)", fig.height = 8, fig.width = 6, out.height = "\\textheight",  out.width = "\\textwidth"}
...
```{r main-acoustic-age2-bs-fig, fig.cap = "(ref:main-acoustic-age2-bs-cap)", results = "asis", out.height = "\\textheight",  out.width = "\\textwidth"}

include_graphics("main-figures/hake_survey_1995-21_NASCTimeSeries_BiomassAtAgeHistograms_grayblue.png", error = FALSE)
```
...
```{r main-acoustic-age1-bs-fig, fig.cap = "(ref:main-acoustic-age1-bs-cap)", results = "asis", out.height = "\\textheight",  out.width = "\\textwidth"}

include_graphics("main-figures/age1hake_03-21_sA_squareroot_bin_narrow-panel_grayblue.png", error = FALSE)
```
...
```{r main-catches-fig, fig.cap = "(ref:main-catches-cap)", fig.height = 5, fig.width = 8}
...
```{r main-us-catch-rates-fig, fig.cap = "(ref:main-us-catch-rates-cap)", fig.height = 5, fig.width = 8}

include_graphics("main-figures/fishCatchRatesUS.png", error = FALSE)
```
...
```{r main-us-depths-fig, fig.cap = "(ref:main-us-depths-cap)", fig.height = 4, fig.width = 8}
...
```{r main-can-depths-fig, fig.cap = "(ref:main-can-depths-cap)", fig.height = 8, fig.width = 8}
...
```{r main-data-overview-fig, fig.cap = "(ref:main-data-overview-cap)", fig.height = 5, fig.width = 8}
...
```{r main-age-comp-bubbles-fig, fig.cap = "(ref:main-age-comp-bubbles-cap)", fig.height = 8, fig.width = 8, out.height = "\\textheight",  out.width = "\\textwidth"}
...
```{r main-survey-extrap-biomass-fig,  fig.cap = "(ref:main-survey-extrap-biomass-cap)", fig.height = 5, fig.width = 8}
...
```{r main-survey-age1-fig, fig.cap = "(ref:main-survey-age1-cap)", fig.height = 5, fig.width = 8}
...
```{r main-maturity-ogive-fig, fig.cap = "(ref:main-maturity-ogive-cap)", fig.height = 11, fig.width = 8, out.height = "\\textheight", out.width = "\\textwidth"}
...
```{r main-weight-at-age-fig, fig.cap = "(ref:main-weight-at-age-cap)", fig.height = 11, fig.width = 8, out.height = "\\textheight", out.width = "\\textwidth"}
...
```{r main-sample-size-weight-at-age-fig, fig.cap = "(ref:main-sample-size-weight-at-age-cap)", fig.height = 11, fig.width = 8, out.height = "\\textheight", out.width = "\\textwidth"}
...
```{r main-weight-at-age-lines-fig, fig.cap = "(ref:main-weight-at-age-lines-cap)", fig.height = 5, fig.width = 8}
...
```{r main-bridge-summary-fig, fig.cap = "(ref:main-bridge-summary-cap)", fig.height = 8, fig.width = 8}
...
```{r main-age1-index-fit-mcmc-fig, fig.cap = "(ref:main-age1-index-fit-mcmc-cap)", fig.height=6, fig.width=8}
...
```{r main-age-comp-fits-fig, fig.cap = "(ref:main-age-comp-fits-cap)", fig.height = 11, fig.width = 8}
...
negative residuals (observed < expected). Green lines track cohorts from years
...
```{r main-age-comp-pearson-fig, fig.cap = "(ref:main-age-comp-pearson-cap)", fig.height = 11, fig.width = 8}
...
```{r main-prior-posterior-fig, fig.cap = "(ref:main-prior-posterior-cap)", fig.height = 10, fig.width = 8}
...
```{r main-prior-posterior-truncated-fig, fig.cap = "(ref:main-prior-posterior-truncated-cap)", fig.height = 10, fig.width = 8}
...
```{r main-tv-selex-fig, fig.cap = "(ref:main-tv-selex-cap)", fig.height = 8, fig.width = 8}
...
```{r main-tv-selex-uncertainty-fig, fig.cap = "(ref:main-tv-selex-uncertainty-cap)", fig.height = 8, fig.width = 8}
...
```{r main-tv-selex-posteriors-fig, fig.cap = "(ref:main-tv-selex-posteriors-cap)", fig.height = 8, fig.width = 8}
...
```{r main-biomass-fig, fig.cap = "(ref:main-biomass-cap)", fig.height = 5, fig.width = 8}

plot_biomass(list(base_model),
             list(base_model_name),
             ylim = c(0, 5),
             point_shape = hake::ts_single_model_pointshape,
             leg_pos = "none")
```
...
```{r main-relative-biomass-fig, fig.cap = "(ref:main-relative-biomass-cap)", fig.height = 5, fig.width = 8}
...
```{r main-recruitment-fig, fig.cap = "(ref:main-recruitment-cap)", fig.height = 5, fig.width = 8}
...
```{r main-recruitment-devs-fig, fig.cap = "(ref:main-recruitment-devs-cap)", fig.height = 4.5, fig.width = 8}
...
```{r main-numbers-at-age-fig, fig.cap = "(ref:main-numbers-at-age-cap)", fig.height = 8, fig.width = 8}
...
(ref:main-recruitment-scale-all-cap) Medians (solid circles) of the
...
recruitment estimates relative to those in 2010 for all years.

```{r main-recruitment-scale-all-fig, fig.cap = "(ref:main-recruitment-scale-all-cap)", fig.height = 4.5, fig.width = 8}
...
```{r main-stock-recruitment-fig, fig.cap = "(ref:main-stock-recruitment-cap)", fig.height = 8, fig.width = 8}
...
```{r main-fishing-intensity-fig, fig.cap = "(ref:main-fishing-intensity-cap)", fig.height = 5, fig.width = 8}
...
```{r main-exploitation-fraction-fig, fig.cap = "(ref:main-exploitation-fraction-cap)", fig.height = 5, fig.width = 8}
...
```{r main-phase-fig, fig.cap = "(ref:main-phase-cap)", fig.height=6, fig.width = 8}
...
```{r main-projected-catch-density-fig, fig.cap = "(ref:main-projected-catch-density-cap)", fig.height = 4.5, fig.width = 8}

plot_catch_forecast_density(base_model, yr = end_yr)
#base_model$plots$catch_fore_density
```

(ref:main-forecast-depletion-comparison-cap) Median and 95% posterior
...
(ref:main-forecast-depletion-comparison-alt) This figure shows that the
...
```{r main-depletion-comparison-fig, fig.cap = "(ref:main-forecast-depletion-comparison-cap)", fig.height = 5, fig.width = 8}
...
```{r main-risk-year-1-fig, fig.cap = "(ref:main-risk-year-1-cap)", fig.height = 4.5, fig.width = 8}
...
```{r main-risk-year-2-fig, fig.cap = "(ref:main-risk-year-2-cap)", fig.height = 4.5, fig.width = 8}
...
```{r main-risk-year-3-fig, fig.cap = "(ref:main-risk-year-3-cap)", fig.height = 4.5, fig.width = 8}
...
Table~\@ref(tab:main-est-numbers-at-age-tab) for the MCMC medians of
numbers-at-age for all years). The panel on the right is scaled based on
...
```{r main-age-comp-forecast-fig, fig.cap = "(ref:main-age-comp-forecast-cap)", fig.height = 4.5, fig.width = 8}

plot_fore_age_comps(base_model)
```

(ref:main-biomass-base-alternative-1-cap) MCMC estimates of spawning
biomass for the base model and alternative sensitivity runs representing
changing the mean of the prior for steepness from 1.0 to 0.5, fixing steepness
at 1.0, lower (1.0) and higher (1.6) levels of variation assumed about the
stock-recruitment relationship ($\sigma_r$), changing the standard deviation
of the prior for natural mortality, and using the Hamel prior distribution
...
```{r main-biomass-base-alternative-1-fig, fig.cap = "(ref:main-biomass-base-alternative-1-cap)", fig.height = 4.5, fig.width = 8}
...
(ref:main-status-base-alternative-1-cap) MCMC estimates of stock status
(relative spawning biomass) for the base model and alternative sensitivity
runs representing changing key parameters. See
Figure~\@ref(fig:main-biomass-base-alternative-1-fig) for
sensitivity descriptions.
  
(ref:main-status-base-alternative-1-alt) This figure shows how relative spawning biomass changes between the first set of sensitivity runs. As in the absolute biomass figure changing the standard deviation of the natural mortality parameter has the most notable effect and scales the population up with an increase in its size.

```{r main-status-base-alternative-1-fig, fig.cap = "(ref:main-status-base-alternative-1-cap)", fig.height = 4.5, fig.width = 8}
...
(ref:main-biomass-base-alternative-2-cap) MCMC estimates of spawning biomass
for the base model and alternative sensitivity models that represent the
following changes in data: removing the index of age-1 fish and down-weighting
fishery composition data using the McAllister-Ianelli method.
...
```{r main-biomass-base-alternative-2-fig, fig.cap = "(ref:main-biomass-base-alternative-2-cap)", fig.height = 4.5, fig.width = 8}
...
(ref:main-status-base-alternative-2-cap) MCMC estimates of stock status
(relative spawning biomass) for the base model and alternative sensitivity
models that represent changes in data. See
...
```{r main-status-base-alternative-2-fig, fig.cap = "(ref:main-status-base-alternative-2-cap)", fig.height = 4.5, fig.width = 8}
...
(ref:main-recruitment-base-alternative-2-cap) MCMC estimates of recruitment
deviations for the base model and alternative sensitivity runs that represent
changes in data. See Figure~\@ref(fig:main-biomass-base-alternative-2-fig)
...
```{r main-recruitment-base-alternative-2-fig, fig.cap = "(ref:main-recruitment-base-alternative-2-cap)", fig.height = 4.5, fig.width = 8}
...
(ref:main-index-base-alternative-2-cap) MCMC estimates of the fit to the
acoustic survey biomass time series for the base model and alternative
...
```{r main-index-base-alternative-2-fig, fig.cap = "(ref:main-index-base-alternative-2-cap)", fig.height = 4.5, fig.width = 8}
...
(ref:main-biomass-base-alternative-4-cap) MCMC estimates of spawning biomass
for the base model and alternative sensitivity runs representing different
standard deviations ($\Phi$) associated with time-varying selectivity.
Standard deviations examined are below (0.21 and 0.70) and above (2.10)
...
```{r main-biomass-base-alternative-4-fig, fig.cap = "(ref:main-biomass-base-alternative-4-cap)", fig.height = 4.5, fig.width = 8}
...
(ref:main-status-base-alternative-4-cap) MCMC estimates of stock status
(relative spawning biomass) for the base model and alternative sensitivity
...
```{r main-status-base-alternative-4-fig, fig.cap = "(ref:main-status-base-alternative-4-cap)", fig.height = 4.5, fig.width = 8}
...
(ref:main-recruitment-base-alternative-4-cap) MCMC estimates of recruitment
for the base model and alternative sensitivity runs representing different
standard deviations ($\Phi$) associated with time-varying selectivity. See Figure~\@ref(fig:main-biomass-base-alternative-4-fig) for sensitivity
descriptions.
...
```{r main-recruitment-base-alternative-4-fig, fig.cap = "(ref:main-recruitment-base-alternative-4-cap)", fig.height = 4.5, fig.width = 8}
...
(ref:main-recruitment-devs-base-alternative-4-cap) MCMC estimates of
recruitment deviations for the base model and alternative sensitivity runs
...
```{r main-recruitment-devs-base-alternative-4-fig, fig.cap = "(ref:main-recruitment-devs-base-alternative-4-cap)", fig.height = 4.5, fig.width = 8}
...
(ref:main-index-base-alternative-4-cap) MCMC estimates of the fit to the
survey index of age-2$+$ biomass for the base model and alternative
...
```{r main-index-base-alternative-4-fig, fig.cap = "(ref:main-index-base-alternative-4-cap)", fig.height = 4.5, fig.width = 8}
...
(ref:main-biomass-recruitment-retrospective-cap) MCMC Estimates of spawning
biomass at the start of each year (top) and recruitment (bottom) for the
base model and 5-year retrospective runs.
...
p <- list()
p[[1]] <- plot_biomass(d_obj = base_model$retros$biomass_df,
                       leg_font_size = 8,
                       x_expansion = 3.5,
                       leg_pos = c(0.6, 0.89),
                       leg_ncol = 2,
                       alpha = 0.1)
p[[2]] <- plot_recruitment(d_obj = base_model$retros$recr_df,
                           leg_pos = "none")
...
recruitment deviations from MCMC models over the last
...
deviations are non-zero because MCMC allows for sampling from the full
lognormal distribution. Lines represent estimated recruitment deviations
for cohorts born from `r min(retro_cohorts)` to `r max(retro_cohorts)`, with
cohort birth year marked at the right of each color-coded line. For example,
the right-most point for the `r assess_yr - 8` cohort shows the cohort at
age-8 (i.e., at the start of `r assess_yr`, which represents the base model
and includes data through `r assess_yr - 1`). The next point to the left
is the `r assess_yr - 8` cohort at age-7, calculated by removing one year of
data (so includes data up to `r assess_yr - 2`). Thus, models are fit to
data available only up to the start of the year in which each cohort became
a given age, such that the last year of data for a given point equals
...
```{r main-retrospective-recruitment-fig, fig.cap = "(ref:main-retrospective-recruitment-cap)", fig.height = 6, fig.width = 8}
...
```{r main-relative-retrospective-recruitment-fig, fig.cap = "(ref:main-relative-retrospective-recruitment-cap)", fig.height = 6, fig.width = 8}
...
assessment estimates of spawning biomass. Estimates are MLEs or MCMC
medians depending on the model structure. Shading represents the 95%
credible interval from the `r assess_yr` base model.
...
```{r main-historical-assessments-fig, fig.cap = "(ref:main-historical-assessments-cap)", fig.height = 4.5, fig.width = 6.5}

plot_assessment_history_biomass(base_model, assess_history_df)
```
...
```{r main-historical-dispersion-fig, fig.cap = "(ref:main-historical-dispersion-cap)", fig.height = 4.5, fig.width = 6.5}
...
<!-- ```{r main-historical-1-fig, fig.cap = "(ref:main-historical-1-cap)", fig.height = 6, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-historical-1-alt)"} -->
