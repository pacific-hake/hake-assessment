...
include_graphics(file.path(figures_dir,"hake_survey_1995-23_NASCTimeSeries_BiomassAtAgeHistograms_graywhite.png"), error = FALSE)
```
...
include_graphics(file.path(figures_dir,"age1hake_03-23_sA_squareroot_bin_narrow-panel_grayblue.png"), error = FALSE)
```
