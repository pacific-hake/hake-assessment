...
(ref:main-bridge-summary-1-alt) The largest change amongst the models
occurred when data from the age 2 plus survey was added to the model.

(ref:main-bridge-summary-2-alt) Including time-varying fecundity led
