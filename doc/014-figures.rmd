...
```{r main-overview-map-fig, fig.cap = "(ref:main-overview-map-cap)", fig.height = 10}
...
```{r main-us-catch-rates-fig, fig.cap = "(ref:main-us-catch-rates-cap)", results = "asis"}

include_graphics(file.path(figures_dir,"fishCatchRatesUS.png"), error = FALSE)
```
...
```{r main-age-comp-bubbles-fig, fig.cap = "(ref:main-age-comp-bubbles-cap)", fig.height = 11}
...
```{r main-maturity-ogive-fig, fig.cap = "(ref:main-maturity-ogive-cap)", fig.height = 11}
...
```{r main-weight-at-age-fig, fig.cap = "(ref:main-weight-at-age-cap)", fig.height = 11}
...
```{r main-sample-size-weight-at-age-fig, fig.cap = "(ref:main-sample-size-weight-at-age-cap)", fig.height = 11}
...
(ref:main-weight-at-age-3d-cap) Empirical weight-at-age (kg) values used for
the base model. Colors are the same as in the heatmaps above, and the bar
heights represent the sample sizes. The numbers on top of the bars are the
actual sample sizes for each year/age combination.

(ref:main-weight-at-age-3d-alt) This plot shows the weight-at-age heatmap in
3D with the bar heights representing the sample size for each year/age
combination.

```{r main-weight-at-age-3d-alt, fig.cap = "(ref:main-weight-at-age-3d-cap)", fig.height = 11}
...
```{r main-age-comp-fits-fig, fig.cap = "(ref:main-age-comp-fits-cap)", fig.height = 11}
...
```{r main-age-comp-pearson-fig, fig.cap = "(ref:main-age-comp-pearson-cap)", fig.height = 11}
...
```{r main-prior-posterior-fig, fig.cap = "(ref:main-prior-posterior-cap)", fig.height = 10}
...
```{r main-prior-posterior-truncated-fig, fig.cap = "(ref:main-prior-posterior-truncated-cap)", fig.height = 10}
...
```{r main-biomass-fig, fig.cap = "(ref:main-biomass-cap)"}
...
```{r main-relative-biomass-fig, fig.cap = "(ref:main-relative-biomass-cap)"}
...
```{r main-recruitment-fig, fig.cap = "(ref:main-recruitment-cap)"}
...
```{r main-recruitment-devs-fig, fig.cap = "(ref:main-recruitment-devs-cap)", fig.height = 4.5}
...
```{r main-numbers-at-age-fig, fig.cap = "(ref:main-numbers-at-age-cap)", fig.height = 11}
...
```{r main-depletion-comparison-fig, fig.cap = "(ref:main-forecast-depletion-comparison-cap)"}
