...
$ln(R_0)$, and the acoustic survey and age-1 extra SD parameters represent the hard
...
model. Female spawning biomass in all years is less when maturity is estimated
earlier in the year.
