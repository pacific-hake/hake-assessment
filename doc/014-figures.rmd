...
```{r main-acoustic-age2-bs-fig, fig.cap = "(ref:main-acoustic-age2-bs-cap)", is.fig = TRUE, alt.text = "(ref:main-acoustic-age2-bs-alt)", results = "asis", out.height = "\\textheight",  out.width = "\\textwidth"}
...
```{r main-acoustic-age1-bs-fig, fig.cap = "(ref:main-acoustic-age1-bs-cap)", is.fig = TRUE, alt.text = "(ref:main-acoustic-age1-bs-alt)", results = "asis", out.height = "\\textheight",  out.width = "\\textwidth"}
...
```{r main-us-catch-rates-fig, fig.cap = "(ref:main-us-catch-rates-cap)", fig.height = 5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-us-catch-rates-alt)"}
...
```{r main-age-comp-bubbles-fig, fig.cap = "(ref:main-age-comp-bubbles-cap)", fig.height = 8, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-age-comp-bubbles-alt)", out.height = "\\textheight",  out.width = "\\textwidth"}
...
quad_grid <- plot_grid(plotlist = plist,
                       nrow = 2,
                       ncol = 2)
full_plist <- list()
full_plist[[1]] <-
...
```{r main-tv-selex-fig, fig.cap = "(ref:main-tv-selex-cap)", fig.height = 8, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-tv-selex-alt)"}
...
plist[[2]] <- plot_selex_posteriors(base_model,
                                    ...
                                    age_range = c(1, 8),
                                    glow = FALSE)
plot_grid(plotlist = plist, ncol = 1, align = "v")
```
...
```{r main-recruitment-scale-all-fig, fig.cap = "(ref:main-recruitment-scale-all-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-recruitment-scale-all-alt)"}
...
```{r main-stock-recruitment-fig, fig.cap = "(ref:main-stock-recruitment-cap)", fig.height = 8, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-stock-recruitment-alt)"}
...
```{r main-fishing-intensity-fig, fig.cap = "(ref:main-fishing-intensity-cap)", fig.height = 5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-fishing-intensity-alt)"}
...
```{r main-exploitation-fraction-fig, fig.cap = "(ref:main-exploitation-fraction-cap)", fig.height = 5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-exploitation-fraction-alt)"}
...
```{r main-phase-fig, fig.cap = "(ref:main-phase-cap)", fig.height=6, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-phase-alt)"}
...
```{r main-projected-catch-density-fig, fig.cap = "(ref:main-projected-catch-density-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-projected-catch-density-alt)"}
...
```{r main-depletion-comparison-fig, fig.cap = "(ref:main-forecast-depletion-comparison-cap)", fig.height = 5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-forecast-depletion-comparison-alt)"}
...
```{r main-risk-year-1-fig, fig.cap = "(ref:main-risk-year-1-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-risk-year-1-alt)"}
...
```{r main-risk-year-2-fig, fig.cap = "(ref:main-risk-year-2-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-risk-year-2-alt)"}
...
```{r main-risk-year-3-fig, fig.cap = "(ref:main-risk-year-3-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-risk-year-3-alt)"}
...
```{r main-age-comp-forecast-fig, fig.cap = "(ref:main-age-comp-forecast-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-age-comp-forecast-alt)"}
...
```{r main-biomass-base-alternative-1-fig, fig.cap = "(ref:main-biomass-base-alternative-1-cap)", fig.height=4.5, fig.width=8, is.fig = TRUE, alt.text = "(ref:main-biomass-base-alternative-1-alt)"}
...
```{r main-status-base-alternative-1-fig, fig.cap = "(ref:main-status-base-alternative-1-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-status-base-alternative-1-alt)"}
...
```{r main-biomass-base-alternative-2-fig, fig.cap = "(ref:main-biomass-base-alternative-2-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-biomass-base-alternative-2-alt)"}
...
```{r main-status-base-alternative-2-fig, fig.cap = "(ref:main-status-base-alternative-2-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-status-base-alternative-2-alt)"}
...
```{r main-recruitment-base-alternative-2-fig, fig.cap = "(ref:main-recruitment-base-alternative-2-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-recruitment-base-alternative-2-alt)"}
...
```{r main-index-base-alternative-2-fig, fig.cap = "(ref:main-index-base-alternative-2-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = ""}
...
```{r main-biomass-base-alternative-4-fig, fig.cap = "(ref:main-biomass-base-alternative-4-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = ""}
...
```{r main-status-base-alternative-4-fig, fig.cap = "(ref:main-status-base-alternative-4-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = ""}
...
```{r main-recruitment-base-alternative-4-fig, fig.cap = "(ref:main-recruitment-base-alternative-4-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-recruitment-base-alternative-4-alt)"}
...
```{r main-recruitment-devs-base-alternative-4-fig, fig.cap = "(ref:main-recruitment-devs-base-alternative-4-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-recruitment-devs-base-alternative-4-alt)"}
...
```{r main-index-base-alternative-4-fig, fig.cap = "(ref:main-index-base-alternative-4-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-index-base-alternative-4-alt)"}
...
```{r main-biomass-recruitment-retrospective-fig, fig.cap = "(ref:main-biomass-recruitment-retrospective-cap)", fig.height = 8, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-biomass-recruitment-retrospective-alt) "}
...
```{r main-retrospective-recruitment-fig, fig.cap = "(ref:main-retrospective-recruitment-cap)", fig.height = 6, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-retrospective-recruitment-alt)"}
...
```{r main-relative-retrospective-recruitment-fig, fig.cap = "(ref:main-relative-retrospective-recruitment-cap)", fig.height = 6, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-relative-retrospective-recruitment-alt)"}
...
```{r main-historical-assessments-fig, fig.cap = "(ref:main-historical-assessments-cap)", fig.height = 4.5, fig.width = 6.5, is.fig = TRUE, alt.text = "(ref:main-historical-assessments-alt)"}
...
```{r main-historical-dispersion-fig, fig.cap = "(ref:main-historical-dispersion-cap)", fig.height = 4.5, fig.width = 6.5, is.fig = TRUE, alt.text = "(ref:main-historical-dispersion-alt)"}
