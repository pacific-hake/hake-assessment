...
make.biomass.plot(sens_models_5[[3]],
...
make.depletion.plot(sens_models_5[[3]],
                    start_yr = start_yr,
                    end_yr = end_yr,
                    color = "blue")
@
...
make.biomass.table(sens_models_5[[3]],
                   start_yr = end_yr-9,
                   end_yr = end_yr,
                   weight.factor = 1000,
...
make.recruitment.table(sens_models_5[[3]],
                       start_yr = end_yr-10,
                       end_yr = end_yr-1,
                       weight.factor = 1000,
...
make.recruitment.plot(sens_models_5[[3]],
                      equil.yr = unfished_eq_yr,
                      start_yr = start_yr,
                      end_yr = end_yr,
                      color = "blue",
...
make.fishing.intensity.table(sens_models_5[[3]],
                             start_yr = end_yr-10,
                             end_yr = end_yr-1,
                             digits = 3,
...
make.fishing.intensity.plot(sens_models_5[[3]],
                            start_yr = start_yr,
                            end_yr = end_yr-1,
                            color = "blue",
                            upper.lim = 1.5)
...
make.exploitation.fraction.plot(sens_models_5[[3]],
                                start_yr = start_yr,
                                end_yr = end_yr-1,
                                color = "blue",
                                upper.lim = 0.35)
...
make.phase.plot(sens_models_5[[3]],
                start_yr = start_yr,
                end_yr = end_yr)
@
\end{center}
...
decision_table(sens_models_5[[3]],
...
models.names <- sapply(sens_models_5[[3]]$catch.levels, "[[", 2)[models.inds]
                       ## pretty catch level name
make.forecast.depletion.comparison.plot(sens_models_5[[3]],
                                        models.inds,
                                        models.names,
                                        start_yr = 2009,
                                        model.end_yr = end_yr,
...
% The \Sexpr{end_yr} catch of \Sexpr{f(base_model$catch.default.policy[1])}~t was calculated
...
make.forecast.risk.comparison.plot(sens_models_5[[3]],
...
make.risk.table(sens_models_5[[3]],
                forecast_yrs,
