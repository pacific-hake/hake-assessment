...
- values shown as proportions instead of as percentages. This allows the removal of all the percentage signs shown on on the relative biomass values which are distracting.
