...
declines or it does not decline, simlar to a tossed coin only being a head or a
...
Only for 2018 is probability from the current assessment model closer to 50\%
...
This is ....****ANDY TO CONTINUE, add projections explanation to fig caption***
