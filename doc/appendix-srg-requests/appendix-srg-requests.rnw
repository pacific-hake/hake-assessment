...
The SRG requested informally that a figure shown in the Data presentation be included. This figure shows the weight-at-age through time for ages 2--10 and is included here as Figure~\ref{fig:srg-weight-at-age}.
