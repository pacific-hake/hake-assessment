...
This appendix will contain any results requested at the upcoming
Scientific Review Group meeting to be held from 26th February to 1st
March 2018.
...
\end{center}
\caption{A comparison of MCMC posterior median estimates and 95\% credibility intervals of relative spawning biomass for the base model (blue line) and the alternative time-varying fecundity model (red line)}
