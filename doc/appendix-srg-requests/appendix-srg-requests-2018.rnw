...
make_age_comp_pearson_plot(sens.models.3[[1]], legend.position = "top")
@
\end{center}
...
make_age_comp_pearson_plot(sens.models.3[[2]], legend.position = "top")
@
\end{center}
\caption{Pearson residuals for model with maximum age of selectivity set
...
make_age_comp_pearson_plot(sens.models.3[[3]], legend.position = "top")
@
\end{center}
\caption{Pearson residuals for model with maximum age of selectivity set
