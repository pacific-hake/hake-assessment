...
\begin{figure}[tbp]
\begin{center}
<<recruitment-trace-recent, fig.height=4.5, fig.width=8, is.fig = TRUE, alt.text = "This figure shows the time series for 100 MCMC estimates of age zero recruitment">>=
...
\begin{figure}[tbp]
\begin{center}
<<recruitment-trace-recent-highlight, fig.height=4.5, fig.width=8, is.fig = TRUE, alt.text = "This figure highlights the time series for 10 MCMC estimates of age zero recruitment">>=
make.mcmc.recruitment.plot(base.model,
                           start.yr = 2006,
                           equil.yr = unfished.eq.yr,
                           samples = 100,
