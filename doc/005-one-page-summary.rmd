...
except for fixing recruitment deviations to zero in the final two years and
the projection years of the model.
...
(t represents metric tonnes), 48% below the average over the most recent 10 years
