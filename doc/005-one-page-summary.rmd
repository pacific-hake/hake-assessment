...
<!-- `r last_yr_tac` t. -->
It was estimated that the stock will be at `r b_40` in the beginning of 2028 with a catch
of 250,000~t in 2026 and 2027, given the current assumption of average recruitment
from 2023 onward.

- Despite estimates of a current stock status above `r b_40`, the recent lack
