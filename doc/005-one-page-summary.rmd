...
- Updates in this assessment include incorporating
...
`r curr_depl_upper`%). After a slow decline since 2018, the median
relative spawning biomass increased from 2023 to 2024, due to the
...
spawning biomass increasing from `r f(last_yr_tac_fore_1_biomass)`% in
`r end_yr` to `r f(last_yr_tac_fore_2_biomass)`% in `r end_yr + 1` and then
decreasing to `r f(last_yr_tac_fore_3_biomass)`% in `r end_yr + 2`,
