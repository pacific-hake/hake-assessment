...
except for fixing recruitment deviations to zero in the final two years and in
the projection years of the model, and removing the relative index of age-1 fish.
The model is fit to an acoustic survey index of biomass, annual commercial catch
data, and age-composition data from the
...
<!-- `r last_yr_tac` t. -->
The model estimates that in two years time the stock will be at `r b_40` with a catch
of 250,000~t in 2026 and 2027, given the current assumption of average recruitment
from 2023 onward.

- Despite estimates of a healthy stock status (albeit less so than last year), the recent lack
