...
The model is fit to an acoustic survey index of biomass, a relative
...
pre-`r end_yr-1` data were made as necessary. In addition, a new model-based
...
[t represents metric tons], 22% below the average over the most recent 10 years
...
relative spawning biomass increased in 2023 and 2024, due to the
...
- Despite healthy stock size and status [median] estimates, the recent lack
of survey abundance and fishery catch in Canada suggests a population structure
not conducive to achieving harvest quotas in northern fisheries over recent years.
