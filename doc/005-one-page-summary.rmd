...
except for recruitment deviations in the terminal two years of
the model and projections years being fixed at zero.
...
The model was not fit to the relative index of age-one fish.
