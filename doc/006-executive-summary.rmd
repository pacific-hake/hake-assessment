...
summer in years with warmer water. Older `r sp` tend to migrate farther north
than younger `r sp` in all years, with catches in the Canadian zone typically
consisting of fish greater than four years old. Separate, and much smaller,
populations of `r sp` occurring in the major inlets of the Northeast Pacific
Ocean, including the Strait of Georgia, Puget Sound, and the Gulf of
California, are not included in this analysis.
...
(rather than constant) selectivity to maintain flexibility with
...
retained and improved upon with time-varying maturity estimates.
...
years, with small year classes for all other years from 2011--2019(median recruitment well below the mean of all median recruitments).

The 2020 cohort is estimated to be above average, and the 2021 cohort is
estimated to be potentially large from limited fishery data and the 2023 biomass
survey.
...
From 2020 the Canada rate steadily declined to a time-series low of 16.5% in 2023, and
...
information on the size of the 2020 year-class (as well as inform the 2021 year
