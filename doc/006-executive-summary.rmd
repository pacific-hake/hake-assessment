...
`r fspr_40` = 1.0, dropping by over 20% to `r median_intensity_2020`% in
2020, then remaining stable for 2021 and 2022 at `r median_intensity_2021`%
and `r median_intensity_2022`% respectively. The 3-year stable trend from
2020--2022 was ended in 2023 when the Relative fishing intensity dropped
again by approximately 0.05 to `r median_intensity_2023`% of the target
level of `r fspr_40` = 1.0 (Table~\@ref(tab:es-fishing-intensity-tab) and
Figure~\@ref(fig:es-fishing-intensity-fig)).
...
below `r fspr_40` = 1.0 from 2012--2016 and again in 2020--2023
(Figure~\@ref(fig:es-fishing-intensity-fig)).
