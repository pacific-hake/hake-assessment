...
The median relative spawning biomass was above the $\Bforty$ reference point
...
table_decision(
  ...
  caption = paste0(
      ...
      "catch remaining the same in ", min(forecast_yrs), " and ",
      min(forecast_yrs) + 1, " (row~", letters[ct_stable_ind], ")."),
  bold_letters = TRUE,
  digits = 2,
