...
in 2020 to `r median_intensity_2020`% and remained stable through 2021 and 2022
at `r median_intensity_2021`% and `r median_intensity_2022`% respectively,
then dropping in 2023 to
`r median_intensity_2023`% and in 2024 to
...
below 1.0 from 2012--2016 and again in 2020--2024
(Figure~\@ref(fig:es-fishing-intensity-fig)).
...
expectations. In particular, while the model estimates the 2020 and 2021 cohorts as
above average in size, their absolute size remains highly uncertain. This
...
class), and the 2023 age-1 index helped inform the size of the 2022 year class.
Collectively, these lessened uncertainty around estimates of female
spawning biomass. Information on the size of the 2023 year class from the 2024
...
occur and propagate through the projections as these cohorts mature; hence total
...
However, interpolation is not appropriate for the default harvest rule (e.g. referred to as Default HR) scenario
