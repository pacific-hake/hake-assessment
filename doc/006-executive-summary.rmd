...
estimate was particularly uncertain), informed by the
age-2+ biomass index and survey age composition data.

The 2021 recruitment is now estimated to be potentially large, whereas
it was estimated to be below average in last year's assessment (with limited data);
...
potentially large, but is currently only informed by limited fishery data and the 2023 biomass
survey.
The 2022 cohort was observed by the age-1 index in 2023,
suggesting it is probably not large. There is no information in the data to estimate the
