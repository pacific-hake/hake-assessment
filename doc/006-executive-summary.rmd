...
table_decision(
  ...
  caption = paste0(
      ...
      "and are a constant value across all ", length(forecast_yrs), " ",
      "forecasted years unless otherwise defined in the first column. ",
...
table_decision(
  ...
  caption = paste0(
      ...
      "value across all ", length(forecast_yrs), " forecasted years unless ",
