...
```{r es-catches-fig, fig.cap = "(ref:es-catches-cap)", fig.height = 4, fig.width = 8, is.fig = TRUE, alt.text = "(ref:es-catches-alt)"}
...
```{r es-survey-biomass-fig, fig.cap = "(ref:es-survey-biomass-cap)", fig.height=5, fig.width=8, is.fig = TRUE, alt.text = "This figure shows that the survey estimate has decreased from 2019 to 2021."}
...
```{r es-survey-age1-fig, fig.cap = "(ref:es-survey-age1-cap)", fig.height = 5, fig.width = 8, is.fig = TRUE, alt.text = "This figure shows that the age-1 survey estimate has increased from 2019 to 2021."}
...
```{r es-biomass-fig, fig.cap = "(ref:es-biomass-cap)", fig.height = 5, fig.width = 8, is.fig = TRUE, alt.text = "This figure shows that the median spawning biomass has been increasing in size since 2021."}
...
```{r es-relative-biomass-fig, fig.cap = "(ref:es-relative-biomass-cap)", fig.height = 5, fig.width = 8, is.fig = TRUE, alt.text = "This figure shows that the relative spawning biomass has been increasing since 2021. The value for 2023 is just above B0."}
...
```{r es-fishing-intensity-fig, fig.cap = "(ref:es-fishing-intensity-cap)", fig.height = 5, fig.width = 8, is.fig = TRUE, alt.text = "This figure shows that we have been below the management value of 1 for FSPR 40 percent throughout the entire time series."}
...
```{r es-exploitation-fraction-fig, fig.cap = "(ref:es-exploitation-fraction-cap)", fig.height = 5, fig.width = 8, is.fig = TRUE, alt.text = "This figure shows that the current exploitation fraction of the female spawning biomass is approximately 0.05. This is a drop from the last five years which have been approximately 0.1."}
...
```{r es-phase-fig, fig.cap = "(ref:es-phase-cap)", fig.height = 5, fig.width = 8, is.fig = TRUE, alt.text = "This figure shows that we are currently not overfishing nor in an overfished state."}
...
```{r es-depletion-comparison-fig, fig.cap = "(ref:es-depletion-comparison-cap)", fig.height = 5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:es-depletion-comparison-alt)"}
...
```{r es-risk-year-1-fig, fig.cap = "(ref:es-risk-year-1-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:es-risk-year-1-alt)"}
...
```{r es-risk-year-2-fig, fig.cap = "(ref:es-risk-year-2-cap)", fig.height=4.5, fig.width=8, is.fig = TRUE, alt.text = "(ref:es-risk-year-2-alt)"}
plot_fore_compare(base_model,
                  forecast_yrs = forecast_yrs,
...
```{r es-risk-year-3-fig, fig.cap = "(ref:es-risk-year-3-cap)", fig.height = 4.5, fig.width = 8, is.fig = TRUE, alt.text = "(ref:es-risk-year-3-alt)"}
plot_fore_compare(base_model,
                  forecast_yrs = forecast_yrs,
