...
above the long-term average catch (`r f(long_term_avge_ct)`~t)
but have been declining over that period (especially in Canada). Landings
...
most even years (odd year classes). There are no data to inform the size of
...
little information content in the data.
...
with new data and updated assumptions about recent recruitments.
The estimate of 2020 recruitment is slightly above average, whereas in the previous
...
for these years. There is no information in the data to estimate the
sizes of the `r end_yr - 1` and `r end_yr` year classes. 
