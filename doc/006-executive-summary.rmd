...
highest in 2019 at `r median_intensity_2019`%, dropping by over 20% to
`r median_intensity_2020`% in 2020, then remaining stable for 2021 and 2022
...
fishing intensity dropped again by approximately 5% to
`r median_intensity_2023`% (Table~\@ref(tab:es-fishing-intensity-tab) and
Figure~\@ref(fig:es-fishing-intensity-fig)).
...
below `r f_40` from 2012--2016 and again in 2020--2023
(Figure~\@ref(fig:es-fishing-intensity-fig)).
