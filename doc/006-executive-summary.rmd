...
`r curr_bio_lower` to `r curr_bio_upper`) Mt. The current estimate of
the `r end_yr - 1` female spawning biomass is `r prev_bio_median`
(`r prev_bio_lower`--`r prev_bio_upper`)~Mt. This is less than half of the
median, and a much narrower credibility interval, than what was estimated in
the compared to the `r end_yr - 1` assessment (i.e.,
`r prev_bio_median_last_assess`, `r prev_bio_lower_last_assess`--
`r prev_bio_upper_last_assess`~Mt).
