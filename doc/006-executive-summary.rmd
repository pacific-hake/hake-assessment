...
to better inform fecundity. Recruitment in 2023 and 2024 was based solely on the
stock--recruitment relationship (no estimated recruitment deviations).  Given the unique seasonal
fishing conditions during the year, this data point was considered potentially suspect
as a standalone observation (i.e., without the addition of survey information). Therefore, recruitment in 2023 was based on the stock--recruitment relationship (no additional
recruitment deviate estimate).
...
(`r prev_bio_lower_last_assess`--`r prev_bio_upper_last_assess`)~Mt. The current
...
the stock-recruitment relationship (i.e., no estimated recruitment deviate).
...
The 2023 and 2024 year classes were set based solely on the stock--recruitment
relationship for this assessment, such that no recruitment deviations were estimated
for these years. There are no survey data available to inform the estimates of
the `r end_yr - 1` and `r end_yr` year class sizes.
...
year and a modelled age of two (observed as age-1 fish) with a survey.
...
year and so 2023 recruitment was therefore set according to the stock--recruitment relationship
(with no estimated recruitment deviate). Further, the interactions among variance parameters that
...
recruitment; selectivity, weight-at-age and fecundity-at-age averaged over the five
