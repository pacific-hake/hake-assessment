...
above) peaked in 1999 and 2006
(Figure~\@ref(fig:es-exploitation-fraction-fig)). Over the last five years, the
median estimated exploitation fraction was the highest in 2021, followed
closely by 2020, before dropping by nearly half by 2023
(Table~\@ref(tab:es-fishing-intensity-tab)).
Median relative fishing intensity is
estimated to have declined from `r median_intensity_2011`% in 2011 to
`r median_intensity_2015`% in 2015, leveled off around 78--90% from
...
below `r f_40` from 2012--2015 and again in 2020, 2021, and 2023 (Figure~\@ref(fig:es-fishing-intensity-fig)).
...
table_decision(
  ...
  forecast_inds =
    seq_along(base_model$forecasts[[length(base_model$forecasts)]]),
  caption = paste0(
    "Forecast quantiles of relative fishing intensity ",
