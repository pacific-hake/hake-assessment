...
Over the last five years, it was the
highest in 2019 at `r median_intensity_2019`%, dropped
in 2020 to `r median_intensity_2020`%, then remained stable for 2021 and 2022
at `r median_intensity_2021`% and `r median_intensity_2022`% respectively.
The 3-year stable trend from 2020--2022 was ended in 2023 when the relative
fishing intensity dropped
...
above) peaked in 1999 and 2008 (Figure~\@ref(fig:es-exploitation-fraction-fig)).
The median exploitation fraction has decreased from a recent high in 2021 of
`r exploitation_med_2021` to `r exploitation_med_2023` in 2023, which is a
comparable level to 10 years ago (Table~\@ref(tab:es-fishing-intensity-tab) and
...
below 1.0 from 2012--2016 and again in 2020--2023
(Figure~\@ref(fig:es-fishing-intensity-fig)).
...
though Canada's was higher than the U.S.'s in 2020.
From 2020 the Canadian rate steadily declined to a time-series low of 14.4% in 2023, and
the U.S. rate fell to 52.1% in 2023.
...
Agreement for `r sp`, was implemented in 2022 and 2023.
...
With zero catch for the next three years, the biomass has a
