...
```{r es-catches-fig, fig.cap = "(ref:es-catches-cap)", fig.height = 4, fig.width = 8}
...
```{r es-survey-biomass-fig, fig.cap = "(ref:es-survey-biomass-cap)", fig.height=5, fig.width=8}
...
```{r es-survey-age1-fig, fig.cap = "(ref:es-survey-age1-cap)", fig.height = 5, fig.width = 8}
...
```{r es-biomass-fig, fig.cap = "(ref:es-biomass-cap)", fig.height = 5, fig.width = 8}
...
```{r es-relative-biomass-fig, fig.cap = "(ref:es-relative-biomass-cap)", fig.height = 5, fig.width = 8}
...
```{r es-recruitment-fig, fig.cap = "(ref:es-recruitment-cap)", fig.height = 5, fig.width = 8}
...
```{r es-fishing-intensity-fig, fig.cap = "(ref:es-fishing-intensity-cap)", fig.height = 5, fig.width = 8}
...
```{r es-exploitation-fraction-fig, fig.cap = "(ref:es-exploitation-fraction-cap)", fig.height = 5, fig.width = 8}
...
```{r es-phase-fig, fig.cap = "(ref:es-phase-cap)", fig.height = 5, fig.width = 8}
...
```{r es-depletion-comparison-fig, fig.cap = "(ref:es-depletion-comparison-cap)", fig.height = 5, fig.width = 8}
...
```{r es-risk-year-1-fig, fig.cap = "(ref:es-risk-year-1-cap)", fig.height = 4.5, fig.width = 8}
...
```{r es-risk-year-2-fig, fig.cap = "(ref:es-risk-year-2-cap)", fig.height = 4.5, fig.width = 8}
...
```{r es-risk-year-3-fig, fig.cap = "(ref:es-risk-year-3-cap)", fig.height = 4.5, fig.width = 8}
