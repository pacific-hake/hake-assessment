...
The addition of `r last_data_yr` data changes the estimates of absolute
recruitments for the most recent years, while
the improved
methods for modeling temporal weight-at-age and spatio-temporal maturity have
slightly changed some historical estimated recruitments.
...
`r f(base_model$mcmccalcs$rmed["2020"], 1)`~billion fish, but with a large
uncertainty. The general notion remains that recent `r sp` recruitment is
...
years, with small year classes for all other years from 2011--2019
(median recruitment well below the mean of all median recruitments).

The 2020 cohort is estimated to be above average, and the 2021 cohort is
estimated to be potentially large from limited fishery data and the 2023
survey.
The 2022 cohort was observed by the age-1 index in 2023,
suggesting it is average to below average in size. There is no information in the data to estimate the
