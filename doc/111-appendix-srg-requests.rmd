...
on the model that removes that age-1 index are not shown here. This model is now the base model and is in the main text.  Shown are the requested figures for the other four models
(Figures~\@ref(fig:main-tv-selex-uncertainty-fig-srg-app)--\@ref(fig:main-tv-selex-posteriors-fig4-srg-app)).
...
```{r srg-app-btsi2-fig, fig.cap = "(ref:srg-app-btsi-cap)", results = "asis"}
...
(see Figures~\@ref(fig:main-tv-selex-unc-tv8-srg-app)--\@ref(fig:main-recruitment-devs-base-a-srg-app)).
...
The base model shown in the following figures is the
