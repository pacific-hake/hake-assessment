...
* Figure~\@ref(fig:srg-prop-age-2-mature-by-temp-fig) shows empirical results for age 2 and
...
fecundity found in this document (Figures~\@ref(main-weight-at-age-fig)--
\@ref(main-fecundity-at-age-fig)). The Projected years (`r min(forecast_yrs)`--
...
The following list gives the differences in parameter estimates.
Figures~\@ref(fig:srg-plot-sur-fit-base-v-lambda-ssb-fig)--
\@ref(fig:srg-plot-recabs-base-v-lambda-ssb-fig) were provided to the SRG
to fulfill the request thoroughly.
...
survey observations (triangles) for the base model and the adjusted
lambda = 0.05 model.
...
(ref:srg-plot-age1-fit-base-v-lambda-ssb-cap) Fits to the age 1 index
observations (triangles) for the base model and the adjusted
lambda = 0.05 model.
...
(ref:srg-plot-base-v-lambda-ssb-cap) Estimated spawning biomass
for the base model and the adjusted lambda = 0.05 model. The shaded areas
...
(ref:srg-plot-rel-base-v-lambda-ssb-cap) Estimated relative spawning biomass
for the base model and the adjusted lambda = 0.05 model. The shaded areas
represent the 95% credible interval.
...
for the base model and the adjusted lambda = 0.05 model. The bars represent
...
table_catch_by_fleet(country = 2,
                     caption = "Fishery Catch-at-age for U.S. (t)",
                     font_size = 6)
```
...
are found almost exclusively in Canada and under age 10 mostly in the U.S.
