...
\resizebox{\textwidth}{!}{$formula <- functional_{maturity} \sim -1 + s(doy) + age_{scaled} + I(age_{scaled}^2) + mean_{temp} + I(mean_{temp}^2)$}

where there is **NO** interaction with the smoother on the day of the year.
Thus, the shape of the relationship does not change with time
...
(ref:srg-new-base-rel-biomass-cap) TODO: caption here

(ref:srg-new-base-rel-biomass-alt) TODO: Alt text here
