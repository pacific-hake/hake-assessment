...
and concerns related to `r sp`. (TODO get ref, see document).
...
TODO check the correct Malick 2020 ref, assuming Sidelecki

Seasonal forecasts of hake distribution in the northern region of the California
Current Ecosystem
[@MalickSiedleckiEtAl2020] were not available at the time of writing this
...
[@MalickSiedleckiEtAl2020 @Phillips2022], we suspect that the delayed
...
species has increased over this period as well (Leising et al., in prep). We
...
table. However, recent indices of prey abundance are favorable. Krill is a
dominant diet item for juvenile and adult hake TODO (Wippel et al. 2017)
[@Phillips2022], Bizzarro et al. 2023). The CCIEA krill indicator shows an
...
and ocean conditions [@MalickSiedleckiEtAl2020, VestfalsEtAl2023].
