...
make.mcmc.diag.plot(base_model, key.posteriors[1], key.posteriors.titles[1])
make.mcmc.diag.plot(base_model, key.posteriors[2], key.posteriors.titles[2])
par <- oldpar
@
\end{center}
...
par(mar=c(4.1, 4.1, 3.1, 0.1))
layout(matrix(c(1,2), nrow = 2, ncol = 1, byrow=TRUE))
make.mcmc.diag.plot(base_model, key.posteriors[3], key.posteriors.titles[3])
make.mcmc.diag.plot(base_model, key.posteriors[4], key.posteriors.titles[4])
par <- oldpar
@
\end{center}
...
par(mar=c(4.1, 4.1, 3.1, 0.1))
layout(matrix(c(1,2), nrow = 2, ncol = 1, byrow=TRUE))
make.mcmc.diag.plot(base_model, key.posteriors[5], key.posteriors.titles[5])
make.mcmc.diag.plot(base_model, key.posteriors[6], key.posteriors.titles[6])
par <- oldpar
@
\end{center}
...
\begin{figure}[H]
\begin{center}
<<main-mcmc-pairs, fig.height=8, fig.width=8, is.fig = TRUE, alt.text = "This figure shows pairs plots for many parameters and derived quantities. There is little correlation between values">>=
...
\begin{figure}[H]
\begin{center}
<<main-mcmc-pairs-recruit-devs, fig.height=8, fig.width=8, is.fig = TRUE, alt.text = "This figure shows pairs plots for many derived quantities. There is little correlation between values">>=
make.mcmc.diag.pairs.plot(base_model,
