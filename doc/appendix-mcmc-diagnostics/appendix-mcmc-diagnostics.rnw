...
This appendix contains the MCMC diagnostics for the base model.

%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[H]
\begin{center}
<<main-mcmc-diag-m-r0, fig.height=4, fig.width=8>>=
...
\begin{figure}[H]
\begin{center}
<<main-mcmc-diag-dm, fig.height=4.8, fig.width=8>>=
oldpar <- par(no.readonly=TRUE)
par(mar=c(4.1, 4.1, 3.1, 0.1))
layout(matrix(c(1,2), nrow = 2, ncol = 1, byrow=TRUE))
make.mcmc.diag.plot(base.model, subplot = 5)
make.mcmc.diag.plot(base.model, subplot = 6)
par <- oldpar
@
\end{center}
