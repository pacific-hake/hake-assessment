...
estimates of biomass from the acoustic survey) or improvements could be made to
the modeling framework to allow these environmental time series to affect
different parts of the stock--recruitment relationship. Results from such work
should be connected to or in cooperation with ongoing research related to
recruitment variability as discussed in
Section~\@ref(sec:assessment-response-review). Related, there is a need to
...
Coast Integrated Survey Initiative. The existing management strategy evaluation
