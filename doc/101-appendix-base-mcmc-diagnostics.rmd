...
```{r app-mcmc-pairs-fig, fig.cap = "(ref:main-mcmc-pairs-cap)", fig.height = 8, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-mcmc-pairs-alt)"}
...
```{r app-mcmc-pairs-recruit-devs-fig, fig.cap = "(ref:main-mcmc-pairs-recruit-devs-cap)", fig.height = 8, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-mcmc-pairs-recruit-devs-alt)"}
