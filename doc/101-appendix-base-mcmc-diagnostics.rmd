...
survey.http://127.0.0.1:16727/graphics/plot_zoom_png?width=1536&height=813
...
(ref:main-mcmc-pairs-cap) Posterior correlations among the objective
...
(ref:main-mcmc-pairs-alt) "This figure shows pairs plots for many parameters
and derived quantities. Natural mortality and log R0 show positive
correlation as do 2014 and 2016 recruitment.

```{r main-mcmc-pairs-fig, fig.cap = "(ref:main-mcmc-pairs-cap)", fig.height = 8, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-mcmc-pairs-alt)"}
...
(ref:main-mcmc-pairs-recruit-devs-cap) Posterior correlations among
...
(ref:main-mcmc-pairs-recruit-devs-alt) This figure shows pairs plots for
many derived quantities. There is some positive correlation between 2014
and 2016 recruitment deviations.

```{r main-mcmc-pairs-recruit-devs-fig, fig.cap = "(ref:main-mcmc-pairs-recruit-devs-cap)", fig.height = 8, fig.width = 8, is.fig = TRUE, alt.text = "(ref:main-mcmc-pairs-recruit-devs-alt)"}
