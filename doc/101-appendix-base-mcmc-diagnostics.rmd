...
(ref:app-mcmc-diag-h-extra-sd-alt) This figure shows good Markov chain Monte
Carlo diagnostics for the base model for steepness and the survey extra
...
for the additional standard deviation (SD) for the age-1 index (upper panels)
and the Dirichlet-multinomial age-composition parameter for the fishery ($\theta_{\text{fish}}$,
...
diagnostics for the base model for the two Dirichlet-multinomial parameters
for the fishery and survey.
