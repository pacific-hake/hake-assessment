...
index (upper 4 panels) and for the age-1 index (lower 4 panels) in the base
model. Sub-panel descriptions as in Figure~\@ref(fig:app-mcmc-diag-m-r0-fig).

(ref:app-mcmc-diag-extra-sd-alt) This figure shows good Markov chain Monte
Carlo diagnostics for the base model for the survey and age-1 index additional
