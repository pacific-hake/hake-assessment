...
\lstinputlisting{\Sexpr{gsub("^.*?hake-assessment/","../",base.model$dat.file)}}
...
\lstinputlisting{\Sexpr{gsub("^.*?hake-assessment/","../",base.model$ctl.file)}}
...
\lstinputlisting{\Sexpr{gsub("^.*?hake-assessment/","../",file.path(base.model$path, starter.file.name))}}
...
% \lstinputlisting{\Sexpr{gsub("^.*?hake-assessment/","hake-assessment/",file.path(base.model$path, forecast.file.name))}}
\lstinputlisting{\Sexpr{gsub("^.*?hake-assessment/","../",file.path(base.model$path, forecast.file.name))}}
...
\lstinputlisting{\Sexpr{gsub("^.*?hake-assessment/","../",file.path(base.model$path, weight.at.age.file.name))}}
