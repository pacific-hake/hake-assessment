...
\lstinputlisting{\Sexpr{here::here(models_path, basename(base.model$path), basename(base.model$dat.file))}}
...
\lstinputlisting{\Sexpr{here::here(models_path, basename(base.model$path), basename(base.model$ctl.file))}}
...
\lstinputlisting{\Sexpr{here::here(models_path, basename(base.model$path), basename(base.model$forecast.file.name))}}
