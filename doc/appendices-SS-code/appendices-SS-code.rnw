...
\lstinputlisting{\Sexpr{base.model$dat.file}}
...
\lstinputlisting{\Sexpr{base.model$ctl.file}}
...
\lstinputlisting{\Sexpr{file.path(base.model$path, starter.file.name)}}
...
\lstinputlisting{\Sexpr{file.path(base.model$path, forecast.file.name)}}
...
\lstinputlisting{\Sexpr{file.path(base.model$path, weight.at.age.file.name)}}
