...
\lstinputlisting{\Sexpr{gsub("^.*?hake-assessment/","../",file.path(base.model$path, starter_file_name))}}
...
\lstinputlisting{\Sexpr{gsub("^.*?hake-assessment/","../",file.path(base.model$path, forecast_file_name))}}
...
\lstinputlisting{\Sexpr{gsub("^.*?hake-assessment/","../",file.path(base.model$path, weight_at_age_file_name))}}
