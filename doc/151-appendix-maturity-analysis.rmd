...
1. a null model representing the status quo, similar to models used in previous
  hake assessments but with additional data;
...
(ref:app-maturity-analysis-sampling-platform-alt) This figure shows more observations at
younger ages but samples available past age-15.
...
(ref:app-maturity-analysis-sampling-platform-years-alt) There are more samples available
from 2012 to 2018 then in other years.
...
age samples from all platforms, partiuclarly from 2012 to 2019.
...
Bottom Trawl Survey (WCGBTS) north of Point Conception, in February.
...
(ref:app-maturity-analysis-age-marginal-alt) Estimated ogives for representative
years where temperatures were lower (2012), average (2020), and high (2016). The
ogive shifts to older ages at 50% maturity at higher temperatures.
...
(ref:app-maturity-analysis-cog-latitude-alt) The center of gravity of hake biomass from the WCGBTS was considerably lower from 2011 to 2014 compared to other years.
