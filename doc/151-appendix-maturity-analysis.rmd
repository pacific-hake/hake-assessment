...
Fig. \@ref(fig:app-maturity-analysis-sampling-platform-fig)-
\@ref(fig:app-maturity-analysis-sampling-platform-age-years-fig)). An
additional 180 samples exist with unknown ages, and 394 samples exist with
uncertain functional maturity; but these were omitted from our analysis.
Similarly, there are 73 samples in this dataset collected in British
Columbia (72 of 73 mature; 70 of 73 age 5 or older), but they have limited
temporal coverage (primarily 2013, 2015) and were omitted from our analysis.
...
temperature indices (Fig. \@ref(fig:app-maturity-analysis-temp-weight-effect-fig),
= 0.98 across all depths and months).
...
maturity at age; Table \@ref(tab:app-maturity-analysis-estimates-tab)).
...
our model using a temperature index to predict year effects received the
most support when ASHOP samples were included and only data north of Pt.
Conception was used (Table \@ref(tab:app-maturity-analysis-aic-tab), AIC > 10);
for other analysis scenarios with different subsets of data used, the time
varying random walk model without temperature as a driver received more
support. For consistency with previous hake stock assessment models, we
focus the remainder of our results on models that only use data north of
Pt. Conception, and also include the ASHOP samples.
...
(Fig. \@ref(fig:app-maturity-analysis-year-effects-nocovar-fig)). Including
...
(Fig. \@ref(fig:app-maturity-analysis-predicted-maps-byage-fig)). Biomass
weighted predictions of maturity also appeared similar between our
spatiotemporal models with and without temperature effects
(Fig. \@ref(fig:app-maturity-analysis-temp-model-sensitivities-fig)). The
largest differences between these models appears to be in years like 2016,
...
(Fig. \@ref(fig:app-maturity-analysis-temp-marginal-fig)). Temperatures in
...
(Fig. \@ref(fig:app-maturity-analysis-temp-depth-fig) -
\@ref(fig:app-maturity-analysis-temp-weight-effect-fig)), above the threshold
corresponding to the peak of the temperature-maturity relationship, and
maturity at age was estimated to decline in these years. Contrasts between
years can also be seen in the estimated ogives
(Fig. \@ref(fig:app-maturity-analysis-age-marginal-fig)) with a delay in
maturity occurring in years that are both cooler and warmer than 2016 (age
