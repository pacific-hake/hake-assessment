...
as a driver (raw February temperature at 130.67 m depth north of Point
Conception) alongside model results for Models 1--2. For each of these three
models, we generated predictions of each of the three models onto the WCGBTS
design grid for non-ASHOP samples (with a larger intercept, ASHOP samples have
earlier maturity at age; Table \@ref(tab:app-maturity-analysis-estimates-tab)).
