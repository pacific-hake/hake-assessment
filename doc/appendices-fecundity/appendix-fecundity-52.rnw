...
\chapter{Fecundity sensitivity Run 52}
\label{chap:fecundity-52}

This appendix contains MCMC model results for the fecundity sensitivty, run 52
as described in the main text and Table~\ref{tab:main-wtatage-runs}.

%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[H]
\begin{center}
<<spawning.biomass.52, fig.height=5, fig.width=8>>=
...
\caption{Median of the posterior distribution for beginning of the year female
         ...
         biomass.}
\label{fig:female-spawning-biomass-52}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[H]
\begin{center}
<<relative.spawning.biomass.52, fig.height=5, fig.width=8>>=
...
\label{fig:relative-spawning-biomass-52}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%

<<biomass.table.52, results='asis', echo=FALSE>>=
...
<<recruitment.table.52, results='asis', echo=FALSE>>=
...
\begin{figure}[H]
\begin{center}
<<recruitment.52, fig.height=5, fig.width=8>>=
...
\label{fig:recruitment-52}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%

<<fishing.intensity.table.52, results='asis', echo=FALSE>>=
make.fishing.intensity.table(sens.model,
                             ...
                             xlabel = "tab:fishing-intensity-52",
                             font.size = 12,
                             space.size = 14,
                             placement = "H")
@
...
\begin{figure}[H]
\begin{center}
<<fishing.intensity.52, fig.height=5, fig.width=8>>=
...
\label{fig:fishing-intensity-52}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%
%
...
\begin{figure}[H]
\begin{center}
<<exploitation.fraction.52, fig.height=5, fig.width=8>>=
...
\label{fig:exploitation-fraction-52}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[H]
\begin{center}
<<phase.plot.52, fig.height=5, fig.width=8>>=
...
<<reference.points.table.52, results='asis', echo=FALSE>>=
make.reference.points.table(
  ...
  xcaption = paste0("For the \\altshort, summary of median and 95\\%",
                     ...
                     " size-at-age and selectivity-at-age."),
                            xlabel = "tab:reference-points-52",
                            font.size = 12,
                            space.size = 14,
                            placement = "H")
@

<<decisions.biomass.table.52, results='asis', echo=FALSE>>=
make.decision.table(
  sens.model,
  xcaption =
    paste0("For the \\altshort, forecast quantiles of \\fishname\\ ",
           ...
           " year biomass in ", max(forecast_yrs), "."),
                    xlabel = "tab:decisions-biomass-52",
                    font.size = 12,
                    space.size = 14,
                    type = "biomass",
                    placement = "H")
...
\begin{figure}[H]
\begin{center}
<<forecast.depletion.comparison.plot.52, fig.height=5, fig.width=8>>=
...
\caption{Time series of estimated relative spawning biomass to \Sexpr{end.yr}
         ...
         defined in Table~\ref{tab:decisions-biomass-52}, with 95\%
...
\label{fig:forecast-depletion-comparison-52}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[H]
\begin{center}
<<forecast.risk.comparison.plot.year.1.52, fig.height=5, fig.width=8>>=
...
\caption{Graphical representation of the probabilities related to spawning
         ...
         options explained in Table~\ref{tab:decisions-biomass-52}) as listed in
         Table~\ref{tab:risk-year-1-52}. The symbols indicate points that were
         computed directly from model output and lines interpolate between the
         points.}
\label{fig:forecast-risk-comparison-year-1-52}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%

<<risk.forecast.year.1.table.52, results='asis', echo=FALSE>>=
make.risk.table(sens.model,
                ...
                xcaption = paste0("Probabilities related to spawning biomass,
                             ...
                             Table~\\ref{tab:decisions-biomass-52})."),
                xlabel = "tab:risk-year-1-52",
                font.size = 12,
                space.size = 14,
                placement = "H")
@
...
\begin{figure}[H]
\begin{center}
<<forecast.risk.comparison.plot.year.2.52, fig.height=5, fig.width=8>>=
make.forecast.risk.comparison.plot(sens.model,
                                   forecast_yrs = forecast_yrs,
...
Table~\ref{tab:decisions-biomass-52}) as listed in
Table~\ref{tab:risk-year-2-52}. The symbols indicate points that were computed
directly from model output and lines interpolate between the points.}
\label{fig:forecast-risk-comparison-year-2-52}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%

<<risk.forecast.year.2.table.52, results='asis', echo=FALSE>>=
make.risk.table(sens.model,
                forecast_yrs,
                ...
                xcaption = paste0("Probabilities related to spawning biomass,
                 ...
                 Table~\\ref{tab:risk-year-1-52} (catch options explained in
                 Table~\\ref{tab:decisions-biomass-52})."),
                xlabel = "tab:risk-year-2-52",
                font.size = 12,
                space.size = 14,
                placement = "H")
@
