...
\chapter{Sensitivity run with alternative fecundity -- MCMC results}
\label{chap:eq-fecundity-early-10}
...
\begin{figure}[H]
\begin{center}
<<spawning.biomass.53, fig.height=5, fig.width=8>>=
...
\caption{Median of the posterior distribution for beginning of the year female
         ...
         biomass.}
\label{fig:female-spawning-biomass-53}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[H]
\begin{center}
<<relative.spawning.biomass.53, fig.height=5, fig.width=8>>=
...
\label{fig:relative-spawning-biomass-53}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%

<<biomass.table.53, results='asis', echo=FALSE>>=
...
<<recruitment.table.53, results='asis', echo=FALSE>>=
...
\begin{figure}[H]
\begin{center}
<<recruitment.53, fig.height=5, fig.width=8>>=
...
\label{fig:recruitment-53}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%

<<fishing.intensity.table.53, results='asis', echo=FALSE>>=
make.fishing.intensity.table(sens.models.5[[3]],
                             ...
                             xlabel = "tab:fishing-intensity-53",
                             font.size = 12,
                             space.size = 14,
                             placement = "H")
@
...
\begin{figure}[H]
\begin{center}
<<fishing.intensity.53, fig.height=5, fig.width=8>>=
...
\label{fig:fishing-intensity-53}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%
%
...
\begin{figure}[H]
\begin{center}
<<exploitation.fraction.53, fig.height=5, fig.width=8>>=
...
\label{fig:exploitation-fraction-53}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[H]
\begin{center}
<<phase.plot.53, fig.height=5, fig.width=8>>=
...
<<reference.points.table.53, results='asis', echo=FALSE>>=
make.reference.points.table(
  ...
  xcaption = paste0("For the \\altshort, summary of median and 95\\%",
                     ...
                     " size-at-age and selectivity-at-age."),
                            xlabel = "tab:reference-points-53",
                            font.size = 12,
                            space.size = 14,
                            placement = "H")
@

<<decisions.biomass.table.53, results='asis', echo=FALSE>>=
make.decision.table(sens.models.5[[3]],
                    xcaption = paste0("Forecast quantiles of \\fishname\\
                     ...
                     max(forecast_yrs),
                     "."),
                    xlabel = "tab:decisions-biomass-53",
                    font.size = 12,
                    space.size = 14,
                    type = "biomass",
                    placement = "H")
...
\begin{figure}[H]
\begin{center}
<<forecast.depletion.comparison.plot.53, fig.height=5, fig.width=8>>=
...
\label{fig:forecast-depletion-comparison-53}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[H]
\begin{center}
<<forecast.risk.comparison.plot.year.1.53, fig.height=5, fig.width=8>>=
...
\caption{Graphical representation of the probabilities related to spawning
         ...
         options explained in Table~\ref{tab:decisions-biomass-53}) as listed in
         Table~\ref{tab:risk-year-1-53}. The symbols indicate points that were
         computed directly from model output and lines interpolate between the
         points.}
\label{fig:forecast-risk-comparison-year-1-53}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%

<<risk.forecast.year.1.table.53, results='asis', echo=FALSE>>=
make.risk.table(sens.models.5[[3]],
                ...
                xcaption = paste0("Probabilities related to spawning biomass,
                             ...
                             Table~\\ref{tab:decisions-biomass-53})."),
                xlabel = "tab:risk-year-1-53",
                font.size = 12,
                space.size = 14,
                placement = "H")
@
...
\begin{figure}[H]
\begin{center}
<<forecast.risk.comparison.plot.year.2.53, fig.height=5, fig.width=8>>=
make.forecast.risk.comparison.plot(sens.models.5[[3]],
                                   forecast_yrs = forecast_yrs,
...
Table~\ref{tab:decisions-biomass-53}) as listed in
Table~\ref{tab:risk-year-2-53}. The symbols indicate points that were computed
directly from model output and lines interpolate between the points.}
\label{fig:forecast-risk-comparison-year-2-53}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%

<<risk.forecast.year.2.table.53, results='asis', echo=FALSE>>=
make.risk.table(sens.models.5[[3]],
                forecast_yrs,
                ...
                xcaption = paste0("Probabilities related to spawning biomass,
                 ...
                 Table~\\ref{tab:risk-year-1-53} (catch options explained in
                 Table~\\ref{tab:decisions-biomass-53})."),
                xlabel = "tab:risk-year-2-53",
                font.size = 12,
                space.size = 14,
                placement = "H")
@
