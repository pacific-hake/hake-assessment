...
Spawning potential ratio (SPR): A metric of fishing intensity. The ratio of the spawning output per recruit under a given level of fishing to the estimated spawning output per recruit in the absence of fishing. It achieves a value of 100\% in the absence of fishing and declines toward zero as fishing intensity increases.
