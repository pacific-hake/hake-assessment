...
intensity relative to that at the SPR fishing rate $\Fforty$, where $\Fforty$ is the $F$ that
gives an SPR of 40\% such that, by definition, SPR$(\Fforty) = 40\%$ (the benchmark spawning
ratio). Therefore
\eb
