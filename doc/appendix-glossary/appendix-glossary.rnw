...
\begin{figure}[t]
\begin{center}
<<fishing-intensity-illustration, fig.height=5, fig.width=5, is.fig = TRUE, alt.text = "This figure shows ******">>=
# Do as a function so that variables remain local
...
\begin{figure}[t]
\begin{center}
<<SPR-illustration, fig.height=7, fig.width=6, is.fig = TRUE, alt.text = "This figure shows ******">>=
