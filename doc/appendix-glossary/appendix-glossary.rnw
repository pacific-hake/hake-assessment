...
% Do as function so that intensity is local
%intensity.plot = function(intensity=seq(0, 1.7, 0.01), target = 0.4)
%  {
%  acheived = ....
%  }      
%
...
** AME to do figure, but doesn't understand what the equation for it should be (and whether notation is consistent with text)....
