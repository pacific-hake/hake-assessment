...
U.S./Canadian allocation: The division of the total allowable catch of \Sexpr{us.allotment.percent}\% as for the U.S. share and \Sexpr{can.allotment.percent}\% for the Canadian share.
