...
Joint Technical Committee (JTC): The joint technical committee established by the Agreement. The full formal name is ``Joint Technical Committee of the \fishname\ Agreement Between the Governments of the United States and Canada''.
...
\fishname: \emph{\sciencename} are located in the offshore waters of the United States and Canada (not including smaller stocks located in Puget Sound and the Strait of Georgia). % **AME -- it's not really the `stock', it's the species. 
