...
# `forecast_yrs` is special because it is an R expression in the YAML code
# and not just a plain value. It has to be parsed from a text string into
# an R expression using `eval(parse())`
...
theme_set(hake_theme(ax_label_color = fig_label_color,
                     ...
                     margin_def = eval(parse(text = fig_margins))))
```
