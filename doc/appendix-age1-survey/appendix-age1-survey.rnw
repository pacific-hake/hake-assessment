...
Sections~\ref{sec:sec:data-acoustic-survey} and \ref{sec:assessment-sensitivity-analyses}
and Table~\ref{tab:main-parameter-estimates-sens-1}. The inclusion of the age-1
survey index may improve estimates of recruitment near the end 
of the time series and age composition during the forecast period, even though the acoustic 
survey design is not structured specifically for indexing age-1 fish. This appendix highlights
...
important enough to warrent further consideration, especially in the context of characterizing
uncertainty.    

The following figures and tables follow an executive summary format.
