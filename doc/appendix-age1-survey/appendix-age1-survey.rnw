...
forecast uncertainty. Nonetheless, this appendix is only meant to provide supplemental information,
and should not be viewed as a viable alternative to the base model.
The figures and tables show results from this sensitivity run (though
