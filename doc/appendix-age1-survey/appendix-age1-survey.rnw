...
** probably not needed for 2023; SRG said to do age-1 survey exclusion as a
standard sensitivity. So commenting out the call to this Appendix.
...
\Sexpr{f(base_model$mcmccalcs$rmed["2020"], 1)}~billion fish (base model, Table~\ref{tab:main-est-numbers-at-age})
to \Sexpr{f(sens_models_2[[1]]$mcmccalcs$rmed["2020"], 1)}~billion fish
...
make.biomass.plot(sens_models_2[[1]],
...
make.depletion.plot(sens_models_2[[1]],
                    start_yr = start_yr,
                    end_yr = end_yr,
                    color = "blue")
@
...
make.biomass.table(sens_models_2[[1]],
                   start_yr = end_yr - 9,
                   end_yr = end_yr,
                   weight.factor = 1000,
...
make.recruitment.table(sens_models_2[[1]],
                       start_yr = end_yr - 10,
                       end_yr = end_yr - 1,
                       weight.factor = 1000,
...
make.fishing.intensity.table(sens_models_2[[1]],
                             start_yr = end_yr - 10,
                             end_yr = end_yr - 1,
                             digits = 3,
...
make.fishing.intensity.plot(sens_models_2[[1]],
                            start_yr = start_yr,
                            end_yr = end_yr - 1,
                            color = "blue",
                            upper.lim = 1.5)
...
make.exploitation.fraction.plot(sens_models_2[[1]],
                                start_yr = start_yr,
                                end_yr = end_yr - 1,
                                color = "blue",
                                upper.lim = 0.35)
...
make.phase.plot(sens_models_2[[1]],
                start_yr = start_yr,
                end_yr = end_yr)
@
\end{center}
...
decision_table(sens_models_2[[1]],
               xcaption =
...
models.names <- sapply(sens_models_2[[1]]$catch.levels, "[[", 2)[models.inds]
...
make.forecast.risk.comparison.plot(sens_models_2[[1]],
...
make.risk.table(sens_models_2[[1]],
                forecast_yrs,
