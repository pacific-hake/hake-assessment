...
\hspace{4ex}Allan C. Hicks\supscr{2} \\
\hspace{4ex}Aaron Berger\supscr{3} \\
\hspace{4ex}Andrew M. Edwards\supscr{1} \\ %Given the amount of work that Andy has done, there's no way my name should appear before his on the author list
\hspace{4ex}Nathan Taylor\supscr{1} \\
