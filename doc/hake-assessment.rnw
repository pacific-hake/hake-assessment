...
# Can temporarily comment out these lines if just editing text/figures (but
#  uncomment them before pushing)
...
\hspace{4ex}Kelli F. Johnson\supscr{2} \\
...
\emph{\supscr{2}Northwest Fisheries Science Center, National Marine Fisheries
...
%% paragraph. Then update any `\% Manual done 2019` text after the paragraph so we
%% definitely know it has been verified. Should end up with no ** by the end (including here!). We'll still
%% read through everything, but the ** indicates what definitely needs some
%% thinking. *******COMMENT ME OUT WHEN DONE*******

%% Final version (with standard author rotation)
This document should be cited as follows:\\
Grandin, C.J., K.F. Johnson, A.M. Edwards, and A.M. Berger.
...
<<appendix-fishery-reports, child='appendix-fishery-reports/appendix-fishery-report-Canada-2019.rnw'>>=
@

\rfoot{Appendix~\ref{chap:us-fishery-report} -- United States fishery report}
<<appendix-fishery-reports, child='appendix-fishery-reports/appendix-fishery-report-US-2019.rnw'>>=
@
...
% \rfoot{Appendix~\ref{chap:fecundity-10} -- Fecundity Early 10 sensitivity}
% <<appendices-fecundity, child='appendix-fecundity-10/appendix-fecundity-10.rnw'>>=
% @

\rfoot{Appendix~\ref{chap:age1-survey} -- Age-1 survey sensitivity}
<<appendices-fecundity, child='appendix-age1-survey/appendix-age1-survey.rnw'>>=
@

\rfoot{Appendix~\ref{chap:adnuts} -- ADNUTS MCMC run}
<<appendices-fecundity, child='appendix-adnuts/appendix-adnuts.rnw'>>=
@
