...
Grandin, C.J., A.C. Hicks, A.M. Berger, A.M. Edwards, N. Taylor, I.G. Taylor, and S. Cox. \Sexpr{assess.yr}.
...
National Marine Fisheries Service and Fisheries and Oceans Canada. xxi~$+$~\pageref{LastPage}~p.
%% \pageref{LastPage} works for arabic pages, but not roman numerals, which we aren't using next year.
