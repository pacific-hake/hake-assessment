...
<<appendix-srg-requests, child='appendix-srg-requests/appendix-srg-requests-2020.rnw'>>=
@
...
<<sens.age1>>=
sens.model <- sens.models.2[[1]]
@
\rfoot{Appendix~\ref{chap:age1-survey} -- Age-1 survey sensitivity}
<<appendices-fecundity, child='appendices-fecundity/appendix-age1-survey.rnw'>>=
@

<<sens.fecundity>>=
sens.model <- sens.models.5[[3]]
@
\rfoot{Appendix~\ref{chap:eq-fecundity-early-10} -- Fecundity sensitivity}
<<appendices-fecundity, child='appendices-fecundity/appendix-eq-fecundity-early-10.rnw'>>=
@
