...
\lhead{}
\rhead{}
%% \lfoot{\fishname\ stock assessment 2016}
...
## The load.models.into.parent.env function is located at bottom
##  of model-setup.r.
if(TRUE){
...
%% DRAFT version
%% \title{\TitleFont Status of the \fishname\ (whiting) stock in U.S. and
%% Canadian waters in \Sexpr{assess.yr}\thanks{\noindent Disclaimer: This
...
\emph{\supscr{4}School of Resource and Environmental Management, Simon Fraser
  University, TASC I -- Room \#8405, 8888 University Drive, Burnaby, B.C.
  V5A 1S6, Canada}
...
Edwards, A.M., I.G. Taylor, C.J. Grandin, A.M. Berger, and S. Cox.
...
<<appendix-srg-requests, child='appendix-srg-requests/appendix-srg-requests-2018.rnw'>>=
@
...
<<appendix-fishery-reports, child='appendix-fishery-reports/appendix-fishery-report-Canada-2017.rnw'>>=
@

\rfoot{Appendix~\ref{chap:us-fishery-report} -- United States fishery report}
<<appendix-fishery-reports, child='appendix-fishery-reports/appendix-fishery-report-US-2017.rnw'>>=
@
