...
fig_align <- "center"
fig_pos <- "htb"
# The "dev" line below is modified by the build_doc() function. Do not modify or
# move it. keep it directly under the opts_chunk$set line with nothing in between
opts_chunk$set(
dev = 'cairo_ps',
               dpi = fig_dpi,
               fig.width = fig_width,
...
fig.path = 'knitr-cache-eps/',
cache.path = 'knitr-cache-eps/',
               # Do not move this cache line from the end of the list as
               # the build_doc() function relies on it being here.
               cache = TRUE)
...
<<appendices-nuts, child='appendix-adnuts/appendix-adnuts.rnw'>>=
@
