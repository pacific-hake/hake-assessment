...
\hspace{4ex}Aaron M. Berger\supscr{2} \\
\hspace{4ex}Chris J. Grandin\supscr{1} \\
\hspace{4ex}Kelli F. Johnson\supscr{3} \\
\bigskip

\emph{\supscr{1}Pacific Biological Station, Fisheries and Oceans Canada,
  3190 Hammond Bay Road, Nanaimo, B.C. V9T 6N7, Canada}

\emph{\supscr{2}Northwest Fisheries Science Center, National Marine
...
Edwards, A.M., A.M. Berger, C.J. Grandin and K.F. Johnson.
...
\rfoot{Appendix~\ref{chap:rec-plot} -- Recruitment plots}
<<appendices-rec-plot, child='appendix-rec-plot/appendix-rec-plot.rnw'>>=
@
