...
\renewcommand{\thetable}{\arabic{table}}     %  where first 1 would be chapter
\renewcommand{\thefigure}{\arabic{figure}}   %  number.
...
\phantomsection \addcontentsline{toc}{subsection}{REFERENCES} %So TOC correct
