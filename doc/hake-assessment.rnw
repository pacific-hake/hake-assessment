...
<<load-globals, child='globals/load-globals.rnw'>>=
@

<<load-data-tables, child='globals/load-data-tables.rnw'>>=
@

<<load-models, child='globals/load-models.rnw'>>=
@

<<load-custom-knitr-variables, child='globals/load-custom-knitr-variables.rnw'>>=
@
