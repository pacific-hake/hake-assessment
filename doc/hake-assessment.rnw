...
\pagenumbering{roman}
\lfoot{Pacific Hake stock assessment \Sexpr{assess.yr}} %% Species common name for left footer
\rfoot{DRAFT - DO NOT CITE} %% The area of the assessment for right footer
...
\hspace{4ex}Aaron Berger\supscr{4} \\
\hspace{4ex}Andrew M. Edwards\supscr{2} \\ %Given the amount of work that Andy has done, there's no way my name should appear before his on the author list
...
\emph{\supscr{4}Northwest Fisheries Science Center, National Marine Fisheries Service, National Oceanic and Atmospheric Administration, U.S. Department of Commerce.
  2032 SE OSU Dr. Bldg. 955, Newport, OR 97365-5275, USA}

This DRAFT document is non-citable.
% Once finalised, uncomment these:
% This document should be cited as follows: Grandin, C.J., A.C. Hicks, A. Berger, N. Taylor, A.M. Edwards, S. Cox, and I.G. Taylor. 2015.
...
% National Marine Fishery Service; Canada Department of Fisheries and Oceans. *******~p.
% Seem to be a lot of semi-colons in there!
...
\renewcommand{\theequation}{\arabic{equation}} % where first 1 would be chapter
                                               % number
\renewcommand{\bibsection}{\section{REFERENCES}} %References as numbered section
...
@      % Keeping track of missing references, will get deleted once empty.
