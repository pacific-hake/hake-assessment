...
make.comparison.plot(c(list(base_model), list(sens_models_7)),
                     subplots = 2,
                     model.names = c(base_model_name, sens.model.names.7),
                     end_yr = end_yr, plot_mcmc = TRUE)
@
\end{center}
...
make.comparison.plot(c(list(base_model), list(sens_models_7)),
                     subplots = 4,
                     model.names = c(base_model_name, sens.model.names.7),
                     end_yr = end_yr, plot_mcmc = TRUE, legend = FALSE)
@
\end{center}
...
%make.biomass.plot(sens_models_6,
...
%make.depletion.plot(sens_models_6,
%                    start_yr = start_yr,
%                    end_yr = end_yr,
%                    color = "blue")
%@
...
%make.biomass.table(sens_models_6,
%                   start_yr = end_yr-9,
%                   end_yr = end_yr,
%                   weight.factor = 1000,
...
%make.recruitment.table(sens_models_6,
%                       start_yr = end_yr-10,
%                       end_yr = end_yr-1,
%                       weight.factor = 1000,
...
%make.recruitment.plot(sens_models_6,
%                      equil.yr = unfished_eq_yr,
%                      start_yr = start_yr,
%                      end_yr = end_yr,
%                      color = "blue",
...
%make.fishing.intensity.table(sens_models_6,
%                             start_yr = end_yr-10,
%                             end_yr = end_yr-1,
%                             digits = 3,
...
%make.fishing.intensity.plot(sens_models_6,
%                            start_yr = start_yr,
%                            end_yr = end_yr-1,
%                            color = "blue",
%                            upper.lim = 1.5)
...
%make.exploitation.fraction.plot(sens_models_6,
%                                start_yr = start_yr,
%                                end_yr = end_yr-1,
%                                color = "blue",
%                                upper.lim = 0.35)
...
% models.names <- sapply(sens_models_6$catch.levels, "[[", 2)[models.inds]
%                        ## pretty catch level name
% make.forecast.depletion.comparison.plot(sens_models_6,
%                                         models.inds,
%                                         models.names,
%                                         start_yr = 2009,
%                                         model.end_yr = end_yr,
...
%make.forecast.risk.comparison.plot(sens_models_6,
...
make.mcmc.survey.fit.plot(sens_models_7,
...
make.mcmc.diag.plot(sens_models_7, key.posteriors[1], key.posteriors.titles[1])
make.mcmc.diag.plot(sens_models_7, key.posteriors[2], key.posteriors.titles[2])
par <- oldpar
@
\end{center}
...
par(mar=c(4.1, 4.1, 3.1, 0.1))
layout(matrix(c(1,2), nrow = 2, ncol = 1, byrow=TRUE))
make.mcmc.diag.plot(sens_models_7, key.posteriors[3], key.posteriors.titles[3])
make.mcmc.diag.plot(sens_models_7, key.posteriors[4], key.posteriors.titles[4])
par <- oldpar
@
\end{center}
...
par(mar=c(4.1, 4.1, 3.1, 0.1))
layout(matrix(c(1,2), nrow = 2, ncol = 1, byrow=TRUE))
make.mcmc.diag.plot(sens_models_7, key.posteriors[5], key.posteriors.titles[5])
make.mcmc.diag.plot(sens_models_7, key.posteriors[6], key.posteriors.titles[6])
par <- oldpar
@
\end{center}
...
plot_mcmc_param_stats(sens_models_7)
@
\end{center}
...
make.mcmc.diag.pairs.plot(sens_models_7,
                          inc.key.params = TRUE,
