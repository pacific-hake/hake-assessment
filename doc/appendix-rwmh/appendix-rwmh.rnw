...
\begin{figure}[H]
\begin{center}
<<biomass-base-alternative-7-rwmh-sens, fig.height=4.5, fig.width=8, is.fig = TRUE, alt.text = "This figure shows ******">>=
...
%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
<<status-base-alternative-7-rwmh-sens, fig.height=4.5, fig.width=8, is.fig = TRUE, alt.text = "This figure shows ******">>=
make.comparison.plot(c(list(base.model), list(sens.models.7)),
                     subplots = 4,
                     model.names = c(base.model.name, sens.model.names.7),
                     end.yr = end.yr, plot_mcmc = TRUE)
...
\begin{figure}[H]
\begin{center}
<<recruitment-base-alternative-7-rwmh-sens, fig.height=4.5, fig.width=8, is.fig = TRUE, alt.text = "This figure shows ******">>=
make.comparison.plot(c(list(base.model), list(sens.models.7)),
                     legend = FALSE,
                     subplots = 10,
                     model.names = c(base.model.name, sens.model.names.7),
...
%% \begin{figure}[H]
\begin{center}
<<recruitment-devs-base-alternative-7-rwmh-sens, fig.height=4.5, fig.width=8, is.fig = TRUE, alt.text = "This figure shows ******">>=
make.comparison.plot(c(list(base.model), list(sens.models.7)),
                     legend = FALSE,
                     subplots = 12,
                     model.names = c(base.model.name, sens.model.names.7),
...
\begin{figure}[H]
\begin{center}
<<mcmc-survey-fit-rwmh, fig.height=6, fig.width=8, is.fig = TRUE, alt.text = "This figure shows ******">>=
...
\begin{figure}[H]
\begin{center}
<<mcmc-diag-m-r0-rwmh, fig.height=4, fig.width=8, is.fig = TRUE, alt.text = "This figure shows ******">>=
...
\begin{figure}[H]
\begin{center}
<<mcmc-diag-h-extra-sd-rwmh, fig.height=4.8, fig.width=8, is.fig = TRUE, alt.text = "This figure shows ******">>=
oldpar <- par(no.readonly=TRUE)
par(mar=c(4.1, 4.1, 3.1, 0.1))
layout(matrix(c(1,2), nrow = 2, ncol = 1, byrow=TRUE))
...
\begin{figure}[H]
\begin{center}
<<mcmc-diag-dm-rwmh, fig.height=4.8, fig.width=8, is.fig = TRUE, alt.text = "This figure shows ******">>=
oldpar <- par(no.readonly=TRUE)
par(mar=c(4.1, 4.1, 3.1, 0.1))
layout(matrix(c(1,2), nrow = 2, ncol = 1, byrow=TRUE))
...
\begin{figure}[H]
\begin{center}
<<mcmc-diag-hists-rwmh, fig.height=6, fig.width=8, is.fig = TRUE, alt.text = "This figure shows ******">>=
...
\begin{figure}[H]
\begin{center}
<<mcmc-pairs-rwmh, fig.height=8, fig.width=8, is.fig = TRUE, alt.text = "This figure shows ******">>=
...
\begin{figure}[H]
\begin{center}
<<mcmc-pairs-recruit-devs-rwmh, fig.height=8, fig.width=8, is.fig = TRUE, alt.text = "This figure shows ******">>=
make.mcmc.diag.pairs.plot(sens.models.7,
