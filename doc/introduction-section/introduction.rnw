...
compiled at Git commit \Sexpr{ss.commit} on \Sexpr{ss.commit.date}.
...
KingMcFarlaneEtAl2012, GarciaEtAl2018
}. Genetic differences have also been found between the
