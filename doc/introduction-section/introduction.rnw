...
first time, all sensitivity analyses are performed in a Bayesian
context rather than just using maximum likelihood estimation.
% Use this later:
...
\fishname\ is currently the [** presumably still true?] most abundant groundfish population in the
...
**Mention Malick et al 2020 paper here presumably... The research on links between migration
...
**Replace/update with Malick and any other refs?: Ongoing research investigating abiotic (environmental conditions) and biotic
...
In terms of an `Ecosystem Approach to
...
%consider adding Malick et al (in press as of 2/2020) next year once published,
%this will be related to hake distribution and temperature work.
%Similiarly add Turley and Rykaczewski CJFAS 2019 because it discusses mortality of larval \fishname\
%signficantly decreased as storm events increased in southern CA current Ecosystem,
%which was opposite all other species (from icthyoplankton surveys). This suggests
%that storms that effect otherwise calm periods may be beneficial for the survival
%of \fishname\ and somewhat goes against the stable ocean hypothesis.
...
adhered to since ratification of the Agreement ***until 2020 when ....

**[prob needs a bit of thinking] Throughout the last decade, the total coast-wide catch has tracked harvest
...
quotas were determined using the default harvest control rule and
stock assessment outputs.

\subsubsection{Management of \fishname\ in the United States}
\label{sec:intro-management-us}

**[presume still all fine] In the U.S. zone, participants in the directed fishery are required to use
...
salmon (\emph{Oncorhynchus tshawytscha}) and several depleted rockfish stocks
(though all but one of the rockfish stocks have
...
% There was a Joint-Venture fishery conducted in \Sexpr{latest.year.can.jv}.
...
**[update ref since now published] The \fishname\ stock is of huge commercial value. For example, in Canada alone
over CA\$26~million in wages was estimated to have been paid to employees of the
processing industry in 2018, with an exported value of CA\$100~million mainly
to Ukraine, China, South Africa and Lithuania
(DFO Groundfish Pacific Region 2020 Integrated Fisheries Management Plan summary, in prep., to be available at
\href{http://www.pac.dfo-mpo.gc.ca/fm-gp/ifmp-eng.html}{http://www.pac.dfo-mpo.gc.ca/fm-gp/ifmp-eng.html}).


\subsubsection{Overview of the fisheries in \Sexpr{last.data.yr}}\label{sec:intro-fisheries-overview}

**[need to be comment out allotment percentages this year, and mention that not
the usual percentages]
The Joint Management Committee (JMC) determined an adjusted (for carryovers)
coast-wide TAC of \Sexpr{last.year.tac}~t for \Sexpr{last.data.yr},
...
**Whole subsection needs updating (once we get US report?). Also mention COVID impacts.
...
The overall catch of \fishname\ in U.S. waters was slightly less than in 2018,
but was the third highest value ever recorded (Table~\ref{tab:intro-catches-US}).
Monthly catch rates were similar to those calculated for 2018, except for September which was considerably higher in 2019 compared to 2018 (Figure~\ref{fig:main-us-catch-rates}). Tribal landings available
...
In both U.S. at-sea sectors (CP and MS) the most common cohorts in the fishery were age-9, age-5, and age-3 fish associated with the 2010, 2014, and 2016 year-classes.
Age-2 fish were more present in the catch this year than in 2018.
Sampling by sector varied with \Sexpr{us.age.n.cp} and \Sexpr{us.age.n.ms}
sampled hauls from each sector, respectively (Table~\ref{tab:main-sampling-history}).
...
showed a similar proportional abundances for
...
rates, whereas catch rates were higher in September and October.  The median fishing depth for the at-sea fleets was slightly shallower than last year, which was shallower than
previous years (Figure~\ref{fig:main-us-at-sea-depths}). From mid-June to September/October, operators
in the at-sea fishery moved to their usual summer fishing grounds where they experienced slower than normal fishing of Bering Sea Walleye Pollock.  The shore-based fishery had the largest monthly
catches during July, August, and September.
...
**Whole subsection needs updating (once we get Canadian report?). Also mention COVID impacts.
...
Fishing started in February and ended in early December. This year most of the
fish were caught in the deep water `scuzz' layer as opposed to the usual large aggregations.
Fish migration appeared normal with early fishing in the South and moving northward throughout the season. The deeper `scuzz' fishing resulted in higher than normal bycatch of Rougheye
and Bocaccio rockfish. Small fish (aged 2-3 years) were found over the whole fishing season in
the North, around Queen Charlotte Sounds and Milbank Sound.
