...
quotas summed to **[check these hardwired numbers now that catches have been
updated] 128\% of the coast-wide limit, while the 1993-1999 combined
...
population. However, management has been **[should precautionary to something
more explicit] precautionary in years when very large
...
**[presumably all still fine]In the U.S. zone, participants in the directed fishery are required to use
...
**[presumably all still fine]Shortly after the 1997 allocation agreement was approved by the Pacific Marine
...
**[currently missing, check it appears, issue \#605]\Sexpr{last.year.can.carryover}~t of uncaught carryover fish from
...
**Should get updated automatically in 2020 once issue \#605 fixed, and providing
 percentages haven't changed. Also some of this may need to wait for US AP report.
...
**[check once \#605 fixed, and maybe unhardwire the 2423 value (maybe not worth it).
...
**[update hard-wired numbers, see comment after this paragraphs that suggests
how to automate some of it] In both U.S. at-sea sectors (CP and MS) the most common cohorts in the spring
