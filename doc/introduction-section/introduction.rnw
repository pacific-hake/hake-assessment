...
habitat conditions for mature \fishname\ has been related to higher biomass further
north and lower biomass around the U.S-Canadian border, while cooler than average
conditions were related to higher biomass of immature \fishname\ coast-wide
...
\citep{TurleyRykaczewski2019} found decreased survival of larval \fishname\
...
adhered to since ratification of the Agreement.  However, a bilateral
...
quotas were otherwise suggested using the default harvest control rule and
