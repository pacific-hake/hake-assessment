...
The historical
catch of \fishname\ for \Sexpr{start_yr}--\Sexpr{last.data.yr} by nation and
...
For the catcher-processor sector, the four most abundant age classes (by numbers) seen in \Sexpr{last.data.yr} were
...
For the mothership sector, the four most abundant age classes for \Sexpr{last.data.yr} were
