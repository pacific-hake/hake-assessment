...
**[Need fishery reports to finalize text]The at-sea fishery maintained moderately high catch rates throughout the
...
rates, whereas catch rates were higher in September and October this year relative to last year.  The median fishing depth for the at-sea fleets was slightly shallower than last year, which was shallower than
...
opportunities in Alaskan waters.  The shore-based fishery had the largest monthly
catches during July, August, and September.  Due to the continuation of moderately high catch-rates for all U.S. fleets, the U.S. utilization rate continued to
maintain close to what it has been in recent years at
\Sexpr{last.year.us.attained}\% in \Sexpr{last.data.yr}).
% Manual done 2020 KFJ.
