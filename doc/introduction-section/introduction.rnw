...
new approaches for weighting composition data and parameterizing
...
results and subsequent management forecasts
**refer to sensitivity section explicitly once it's updated with the sens run
