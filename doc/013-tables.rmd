...
```{r main-maturity-ogives-tab, results = "asis", echo = FALSE}
table_maturity_ogive(
  maturity_ogives_df,
  caption = paste0(
    "Information on maturity and fecundity used in this assessment as shown ",
    "in Figure~\\@ref(fig:main-maturity-ogive-fig). The sample sizes refer to the ",
    "subset of samples in Table~\\@ref(tab:main-ovaries-tab) for which age ",
...
table_median_posteriors(
  ...
  caption = paste0(
    ...
    "dashes (--) indicate quanties requiring ", end_yr, " catch which has ",
    "not taken place yet."),
  font_size = 8,
  header_font_size = 9,
  longtable = TRUE)
...
```{r main-decisions-biomass-tab, results = "asis", echo = FALSE}
table_decision(
  base_model,
  type = "biomass",
  forecast_inds =
...
```{r main-decisions-spr-tab, results = "asis", echo = FALSE}
table_decision(
  base_model,
  type = "spr",
  forecast_inds =
  ...
  caption = paste0(
    ...
    "alternatives presented in Table~\\@ref(tab:main-decisions-biomass-tab). ",
    "Values greater than 1 indicate relative fishing intensities greater ",
    "than the ", f_40_for_latex_table, " harvest policy calculated using baseline ",
    "selectivity."),
  bold_letters = TRUE,
  digits = 2,
  font_size = 10,
...
```{r main-risk-year-1-tab, results = "asis", echo = FALSE}
...
```{r main-risk-year-2-tab, results = "asis", echo = FALSE}
# Index in model$risks to use, e.g. 1 means forecast year 2 compared to
# forecast year 1
table_risk(
  base_model,
...
```{r main-risk-year-3-tab, results = "asis", echo = FALSE}
# Index in model$risks to use, e.g. 1 means forecast year 2 compared to
# forecast year 1
table_risk(
  base_model,
...
table_param_est(
  base_model$retros$retro_param_est,
  section_bold = TRUE,
  section_italics = TRUE,
  section_underline = TRUE,
  section_line_above = TRUE,
