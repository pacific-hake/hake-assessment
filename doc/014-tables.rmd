...
```{r main-catches-us, results = "asis", echo = FALSE}
table_catch(
  ct,
  inc_foreign_jv = TRUE,
  start_yr = start_yr,
...
```{r main-catches-can, results = "asis", echo = FALSE}
table_catch(
  ct,
  inc_foreign_jv = TRUE,
  start_yr = start_yr,
...
table_sampling_history(
  ...
  caption = paste0(
    ...
    "Shore-based and Canadian Shoreside fleets are reported as the number ",
...
table_maturity_ogive(
  ...
  caption = paste0(
    ...
    "subset of samples in Table~\\@ref(tab:main-ovaries-table) for which age ",
...
table_ovary_samples(
  ...
  caption = paste0(
    ...
    "and including 2017; (ref:cite-jtc2018))."),
  font_size = 9,
  header_font_size = 8,
  longtable = TRUE)
```
...
table_median_posteriors(
  ...
  caption = paste0(
    ...
    "represent fishing below $\\Fforty$. In the last row, dashes (--) ",
    "indicate quanties requiring ", end_yr, " catch which has not ",
    "taken place yet."),
  font_size = 8,
  header_font_size = 9,
  longtable = TRUE)
...
table_ci_posteriors(
  ...
  caption = paste0(
    ...
    "shown in Table \\@ref(tab:main-median-posterior-table). In the last ",
    "row, dashes (--) indicate quanties requiring ", end_yr, " catch which ",
...
```{r main-decisions-biomass-table, results = "asis", echo = FALSE}
table_decision(
  base_model,
  type = "biomass",
  forecast_inds =
...
```{r main-risk-year-1-table, results = "asis", echo = FALSE}
...
```{r main-risk-year-2-table, results = "asis", echo = FALSE}
# Index in model$risks to use, e.g. 1 means forecast year 2 compared to
# forecast year 1
table_risk(
  base_model,
...
```{r main-risk-year-3-table, results = "asis", echo = FALSE}
# Index in model$risks to use, e.g. 1 means forecast year 2 compared to
# forecast year 1
table_risk(
  base_model,
