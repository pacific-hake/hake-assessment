...
decrease the following year, except for 2017, 2019 (the example just given), and
2023;
...
The 2017, 2019, and 2023 assessments `incorrectly' projected that the stock would likely
...
(Figure~\@ref(fig:main-historical-1-fig)). For the 2017 [@JTC2017] and 2019
[@JTC2019] assessments the biomass trend was projected to be relatively flat the
...
(Figure~\@ref(fig:main-historical-1-fig)), and give low probabitlies of the
...
from the current base model similarly rose, but remained lower than the previous
assessments' calculations. The exception is for P(*B*~2023~ < `r b_40`) which is now
estimated to have been >30% (Figure~\@ref(fig:main-historical-2-fig)), somewhat
higher than originally estimated in the 2022 assessment [@JTC2022] and also in
the analogous figure in the 2023 assessment [@JTC2023].
