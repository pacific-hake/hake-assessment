...
(median recruitment well below the mean of all median
recruitments).
As noted above, the size of the 2020 cohort is estimated to be somewhat smaller than
...
Tables~\@ref(tab:main-median-posterior-tab) and
\@ref(tab:main-ci-posterior-tab)). It was close to `r f_40` in 1999 and 2006--2008,
...
`r median_intensity_2015`% in 2015, and then it leveled off around 78-90% from
...
though Canada's was higher in 2020.
