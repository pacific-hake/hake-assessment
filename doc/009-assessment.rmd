...
CEATTLE as a way forward and have explored this within Stock Synthesis.
Additionally, the JTC will investigate using the results from CEATTLE to inform
age-specific priors on $M$ for the 2026 SRG meeting.*
...
unchanged through 2023 but the female spawning biomass increased in the final
...
The final step in this year's bridging led to turning off the estimation of the
...
is `r f(as.numeric(sens_models[[2]][[4]]$extra_mcmc$q_extrasd_edna_med), 3)`).
The index is representative of all fish age-1 and older (i.e., fully selective
of fish age-1$+$), with a median catchability estimate of
`r f(as.numeric(exp(sens_models[[2]][[4]]$extra_mcmc$lnq_edna_med)), 3)`. Catchability
is not as intuitive as for the other indices as it scales copies of DNA per microliter
to biomass. The eDNA index
...
fit well in this sensitivity model (Figure~\@ref(fig:main-index-edna-fig)),
somewhat at the cost of reduced fits in the age
...
increase or decrease the following year, except for 2017, 2021, and 2023
...
The 2017, 2021, and 2023 assessments `incorrectly' projected that the stock would
...
The 2021 assessment [@JTC2021] had minimal information on the 2019 cohort and so
projections included a large range of values for 2019 recruitment. But this
recruitment now (with
more years of data) seems to be particularly small, such that the biomass most
likely declined between 2019 and 2020 (the opposite to what the 2021 assessment expected).
The
...
(or only slightly above) the previous
assessments' calculations, mostly similar to the analogous figure in the 2024
assessment [@JTC2024].
