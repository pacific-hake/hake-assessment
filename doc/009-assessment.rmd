...
> (dynamic $B_0$; see Figure~\@ref(fig:main-fished-unfished-rel-biomass-fig)).
...
negligible effect on assessment results (Figure~\@ref(fig:main-bridge-summary-2-fig)).
...
size or status (Figure~\@ref(fig:main-bridge-summary-2-fig)). However, there
...
(Figure~\@ref(fig:main-bridge-summary-1-fig)). The addition of the 2023 relative
