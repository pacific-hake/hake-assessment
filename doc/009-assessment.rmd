...
> *We also include Figure~\@ref(fig:main-recruitment-scale-all-fig) (as
...
2008 year class. The very strong 2010 year class comprised
`r top_coh(base_model, 2014, ret_cohort = 2010)`% of the coast-wide commercial
catch in 2014, `r top_coh(base_model, 2016, ret_cohort = 2010)`% of the 2016
catch, `r top_coh(base_model, 2018, ret_cohort = 2010)`% of the 2018 catch,
...
prior model estimated natural mortality at `r f(nat_m_hamel[2], 3)` with
a 95% credible interval of `r f(nat_m_hamel[1], 3)`--`r f(nat_m_hamel[3], 3)`
