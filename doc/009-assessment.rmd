...
with the number of degrees of freedom (2) equal to one less than the
number of available data points (3). An additional constant and additive
...
database for use in CEATTLE. Age-0 and age-1 fish were found in over 7,000
