...
assumptions about recent recruitments.  In particular, the `r last_data_year - 1` and `r last_data_year` year classes were set based solely on the stock--recruitment relationship for this assessment, such that
no recruitment deviations were estimated for these years.  While this is standard for the
most recent data year (`r last_data_year`), the quantity of available data determines whether it is the case
for the year previous (`r last_data_year - 1`). The only information on the size of the 2023 cohort
(age-1 fish in `r last_data_year`) in this assessment comes from the age composition of fishery catches.
The catch of age-1 fish was particularly high in `r last_data_year`, potentially due to the unique
...
By restricting `r last_data_year - 1` recruitment to the stock--recruitment relationship, the assessment model
was not allowed to predict a very high `r last_data_year - 1` year class based solely on the age-1
catch in the fishery. Another year of data, particularly form the age-2$+$ acoustic--trawl
survey in `r assess_yr` will provide additional information on the size of the `r last_data_year - 1` year class.
