...
> *Response -- The JTC has not officially investigated CPUE since prior to the
...
> known to be problematic, and current data confidentialy agreements do not
> allow the sharing of vessel-specific information amongst the JTC members
> making it difficult to do a comprehensive analysis. Maps of CPUE for the
...
> projection period are the stock--recruitment relationship, the
> stock--recruitment relationship with a multiplier, and the mean across a
...
sensitivity models also showed an increases in the overall scale of the
...
scales, halved estimated relative fishing intensity in `r end_yr - 1`, and more
...
provides a method to evalutate how the information about juvenile fish is
...
recruitment in 2022 is estimated to be slighlty above average when the model is
