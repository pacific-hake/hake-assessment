...
P(*B*~`r assess_yr`~ > 0.4`r b_msy`) = `r f(dfo_probs_curr[1, 2], 0)`%
and
P(*B*~`r assess_yr`~ > 0.8`r b_msy`) = `r f(dfo_probs_curr[1, 3], 0)`%
such that the stock is estimated to be in the provisional `healthy zone'.
For completeness, we note that
P(*B*~`r assess_yr`~ > `r b_msy`) = `r f(dfo_probs_curr[1, 1], 1)`%.
