...
biomass index (*q*~b~) and with the relative age-1 index (*q*~1~), for bridging
models that included it, were calculated
...
TODO add in age-1 index, and somewhere mention: Selectivity for the relative age-1 index was set to one
