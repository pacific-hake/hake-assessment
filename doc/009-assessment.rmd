...
- Incrementally add `r last_data_yr` catch, maturity-at-age/weight-at-age/fecundity-at-age, and fishery age-composition data (in that order); and
- Turn off estimation of the `r last_data_yr - 1` and `r last_data_yr` recruitment deviations (e.g., recruitment from the stock--recruitment relationship) due to limited data to inform the estimation of `r last_data_yr - 1` year class strength in the absence of survey data.
...
The addition of the `r last_data_yr` catch, modelled weight-at-age estimates, and fishery age compositions extends the model to the start of `r assess_yr`. Historical recruitment estimates and the stock
trajectory were relatively unchanged through 2023, but the female spawning biomass increased in the final year of the model due to well above average recruitment being estimated for 2023 (Figure~\@ref(fig:main-bridge-summary-2-fig)). With the lack of a survey in 2024, the 2023 recruitment deviation is being informed by age-1 observation in the fishery age-compositions.
...
The final step in the model bridging turned off estimation of the `r last_data_yr - 1` and `r last_data_yr` recruitment deviations (e.g., recruitment from the stock--recruitment relationship, Figure~\@ref(fig:main-bridge-summary-2-fig)). Given the unique seasonal
fishing conditions during the year, this data point was considered potentially suspect
as a standalone observation (i.e., without the addition of survey information). This change in the model decreased the female spawning biomass at the start of `r assess_yr` relative to the previous model bridging steps. The next assessment will include survey information via the relative age-1 index which will provide additional information about the strength of the 2023 year class.
