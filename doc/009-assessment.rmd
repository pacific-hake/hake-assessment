...
age-1 index, which starts in 1995, but start to diverge in 2017
...
standard deviation on the log-scale (median estimate
is `r f(as.numeric(sens_models[[2]][[4]]$extra_mcmc$q_extrasd_edna_med), 3)`)
was freely estimated to accommodate
unaccounted-for sources of process and observation error.
...
onward, similar in size and trajectory to when fishery age-composition data are
down weighted
