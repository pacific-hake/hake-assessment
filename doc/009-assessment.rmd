...
compositions providing additional information on the `r last_data_yr-1` and
`r last_data_yr`
year-class strengths. Given this survey information, the `r assess_yr+1` assessment will explore
estimating recruitment deviations for `r last_data_yr`.

TODO someone please confirm that last bit is okay.

The final bridging step was to exclude the age-1 index from the base model.

TODO, once we have results, adapt this from earlier text:

because it was found to be strongly influencing recruitment estimates even for
cohorts that had several years of data.

Also, the age-1 index does not have an externally calculated measure of uncertainty.
