...
> (Figures~\@ref(fig:main-empirical-weight-at-age-fig) and
...
(Figure~\@ref(fig:main-bridge-5-panel-1-fig).
...
(Figure~\@ref(fig:main-bridge-5-panel-1-fig)). Adding the weight-at-age data for
`r last_data_yr` makes little change, though slightly increases the estimated
female spawning biomass (Figure~\@ref(fig:main-bridge-5-panel-1-fig)).
...
recruitment estimates (Figure~\@ref(fig:main-bridge-5-panel-1-fig)).
...
uncertainty in recent recruitment (Figure~\@ref(fig:main-bridge-5-panel-1)-fig).
...
Figures~\@ref(fig:main-mcmc-diag-m-r0-fig)--\@ref(fig:main-mcmc-diag-dm-fig)).
...
expected via random chance (Figure~\@ref(fig:main-mcmc-diag-hists-fig)). The
...
(Figure~\@ref(fig:main-mcmc-pairs-fig)). Estimates of recruitment in 2014 and
...
these quantities (Figure~\@ref(fig:main-mcmc-pairs-fig)). An examination of
deviations in recruitment (log-scale differences between estimated and
expected recruitment values) from recent years
(Figure~\@ref(fig:main-mcmc-pairs-recruit-devs-fig)) indicates the highest
...
(Figure~\@ref(fig:main-mcmc-survey-fit-fig)) remains similar to the
...
and closely fit the 2021 index (Figure~\@ref(fig:main-mcmc-survey-fit-fig)).
...
(Figure~\@ref(fig:main-mcmc-age1-fit-fig)). In particular, the 2008 and 2014
...
Section~\@ref(sec:data-age-comp-likelihood-fig)).
...
(Figure~\@ref(fig:main-tv-selex-uncertainty-lines-fig)). The decline in survey
...
\@ref(fig:main-tv-selex-uncertainty-lines-fig)), but in spite of this uncertainty,
...
(Figures~\@ref(fig:main-female-spawning-biomass-fig) and
\@ref(fig:main-relative-spawning-biomass-fig) and
...
Figure~\@ref(fig:main-mcmc-sr-variability-fig). Extremely large variability
...
spawning biomass (Figure~\@ref(fig:main-mcmc-sr-variability-fig)). The
...
$\Fforty$ for all years (Figure~\@ref(fig:main-fishing-intensity-fig) and
Tables~\@ref(tab:main-median-posterior-tab) and
\@ref(tab:main-ci-posterior-tab)). It was close to $\Fforty$ in 2008 and 2010,
...
below $\Fforty$ from 2012 through 2016 and again from 2019 to 2022 (Figure~\@ref(fig:main-fishing-intensity-fig)). The median estimate for 2017
and 2018 is below $\Fforty$ though the 95% posterior credibility interval
does include $\Fforty$.
...
Figure~\@ref(fig:main-relative-spawning-biomass-fig)).
...
remained well below $\Fforty$, and total catch has been declining since the
...
Figure~\@ref(fig:main-recruit-base-alternative-2-fig) discussed later).
...
P$(\mathrm{B}_{`r assess_yr`} > 0.4\Bmsy) = `r f(dfo_probs_curr[1, 2] |> pull(), 0)`$%
and
P$(\mathrm{B}_{`r assess_yr`} > 0.8\Bmsy) = `r f(dfo_probs_curr[1, 3] |> pull(), 1)`$%
such that the stock is estimated to be in the provisional `healthy zone'.
For completeness, we note that
P$(\mathrm{B}_{`r assess_yr`} > \Bmsy) = `r f(dfo_probs_curr[1, 1] |> pull(), 1)`$%.
...
outcomes relative to $\Fforty$ (based on SPR; see table legend).
...
Figures~\@ref(fig:main-forecast-depletion-comparison-fig)--
\@ref(fig:main-forecast-risk-comparison-year-3-fig)). These metrics summarize
...
Figure~\@ref(fig:main-forecast-risk-comparison-year-1-fig)). However,
...
Figures~\@ref(fig:main-forecast-risk-comparison-year-2-fig)
and \@ref(fig:main-forecast-risk-comparison-year-3-fig).

Figure~\@ref(fig:main-forecast-depletion-comparison-fig) shows the projected
...
(Table~\@ref(tab:main-risk-year-1-tab) and Figure~\@ref(fig:main-forecast-risk-comparison-year-1-fig)), a
`r zero_catch_prob_bio_down_2`% probability of decreasing from
`r forecast_yrs[2]` to `r forecast_yrs[3]`
(Table~\@ref(tab:main-risk-year-2-tab) and Figure~\@ref(fig:main-forecast-risk-comparison-year-2-fig)), and a
...
and Figure~\@ref(fig:main-forecast-risk-comparison-year-3-fig)).
...
(Table~\@ref(tab:main-risk-year-1-tab) and
Figure~\@ref(fig:main-forecast-risk-comparison-year-1-fig)). It is 81% for the
...
\@ref(tab:main-risk-year-3-tab) and
Figures~\@ref(fig:main-forecast-risk-comparison-year-1-fig)--
\@ref(fig:main-forecast-risk-comparison-year-3-fig)). The similar maximum
...
Figure~\@ref(fig:main-maturity-fig)).
...
below $\Btwentyfive$; Table~\@ref(tab:main-risk-year-1-tab)).
...
biomass is above $\Bforty$. The overall scale of the population was impacted
...
estimated stock status relative to $B_0$ prior to 1990, the uncertainty in
...
equilibrium yield at $\BSPRforty$
...
(Figure~\@ref(fig:main-mcmc-sr-variability-fig)).
...
\@ref(fig:main-recruit-base-alternative-2-fig)).
...
recruitments (Figure~\@ref(fig:main-recruit-base-alternative-4-fig)). In
...
models (Figure~\@ref(fig:main-recruit-devs-base-alternative-4-fig)),
...
(Figure~\@ref(fig:main-female-spawning-biomass-fig)) so even slight changes in
...
i.e.,~P$(\mathrm{B}_{t+1} < \Bforty)$; Figure~\@ref(fig:main-historical-2-fig).
...
of the biomass falling below $\Bforty$ were $>10%$ and continued to rise (Figure~\@ref(fig:main-historical-2-fig)), until falling due to the
...
calculations for P$(\mathrm{B}_{t+1} < \Bforty)$ show little change as more
