...
The final step in the model bridging turned off estimation of the `r last_data_yr - 1` and `r last_data_yr` recruitment deviations (i.e., recruitment comes from the stock--recruitment relationship, Figure~\@ref(fig:main-bridge-summary-2-fig)). Given the unique seasonal
...
A biomass-based index of `r spp` relative abundance has been developed using
...
environmental DNA sampling, will be advantageous for understanding `r spp` population
dynamics and the biological communities that interact with `r spp`.
