...
the 2021 cohorts at age-3 estimated this year to be as large as the 2020
cohort was last year at age-3.

Uncertainties are shown for select cohorts in
Figure~\@ref(fig:main-retrospective-recruitment-fig). In previous years,
this figure showed only the median lines. The uncertainty is represented as
...
they are so large that they cover the whole plot and wash out the other
uncertainty bands.
