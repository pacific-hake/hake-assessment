...
recruitment somewhat. The addition of the `r last_data_yr` relative age-1 index
led to an estimated increase in stock biomass from 2023 to 2024 as a result of
small shifts in expected recruitment, particularly for the 2020 and 2022 year
classes.
...
$\log \theta_{\text{fish}}$ was `r f(log_theta_fishery_median, 3)`
...
i.e., \protect{$\log \theta_{\text{surv}}$}, was
...
was 0.84 (Figure~\@ref(fig:main-catchability-density-fig)).
...
relative age-1 index compared to the previous assessment;
...
age-1 index (q~1~) was 0.50 (Figure~\@ref(fig:main-catchability-density-fig)).
