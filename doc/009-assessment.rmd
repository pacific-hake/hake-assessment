...
(Figure~\@ref(fig:main-bridge-summary-fig).
...
(Figure~\@ref(fig:main-bridge-summary-fig)). Adding the weight-at-age data for
`r last_data_yr` makes little change, though slightly increases the estimated
female spawning biomass (Figure~\@ref(fig:main-bridge-summary-fig)).
...
recruitment estimates (Figure~\@ref(fig:main-bridge-summary-fig)).
...
uncertainty in recent recruitment (Figure~\@ref(fig:main-bridge-summary-fig).
