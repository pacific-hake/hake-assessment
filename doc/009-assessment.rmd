...
(Appendix~\@ref(sec:glossary)) have required specific changes to control
rules.
...
(Figure~\@ref(fig:app-mcmc-pairs-recruitment-devs-fig)) indicates the highest
...
excludes %the age-1 survey index (Appendix~\@ref(sec:age1-survey)). The
