...
And, because there was no survey in `r last_data_yr`, the main recruitment
deviation period remained at `r last_data_yr - 2` but the late recruitment
deviations were extended to `r last_data_yr`. Historical recruitment estimates
and the stock trajectory were relatively unchanged through 2023 but the female
spawning biomass increased in the final year of the model due to well
above-average recruitment being estimated for `r last_data_yr-1`
(Figure~\@ref(fig:main-bridge-summary-2-fig)). With the lack of a survey in
2024, the `r last_data_yr-1` recruitment deviation is being informed solely by
age-1 observations in the `r last_data_yr` fishery age-composition data.
...
The final step in the model bridging led to turning off the estimation of the
`r last_data_yr - 1` and `r last_data_yr` recruitment deviations (i.e.,
recruitment comes from the stock--recruitment relationship,
Figure~\@ref(fig:main-bridge-summary-2-fig)). Given the unique seasonal fishing
conditions during the year, these estimates of recruitment were considered
...
year-class strength. Additionally, the `r assess_yr+1` assessment will explore
estimating recruitment deviations for `r last_data_yr` and `r assess_yr`
because there will be both a relative age-1 index and fishery age-composition
data to inform those estimates.
