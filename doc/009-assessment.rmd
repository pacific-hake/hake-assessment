...
assessment it was
`r f(prev_assess_recruitment_med["1980"], 1)`~billion compared to
`r f(prev_assess_recruitment_med["2010"], 1)`~billion.
This looks to be caused by the penultimate bridging step of using the modelled
...
in 2010, whereas Figure~\@ref(fig:main-recruitment-fig) suggests that 1970,
1999 and 2014 could also possibly be larger than in 2010, giving an
over-optimistic impression of how often we can expect cohorts the size of
the 2010 cohort to occur. The 2020 cohort is still very uncertain but has a
...
Figure~\@ref(fig:main-recruitment-scale-all-fig) shows how it is the largest for
