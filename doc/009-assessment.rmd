...
and 2010 year classes, resulting in an increased biomass through 2018. The
...
uncertainty as the estimate from the `r end_yr - 1` assessment of `r prev_bio_median_last_assess`
...
seasonal fishing conditions during the year (see Section appendix) and the relative
...
catch in the fishery. Another year of data, particuarlly form the age-2$+$ acoustic--trawl
