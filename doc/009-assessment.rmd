...
> *Response -- A figure has been added to the assessment document that shows the
> unfished spawning stock biomass time series relative to the standard 'fished'
> spawning stock biomass time series (see Figure ADD FIGURE HERE).
> This can be used to visually compare equilibirum versus non-equilibrium
> assumptions. The JTC once again delivered a presentation on dynamic reference
