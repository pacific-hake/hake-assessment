...
*Response -- Pacific Hake have several natural predators, including themselves,
...
AFWwaea2_PScUeInVLp6dXD_hYL6&html=&pos=0&folt=kw-top) identified Pacific Hake as the largest
...
*Predation in Stock Synthesis does not allow for feedback between Pacific Hake and the predator, and thus,
...
$M$ at age due to cannibalism. These values can be input into Stock Synthesis as fixed $M$ at age. In
...
assessments, not smaller. For example, 2016--17 increase from each assessment is:*
  ...
  - *2024 base model: increase of 423,000 t; and 2022--2023 (presumably) increase from each assessment is:*
