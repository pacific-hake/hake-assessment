...
in the estimation of recruitment from 2023 onwards. Given the unique
...
estimated for `r end_yr - 1` -- forecast years because no information is available
...
*and 2022--2023 (presumably) increase from each assessment is:*
...
- Turn off estimation of the `r last_data_yr - 1` and `r last_data_yr` recruitment deviations (i.e., recruitment comes from the stock--recruitment relationship) due to limited data to inform the estimation of `r last_data_yr - 1` year class strength in the absence of survey data. Similarly, no recruitment deviations were estimated during the forecast period.
...
an underestimation of uncertainty during the forecast period. The continued inclusion of
...
[Figure~\@ref(fig:main-retrospective-recruitment-fig) and @JTC2024] for the
