...
\chapter{Report of the \Sexpr{assess_yr} \fishname\ fishery in the United States} % from the Advisory Panel}
...
{\bf Prepared by the United States Advisory Panel and submitted for the Canada/US
  ...
  January **, \Sexpr{assess_yr}. **make text same as for Canadian?}
