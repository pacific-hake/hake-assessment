...
reports
(Appendices~\@ref(sec:us-fishery-report)--\@ref(sec:canada-fishery-report)).
...
has been in recent years (see Appendix~\@ref(sec:us-fishery-report) for more
...
Table~\@ref(tab:main-us-shore-age-data-tab). Age-composition differences
...
longer than usual (see Appendix~\@ref(sec:us-fishery-report) for more
details).
...
Appendix~\@ref(sec:canada-fishery-report) for more details).
...
Table~\@ref(tab:main-can-shore-age-data-tab).
