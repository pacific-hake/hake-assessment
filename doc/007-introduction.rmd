...
as summarized in the National Oceanic and Atmospheric Admistration's (NOAA) 
...
Ecosystem, the abundance of `r sp` larvae in the California Cooperative Oceanic Fisheries Investigations (CalCOFI) survey area has been
above average for two consecutive years, with 2023 being the highest since 2011. At
the same time, `r sp` predation by Bluefin Tuna and Swordfish were also well above average in
