...
Motivated by such research, focussing on @VestfalsEtAl2023 in particular, we
include a new hake-specific ecosystem summary
in Appendix~\@ref(sec:app-ecosystem-report). We collate time series of relevant ecosystem
processes that are believed to somewhat influence hake recruitment. These include prey/competitors (Pacific Herring, \emph{Clupea pallasii}, off
Vancouver Island) and predators (age-1 hake), basin-scale oceanography, and
...
comprehensive or definitive, this is a start to including such hake-relevant
...
regions of the CCE indicate that the abundances of larval and juvenile hake in
