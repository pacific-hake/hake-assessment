...
Furthermore, the new year-specific maturity-at-age specifically includes a
temperature effect from a spatiotemporal model (Section~\@ref(sec:data-maturity) and
Appendix~\@ref(sec:app-maturity-analysis)).
