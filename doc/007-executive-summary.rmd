...
table_catch(
  ...
  end_yr = end_yr - 1,
  caption = paste0(
    "Recent commercial fishery catch (t). Tribal catches are included in ",
    "the sector totals. Research catch includes landed catch associated with ",
    "certain research-related activities. Catch associated with surveys and ",
    "discarded bycatch in fisheries not targeting hake is relatively small ",
    "and not included in the table or model."),
  font_size = 9,
  header_font_size = 8)
```
