...
table_decision(
  ...
  caption = paste0(
    ...
    "alternatives presented in Table~\\@ref(tab:main-decisions-biomass-table). ",
...
table_risk(
  ...
  caption = paste0(
    ...
    "Table~\\@ref(tab:main-decisions-biomass-table))."),
  font_size = 10,
  header_font_size = 10,
  longtable = TRUE)
```
...
table_risk(
  ...
  caption = paste0(
    ...
    "in Table~\\@ref(tab:main-risk-year-1-table) (catch options explained in ",
    "Table~\\@ref(tab:main-decisions-biomass-table))."),
  font_size = 10,
  header_font_size = 10,
  longtable = TRUE)
...
table_risk(
  ...
  caption = paste0(
    ...
    " catch levels shown in Tables~\\@ref(tab:main-risk-year-1-table) and~",
    "\\@ref(tab:main-risk-year-2-table) (catch options explained in Table~",
    "\\@ref(tab:main-decisions-biomass-table))."),
  font_size = 10,
  header_font_size = 10,
  longtable = TRUE)
```
