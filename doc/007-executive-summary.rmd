...
credibility interval from `r curr_bio_lower` to `r curr_bio_upper` million~t.
The current estimate of the `r end_yr - 1` female spawning biomass is
`r prev_bio_median` (`r prev_bio_lower`--`r prev_bio_upper`) million~t. This is
...
table_biomass(
  ...
  caption = paste0(
    ...
    "biomass (SSB; thousand~t) and spawning biomass relative to estimated ",
