...
%    now based on posterior distributions rather than maximum likelihood estimates.
  ...
  \item Coast-wide catch in \Sexpr{end_yr-1} was \Sexpr{last.year.landings}~t
    ...
    \Sexpr{f(mean(ct$tot_catch[(end_yr-start_yr-9):(end.yr-start_yr)]),0)}~t,
...
\Sexpr{last.yr.tac.fore.2.biomass}\% in \Sexpr{end.yr+1} (due to the
...
% from \Sexpr{end.yr+2} to \Sexpr{end.yr+3}
