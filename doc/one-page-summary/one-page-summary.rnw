...
\begin{itemize}
  \item The stock assessment model for \Sexpr{assess_yr} has the same population
    dynamics structure as the \Sexpr{last.assess_yr} model. For \Sexpr{assess_yr},
    ...
    The addition of the age-1 index is the main change in data streams from \Sexpr{last.assess_yr}.

%  \item The main change from \Sexpr{last.assess_yr} is the use of the age-1 index
