...
maturity ogive.
  ...
  \item The model was update to include new approaches for weighting composition data
    and for parameterizing time-varying selectivity.

  \item Coastwide catch in \Sexpr{end.yr-1} was \Sexpr{last.year.landings}~t -- the
    largest on record --
