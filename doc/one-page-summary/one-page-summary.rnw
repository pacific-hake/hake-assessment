...
%    at the start of \Sexpr{end_yr} is \Sexpr{joint.percent.prob.above.below}\%.
  ...
  \item Projections were conducted across a wide-range of catch levels due to
   ...
   of the spawning biomass falling below $\Bforty$ in \Sexpr{end_yr+2}. There is an
   estimated \Sexpr{last.yr.tac.risk.1.biomass.decline}\% chance of the spawning biomass declining from \Sexpr{end_yr} to
