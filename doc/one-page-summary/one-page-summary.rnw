...
\begin{itemize}
  \item The stock assessment model for \Sexpr{assess.yr} is similar in structure to the \Sexpr{last.assess.yr} model with the addition
    of fishery age compositions from \Sexpr{end.yr-1}, reanalyzed acoustic survey biomass and age compositions from 1995--2015, and minor refinements to data including catch
  ...
  \item The stock is estimated to be at its highest biomass level as a result of estimated large 2010 and 2014 cohorts.
    The 2014 cohort has only been observed twice by the commercial fishery, thus its size is highly uncertain.
  ...
  \item The spawning biomass in \Sexpr{end.yr} is estimated to have increased from \Sexpr{end.yr-1}
    due to the 2014 year-class likely being well above average size. % and the estimate of the 2012 year-class being slightly above average.
  ...
  \item Projections setting the \Sexpr{forecast.yrs[1]} and \Sexpr{forecast.yrs[2]} catch equal to the \Sexpr{forecast.yrs[1]-1} TAC of
    \Sexpr{last.year.tac}~t show the estimated median relative spawning biomass increasing from \Sexpr{f(100*median(base.model$mcmc$Bratio_2016))}\%
