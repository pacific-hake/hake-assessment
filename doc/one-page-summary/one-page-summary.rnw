...
\begin{itemize}
  ...
  \item The stock is estimated to be near its highest biomass level since the early 1990s as a result of an above average 2008 cohort
    and a very large 2010 cohort. Recruitment in 2011 is estimated to have been below average. Cohorts from the years 
    \Sexpr{end.yr-3}--\Sexpr{end.yr-1} have not been observed long enough in the data to estimate their size or even if they are likely to be above or below average.
