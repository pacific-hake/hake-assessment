...
\section{Corrected Table 23}

Table 23 in the \fishname\ assessment document has two incorrect columns, \textbf{Total Biomass} and \textbf{Age 2+ Biomass}. They values reported were MLEs and should have been MCMC medians. The following table is correct.
