...
create_data_hake("refpt_bo_linecolor", "blue")
create_data_hake("refpt_usr_linecolor", "green")
create_data_hake("refpt_lrp_linecolor", "red")
create_data_hake("refpt_bo_linewidth", 0.75)
create_data_hake("refpt_usr_linewidth", 0.5)
create_data_hake("refpt_lrp_linewidth", 0.5)
create_data_hake("refpt_bo_linetype", "dashed")
create_data_hake("refpt_usr_linetype", "dashed")
create_data_hake("refpt_lrp_linetype", "dashed")
