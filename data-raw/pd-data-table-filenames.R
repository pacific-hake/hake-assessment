...
create_data_hake("can_raw_ft_age_props_fn", "can-raw-ft-age-proportions.csv")
create_data_hake("can_raw_ss_age_props_fn", "can-raw-ss-age-proportions.csv")
create_data_hake("can_raw_jv_age_props_fn", "can-raw-jv-age-proportions.csv")
