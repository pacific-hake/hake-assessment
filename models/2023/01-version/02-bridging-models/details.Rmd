...
df <- tribble(
  ...
  "01-updated-ss-exe",        "Chris",            "SS3 version 3.30.20 built with ADMB version 12.3",
  "02-add-new-catch",         "Chris",            "Update catch and age-composition data",
  "03-add-new-weight-at-age", "Chris",            "Add weight-at-age data for 2021 as well as update data for years prior",
  "04-add-survey-age-2-plus", "Chris",            "Add the acoustic survey age 2+ biomass and age-composition estimates",
  "05-add-survey-age-1",      "Chris",            "Add the acoustic survey age 1 biomass and age-composition estimates",
  "06-add-fishery-ages",      "Chris",            paste0("Add fishery age comps for ", yr))
