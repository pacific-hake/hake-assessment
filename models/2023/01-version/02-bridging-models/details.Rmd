...
df <- tribble(
  ...
  "01-new-ss-exe",      "Chris",            fmod("01-new-ss-exe"),    "Version 3.30.18-safe, commit a0f982, ADMB 12.3, commit 1376cb",
  "02-new-catch-age",   "Chris",            fmod("02-new-catch-age"), "Update catch and age-composition data",
  "03-update-survey",   "Chris",            fmod("03-update-survey"), "Update acoustic survey biomass and age-composition data from years prior to 2021",
  "04-new-wt-at-age",   "Chris",            fmod("04-new-wt-at-age"), "Add the 2021 acoustic survey biomass and age-composition estimates",
  "05-age-1-index",     "Chris",            fmod("05-age-1-index"),   "Add weight-at-age data for 2021 as well as update data for years prior")
