...
```{r paste("dirs-", yr, "-version-", version, "-request-models"), echo = FALSE}
fmod <- function(fn){
...
df <- tribble(
  ...
  "01-request-01-remove-age-1-index", "Chris",            fmod("01-request-01-remove-age-1-index"), "Remove the age-1 index from the base model")
