...
# then changing the permissions on the next line will cause git to report
# every file and directory in the repo as modified and they will have to be
# added again - we do not want that!
