...
# Andy just change this line for your machine
models_dir <- "/srv/hake/models/2023/01-version"
...
% plot_biomass(request_models,
%              request_models_names,
%              x_expansion = 4,
%              ylim = c(0, 5),
%              y_breaks = seq(0, 20, 2),
%              leg_font_size = 5,
...
% table_param_est(request_models,
%                 request_models_names,
%                 end_yr = end_yr,
%                 digits = 3,
%                 xcaption = NULL,
