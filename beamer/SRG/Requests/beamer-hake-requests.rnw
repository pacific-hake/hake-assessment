...
\frametitle{Request 1}
 Retrospective squid plots for the base model
\begin{center}
\vspace{-5pt}
...
\begin{frame}
\frametitle{Request 1}
 Retrospective squid plots for the sensitivity to inclusion of the age-1 index
\begin{center}
\vspace{-5pt}
...
\begin{frame}
\frametitle{Recruitment deviation uncertainty for cohorts}
<<cohort.uncertainty>>=
