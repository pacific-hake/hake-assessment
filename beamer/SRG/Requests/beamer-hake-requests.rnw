...
Request 6 -- Redo recruitment retrospective analysis including Age-1 index, focusing on the 2014 and other strong year-classes.
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Request 4 -- Calculate average of recruitment deviations over the main period
...
\begin{frame}
\frametitle{Request 7}
Request 7 -- Produce a time plot of effective $N$ and input $N$ to look for temporal patterns. Are recent samples upweighted relative to historical samples?
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
\frametitle{Request 5}
Request 5 -- Redo ADNUTs plots thinning down to about 2,000 samples from samples available, and redo convergence diagnostic plots.
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
oldpar <- par()
par(mar=c(4.1, 4.1, 3.1, 0.1))
plot_mcmc_param_stats(sens.models.6)
par <- oldpar
@
\end{center}
\end{frame}
...
oldpar <- par()
par(mar=c(4.1, 4.1, 3.1, 0.1))
plot_mcmc_param_stats(adnuts.model.2000)
par <- oldpar
@
\end{center}
\end{frame}
...
oldpar <- par()
par(mar=c(4.1, 4.1, 3.1, 0.1))
plot_mcmc_param_stats(adnuts.model.1000)
par <- oldpar
@
\end{center}
\end{frame}
...
\subsection{}
\begin{frame}
Request 3 -- Investigate changes in weights-at-age for 1987, when 1977 was expected to change but did not occur (compare 2019 to 2020).
~\\
~\\
