...
make.comparison.plot(
  ...
  subplots = 2,
  model.names = c(paste0("Base model ", end.yr), sens.model.names.7),
  legendloc = "topleft",
  end.yr = end.yr)
par <- oldpar
@
...
\frame{\frametitle{Request 2}
  MCMC diagnostics on a longer chain for the base model.\\
  %\medskip
  % {\bf Rationale:} .
...
\frame{\frametitle{Request 4 - slide 1}
  MCMC chain = 24,000,000 with 2000 samples..\\
  \begin{figure}[p]
    \vspace{-5mm}
    \begin{center}
      \includegraphics[max size={\paperwidth}{\paperheight}]{Mexplore.eps} % width=\maxwidth,
    \end{center}
  \end{figure}
}
...
\frame{\frametitle{Request 4 - slide 2}
  ...
  \begin{figure}[p]
    \vspace{-5mm}
    \begin{center}
      \includegraphics[max size={\paperwidth}{\paperheight}]{Hexplore.eps} % width=\maxwidth,
    \end{center}
  \end{figure}
}
\frame{\frametitle{Request 4 - slide 3}
  ...
  \begin{figure}[p]
    \vspace{-5mm}
    \begin{center}
      \includegraphics[max size={\paperwidth}{\paperheight}]{mcmcNuisance.eps} % width=\maxwidth,
    \end{center}
  \end{figure}
}
\frame{\frametitle{Request 4 - slide 4}
  ...
  \begin{figure}[p]
    \vspace{-5mm}
    \begin{center}
      \includegraphics[max size={\paperwidth}{\paperheight}]{pairs1.eps} % width=\maxwidth,
    \end{center}
  \end{figure}
}
\frame{\frametitle{Request 4 - slide 5}
  ...
  \begin{figure}[p]
    \vspace{-5mm}
    \begin{center}
      \includegraphics[max size={\paperwidth}{\paperheight}]{pairs2.eps} % width=\maxwidth,
    \end{center}
  \end{figure}
}
