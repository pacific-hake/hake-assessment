...
\begin{frame}
\frametitle{Request 5 -- \Sexpr{sens_req1_names[3]}}
\centering
<<select-age7, fig.height=4, fig.width=8, out.width='0.95\\columnwidth'>>=
plot_multiple_tv_selex_unc(sens_req1[[3]],
                           label_font_size = lfs,
                           point_size = ps,
                           point_fatten = pf,
                           label_loc = ll,
...
\begin{frame}
\frametitle{Request 5 -- \Sexpr{sens_req1_names[4]}}
\centering
<<select-age8, fig.height=4, fig.width=8, out.width='0.95\\columnwidth'>>=
plot_multiple_tv_selex_unc(sens_req1[[4]],
                           label_font_size = lfs,
                           point_size = ps,
                           point_fatten = pf,
                           label_loc = ll,
