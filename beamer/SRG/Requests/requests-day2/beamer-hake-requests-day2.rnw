...
\bi
    ...
    \item Have fixed a tolerance limit.
\ei
\end{frame}
...
\begin{frame}
\frametitle{Request 5 -- \Sexpr{sens_models_desc[[4]][1]}}
\centering
<<select-age5, fig.height=4, fig.width=8, out.width='0.95\\columnwidth'>>=
plot_multiple_tv_selex_unc(sens_models[[4]][[2]],
                           n_col = 2)
@
\end{frame}
...
\begin{frame}
\frametitle{Request 5 -- \Sexpr{sens_models_desc[[4]][2]}}
\centering
<<select-age7, fig.height=4, fig.width=8, out.width='0.95\\columnwidth'>>=
plot_multiple_tv_selex_unc(sens_models[[4]][[3]],
                           n_col = 2)
@
\end{frame}

\begin{frame}
\frametitle{Request 5 -- \Sexpr{sens_models_desc[[4]][3]}}
\centering
<<select-age8, fig.height=4, fig.width=8, out.width='0.95\\columnwidth'>>=
plot_multiple_tv_selex_unc(sens_models[[4]][[4]],
                           n_col = 2)
@
\end{frame}
