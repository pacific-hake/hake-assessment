...
\bi
  ...
  \bi
    ...
    \bn
      \item Additon of the 1995 survey biomass estimate (point estimate and CV) 
  ...
  \ei \pause
  \item {\em Continue the evalution of identified key sensitivity runs; further explore sigma-R}
  \bi
    \item {\bf Response:} Done and will be presented
  \ei 
\ei
...
\bi
  ...
  \bi
    \item {\bf Response:} The JTC supports the collection/processing of genetic material and other research to evaluate stock strucutre.
  \ei \pause
  \item {\em Continued collection of ovaries}
  \bi
    \item {\bf Response:} Many ovaries collected in \Sexpr{last.assess.yr}, including during all four seasons and doubled collections from Canadian shoreside fishery. No new analysis in time for this assessment, but thourough analysis anticipated for 2018.
  \ei
\ei
}
...
\frametitle{Overview of model structure}
  \bi
    ...
    \bi
      ...
      \item Additon of 1995 survey biomass estimate and age compositions
...
\frame{\frametitle{Bridging to the base model: Summary}
  \bi
    ...
    \item Additon of 1995 and updates to 1998 and 2015 survey biomass estimates had minor influence on results
...
%----------------------------------------------------------
 ...
 \begin{columns}
  \begin{column}{0.48\textwidth}
    \vspace{-10pt}
    \bc
    <<main.tv.selex, fig.height=12, fig.width=10,out.width='1.0\\columnwidth'>>=
  ...
  \begin{column}{0.48\textwidth}
    \vspace{-10pt}
    \bc
    <<main.tv.selex.uncertainty, fig.height=12, fig.width=10, out.width='1.0\\columnwidth'>>=
...
\begin{columns}
  ...
  \vspace{-10pt}
  \bc
  <<main.numbers.at.age, fig.height=12, fig.width=10,out.width='1.0\\columnwidth'>>=
...
\frame{\frametitle{Fishing Intensity and Exploitation Rate}
  \vspace{-5pt}
  \bc
  <<fishing.intensity, fig.height=4, fig.width=8, out.width='0.65\\columnwidth'>>=
    make.fishing.intensity.plot(base.model,
                                start.yr = start.yr,
                                end.yr = end.yr-1,
                                color = "blue")
  @
  <<exploitation, fig.height=4, fig.width=8, out.width='0.65\\columnwidth'>>=
...
\frame{\frametitle{Summary}
  ...
  \item The spawning biomass in \Sexpr{end.yr} is estimated to have increased from \Sexpr{end.yr-1} due to the estimate of the 2014 year-class being well above average size.  The 2010 year-class remains prevelant, making up the 2nd largest proportion-by-age (numbers of fish) in the stock. % Manual to do.
  \ei
}
