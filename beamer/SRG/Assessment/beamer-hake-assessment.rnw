...
\bi
  \item Review of 2014 SRG assessment recommendations
  \item Model structure and changes from 2015
  \item Fits to data
  \item Estimates and predictions
\ei
}

%----------------------------------------------------------
\frame{\frametitle{2014 SRG assessment recommendations}
\bi
  \item Base model fit to survey series starting in 1995 without extrapolation
  \item Include a sensitivity with age-1 acoustci survey index
  \item Include key sensitivities
  \item Ongiong monitoring and research on stock structure
  \item Continued collection of ovaries
\ei
}
...
\frame{\frametitle{Bridging to the base model: Summary}
  \bi
    ...
    \item The 2015 fishery age compositions agreed with survey data, but decreased 2012 and 2013 year classes, and greatly increased the 2014 year class
    \item Re-tuning the model counteracted the effects of adding the 2015 fishery data
    \bi
      \item 2012 and 2013 year classes were similar to before
