...
%----------------------------------------------------------
     \frame{\frametitle{Fit to acoustic survey age comps}
       ...
       \item Predicted higher: 1999 cohort often,  2010 cohort in 2017 survey
...
%----------------------------------------------------------
     \frame{\frametitle{\Sexpr{last_assess_yr} SRG assessment recommendations\\
       ...
       \item Threshold probabilities of stock change: this endeavor is well suited for future
             MSE-related performance metric discussions.
       \pause
       ...
       \pause
       \item Input sample sizes: nothing explicit undertaken to date, but working with AFSC researchers working on
...
%----------------------------------------------------------
     \frame{\frametitle{Summary -- Key Points}
       ...
       \item Anomolies to consider include low catches in Canada, differences in U.S. fleet catch-at-age, and
