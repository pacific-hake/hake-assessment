...
%----------------------------------------------------------
\frame{\frametitle{Last assessment: Fishery empirical weight-at-age (Fig. 13 in 2020 doc)}
  \bc
...
%
%----------------------------------------------------------
\frame{\frametitle{Bridging: rwMH to NUTS (Fig. H1 and H2)}
  \bc
...
%----------------------------------------------------------
\frame{\frametitle{Bridging: NUTS $R_0$ (Fig. A1)}
  \bc
...
%----------------------------------------------------------
\frame{\frametitle{Bridging: rwMH $R_0$ (Fig. H6)}
  \bc
