...
%----------------------------------------------------------
     \frame{\frametitle{Key quantities}
       ...
       <<main.parameter.estimates, results='asis', echo=FALSE>>=
         param_est_table(list(base_model, last_yr_base_model),
...
%----------------------------------------------------------
     \frame{\frametitle{Spawning Biomass (million~t)}
       <<biomass.calcs>>=
         ...
         year's assessment, partly due to increases in weight-at-age, the credible interval
         mostly overlaps that from last year's assessment.
     }
%----------------------------------------------------------
     ...
     \frame{\frametitle{\Sexpr{last_assess_yr} SRG assessment recommendations\\
       ...
       \item Medium-term: continuing research to treat recruitment deviations as a random effect and estimate $\sigma_R$
         \bi
          ...
          \item Hake MSE estimation model, also coded in TMB, is another tool being explored
          \ei
         \ei
       \pause
...
%----------------------------------------------------------
     \frame{\frametitle{\Sexpr{last_assess_yr} SRG assessment recommendations\\
       ...
       \item JTC is also submitting proposals to work on further evaluate recruitment potential from other
...
%----------------------------------------------------------
     \frame{\frametitle{\Sexpr{last_assess_yr} SRG assessment recommendations\\
       ...
       \item JTC continues to engage the science and management community on this topic:
          ...
          \item Conducted a learning session at last summer JMC meeting.
          \item Reached out to regional RFMO that operationalizes dynamic reference points.
...
%----------------------------------------------------------
     \frame{\frametitle{\Sexpr{last_assess_yr} SRG assessment recommendations\\
       ...
       \item Follow (and engage with as needed) ongoing research looking at spatiotemporal
             trends in \fishname\ reproduction (more later this week at research presentation).
       \pause
...
%----------------------------------------------------------
     \frame{\frametitle{\Sexpr{last_assess_yr} SRG assessment recommendations\\
       ...
       \item Resources were made available for the JTC to use a new high-performance computing network
             ...
             retrospectives, and forecasts). This will also be available for MSE model runs.
       \pause
...
%----------------------------------------------------------
%
%Below is a bunch of old slides that could be deleted, but saving for now
%----------------------------------------------------------
  % \begin{frame}
...
%<<get.prior.values>>=
  %  priors_mle <- get_prior_data(base_model, tail(key_posteriors, 2))
  %@
    %\bi
