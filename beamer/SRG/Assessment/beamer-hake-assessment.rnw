...
%----------------------------------------------------------
     \frame{\frametitle{Acoustic survey 2023 catchability (\emph{$q_b$}) posterior}
       \bc
...
%----------------------------------------------------------
   \frame{\frametitle{Age-1 index 2023 catchability (\emph{$q_1$}) posterior}
     \bc
     <<histQ.age1,fig.height=2.25, fig.width=5.5>>=
       make.mcmc.catchability.plot(base_model, type = "age1")
     @
       \begin{table}
     \begin{tabular}{cccc} \hline
     \textcolor{blue}{Median (\Sexpr{assess_yr})} &
