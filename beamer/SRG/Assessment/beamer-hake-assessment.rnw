...
\frame{\frametitle{Bridging to the base model: Summary}
  \bi
    ...
    \bi
      \item Though difference was negligible compared to addition of 2016 fishery composition data
...
\begin{columns}
  ...
  \vspace{-10pt}
  \bc
  <<main.numbers.at.age, fig.height=8, fig.width=8,out.width='1.0\\columnwidth'>>=
