...
\bi
\item 2010 cohort is estimated to make up \Sexpr{f(b_curr_prop_2010 * 100)}\%
  of the biomass
\item 2014 cohort is estimated to make up \Sexpr{f(b_curr_prop_2014 * 100)}\%
  of the biomass
\item 2016 cohort is estimated to make up \Sexpr{f(b_curr_prop_2016 * 100)}\%
  of the biomass
\ei
}
...
\subsection{Key Cohorts}
\frame{\frametitle{Summary -- Key Cohorts}
  \bi
  \item The 2010 cohort is estimated to be \Sexpr{f((recruitment.med.to.compare - prev.assess.recruitment.med)["2010"], 1)}~billion fish,
    a \Sexpr{f(((((recruitment.med.to.compare - prev.assess.recruitment.med)["2010"]) / (prev.assess.recruitment.med)["2010"]) * 100), 0)}\% increase
    over last year's estimate.
  \item The 2014 cohort is estimated to be \Sexpr{f((recruitment.med.to.compare - prev.assess.recruitment.med)["2014"], 1)}~billion fish,
    a \Sexpr{f(((((recruitment.med.to.compare - prev.assess.recruitment.med)["2014"]) / (prev.assess.recruitment.med)["2014"]) * 100), 0)}\% increase
    over last year's estimate.
  \item The 2016 cohort is estimated to be \Sexpr{f((recruitment.med.to.compare - prev.assess.recruitment.med)["2016"], 1)}~billion fish,
    a \Sexpr{f(((((recruitment.med.to.compare - prev.assess.recruitment.med)["2016"]) / (prev.assess.recruitment.med)["2016"]) * 100), 0)}\% increase
    over last year's estimate.
  ...
  \item 2010 cohort is estimated to make up \Sexpr{f(b_curr_prop_2010 * 100)}\% of the biomass
  \item 2014 cohort is estimated to make up \Sexpr{f(b_curr_prop_2014 * 100)}\% of the biomass
  \item 2016 cohort is estimated to make up \Sexpr{f(b_curr_prop_2016 * 100)}\% of the biomass
