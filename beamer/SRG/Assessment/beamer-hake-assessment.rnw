...
\frame{\frametitle{Bridging: Summary}
  \bi
    ...
    \item Adding priors to the Dirichlet-Multinomial parameters reduced correlation between $M$ and $log(R_0)$.
   \ei
}
...
\bi
  ...
  \item In the \Sexpr{last.assess.yr} assessment, these parameters were stuck between 0.99--1.00 (at the upper bound).
 ...
 \bc
  ...
  \begin{table}
    \begin{tabular}{cccc} \hline
      ...
      \textcolor{green}{Median (\Sexpr{assess.yr - 1})} &
      \textcolor{blue}{MLE (\Sexpr{assess.yr})} &
      \textcolor{green}{MLE (\Sexpr{assess.yr - 1})} \\
      \hline
      \textcolor{blue}{\Sexpr{f(median(base.model$extra.mcmc$Q_vector), 2)}} &
      \textcolor{green}{\Sexpr{f(median(last.yr.base.model$extra.mcmc$Q_vector), 2)}} &
      \textcolor{blue}{\Sexpr{f(base.model$cpue$Calc_Q[1],2)}}  &
      \textcolor{green}{\Sexpr{f(last.yr.base.model$cpue$Calc_Q[1],2)}} \\
      \hline
    \end{tabular}
  \end{table}
 \ec
