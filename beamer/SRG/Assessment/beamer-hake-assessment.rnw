...
\bi
  \item 2010 cohort is estimated to make up \Sexpr{f(baa_2010, 1)}\% of the biomass
  \item 2014 cohort is estimated to make up \Sexpr{f(baa_2014, 1)}\% of the biomass
  \item 2016 cohort is estimated to make up \Sexpr{f(baa_2016, 1)}\% of the biomass
\ei
}
...
\begin{columns}
  \begin{column}{0.5\textwidth}
    <<baa.table, results='asis', echo=FALSE>>=
      baa_table(baa, font.size = 9, space.size = 9)
    @
  \end{column}
  \begin{column}{0.5\textwidth}
  \bc
