...
\begin{center}
\vspace{-5pt}
<<sigma.r.sensitivity.biomass, fig.height=4.5, fig.width=8, out.width='0.9\\columnwidth'>>=
oldpar <- par()
...
\begin{center}
\vspace{-5pt}
<<max.age.sensitivity.biomass, fig.height=4.5, fig.width=8, out.width='0.9\\columnwidth'>>=
oldpar <- par()
par(mar = c(7.1, 4.1, 0, 0))
...
%%%%%%%%%%%%%%%%%%%%%%%
\section{Other Sensitivities}
\subsection{}
\begin{frame}
\frametitle{Sensitivity Table - MLE}
\begin{center}
<<other.sensitivities.table, results='asis', echo=FALSE>>=
make.short.parameter.estimates.sens.table(
...
%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Other Sensitivities - Biomass}
\begin{center}
\vspace{-5pt}
<<other.sensitivities.biomass, fig.height=4.5, fig.width=8, out.width='0.9\\columnwidth'>>=
...
%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Other Sensitivities - Status}
\begin{center}
\vspace{-5pt}
<<other.sensitivities.recr, fig.height=4.5, fig.width=8, out.width='0.9\\columnwidth'>>=
oldpar <- par()
par(mar = c(4.5, 4.1, 1.5, 1.1))
make.comparison.plot(
  c(list(base.model), sens.models.4),
