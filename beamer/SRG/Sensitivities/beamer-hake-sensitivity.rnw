...
\subsection{}
\begin{frame}
\frametitle{Probabilities change with inclusion age-1 index}
\begin{table}[tbp]
\centering
\begin{tabular}{lrr}
\hline
...
P$(B_{\Sexpr{assess.yr+1}} < \Bforty)$ &
  \Sexpr{f( base.model$risks[[1]][4,"Bratio_2021<0.40"])}\% &
  \Sexpr{f( sens.models.2[[1]]$risks[[1]][4,"Bratio_2021<0.40"])}\% \\
P$(B_{\Sexpr{assess.yr+2}} < \Bforty)$ &
  \Sexpr{f( base.model$risks[[2]][4,"Bratio_2022<0.40"])}\% &
  \Sexpr{f( sens.models.2[[1]]$risks[[2]][4,"Bratio_2022<0.40"])}\% \\
\hline
\end{tabular}
\end{table}
\end{frame}
...
\item NUTS looks worth using next year
