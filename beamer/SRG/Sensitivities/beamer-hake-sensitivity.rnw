...
% Maybe take some of what's deleted in f61f7488b1  for context
%%%%%%%%%%%%%%%%%%%%%%%
%\section{$\phi$}
%\subsection{}
\begin{frame}
...
\begin{itemize}
  ...
  \item In 2018 assessment we updated maturity ogive
\end{itemize}
\begin{equation}
...
b) For equilibrium and 1966-1974  there is no empirical weight-at-age data;
...
\bi
\item Not done (using equivalent 2016-2018). Used mean 1975-2018, as for 2018 base model.
\ei
...
weight.at.age.heatmap(sens.models.5[[2]], font.size=1.6)
@
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%
...
weight.at.age.heatmap(sens.models.6[[1]], proj.line.yr=2017, font.size=1.6)
@
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%
...
weight.at.age.heatmap(sens.models.5[[3]], proj.line.yr=2017, font.size=1.6)
@
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%
...
weight.at.age.heatmap(sens.models.6[[2]], proj.line.yr=2017, font.size=1.6)
@
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Retrospectives -- Recruitment}
\begin{center}
\vspace{-5pt}
...
%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Retrospectives -- baby squid}
\begin{center}
\vspace{-5pt}
% , fig.height=4.5, fig.width=8, out.width='0.9\\columnwidth'>>=
...
%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Retrospectives -- squid}
\begin{center}
\vspace{-5pt}
