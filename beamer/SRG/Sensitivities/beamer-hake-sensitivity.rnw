...
\vspace{5pt}
% fig.width=8>>=
<<phi.sensitivity.density.2016, fig.height=3.5>>=
oldpar <- par()
par(mar = c(7.1, 4.1, 0, 1))
make.comparison.plot(c(list(base.model),
                       sens.models.4[1],
...
\vspace{5pt}
% fig.width=8>>=
<<phi.sensitivity.density.2017, fig.height=3.5>>=
oldpar <- par()
...
make.comparison.plot(c(list(base.model),
                     ...
                     model.names = c(paste0("Base model ", end.yr),
                                     ...
                                     sens.model.names.4[3]),
                     legendloc = "topright",
                     densitynames = "Recr_2017",
                     densityxlab  = "Recruitment in 2017 (billions)",
                     indexPlotEach = TRUE,
                     end.yr = end.yr)
par <- oldpar
@
...
\item Retrospectives -- 2010 cohort largest
\item Retrospectives -- 2014 cohort second largest
\item Retrospectives -- 2016 cohort third largest
  certain yet
\ei
\end{frame}
% -----------------------------------------------------------------------------%
