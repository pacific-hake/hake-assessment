...
%%%%%%%%%%%%%%%%%%%%%%%
\section{$h$, $\sigma_r$, and $M$}
\subsection{}
\begin{frame}
\frametitle{Steepness, $\sigma_r$, and $M$ -- Biomass}
\begin{center}
\vspace{5pt}
%, fig.width=8>>=
<<sens.1.biomass.fig, fig.height=4.5>>= 
...
%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Sensitivities to Steepness and $\sigma_r$}
\begin{center}
<<sens.1.par.table, results='asis', echo=FALSE>>=
...
%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Sensitivities to $M$}
\begin{center}
<<sens.1.M.par.table, results='asis', echo=FALSE>>=
make.short.parameter.estimates.sens.table(
  c(list(base.model),
    sens.models.1[5],
    sens.models.1[6]),
