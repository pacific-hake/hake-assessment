...
\begin{itemize}
  ...
  \item Retrospectives
        ...
        \item Cohort determination ('squid plots'): -16 years
...
%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Sensitivity Table}
\begin{center}
\includegraphics[width=5.5in, height=3.5in]{../../../doc/main-figures/SensTable1}
%\includegraphics[scale=1]{Figures/pastManagement.eps} % width=\maxwidth,
@
\end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%
...
%  \begin{center}
%    \includegraphics[width=3in, height=3in]{../../../doc/main-figures/can-bottom-depths}
%  \end{center}
%}
