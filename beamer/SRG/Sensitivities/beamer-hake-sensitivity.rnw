...
\vspace{5pt}
%, fig.width=8>>=
<<sigmar.biomass.fig, fig.height=4.5>>= 
#oldpar <- par(mar=c(5,4,1,1),no.readonly = TRUE)
#par(mar = c(4.5, 4.1, 1.5, 1.1))
oldpar <- par()
par(mar = c(7.1, 4.1, 0, 0))
...
\begin{center}
<<harmonicmean.sensitivity.biomass, fig.height=4.5, out.width='4.5in'>>=  
oldpar <- par()
par(mar = c(7.1, 4.1, 0, 0))
make.comparison.plot(
  c(list(base.model),
...
\begin{center}
<<usagecompsweight.sensitivity.biomass, fig.height=4.5, out.width='4.5in'>>=  
oldpar <- par()
par(mar = c(7.1, 4.1, 0, 0))
make.comparison.plot(
  c(list(base.model),
...
\begin{center}
<<altcatchstream.sensitivity.biomass, fig.height=4.5, out.width='4.5in'>>=  
oldpar <- par()
par(mar = c(7.1, 4.1, 0, 0))
make.comparison.plot(
  c(list(base.model),
...
\vspace{5pt}
% fig.width=8>>=
<<phi.sensitivity.density.2014, fig.height=4.5, out.width='4.5in'>>=  
oldpar <- par()
...
\vspace{5pt}
% fig.width=8>>=
<<phi.sensitivity.density.2016, fig.height=4.5, out.width='4.5in'>>=  
oldpar <- par()
par(mar = c(7.1, 3.1, 0, 0))
make.comparison.plot(
  c(list(base.model),
...
\vspace{5pt}
% , fig.width=8>>=
<<semi.sensitivity.biomass, fig.height=4.5, out.width='4.5in'>>=  
oldpar <- par()
par(mar = c(7.1, 4.1, 0, 0))
make.comparison.plot(
  c(list(base.model),
...
\vspace{5pt}
% fig.width=8>>=
<<semi.sensitivity.density.2014, fig.height=4.5, out.width='4.5in'>>=  
oldpar <- par()
par(mar = c(7.1, 3.1, 0, 0))
make.comparison.plot(
  c(list(base.model),
...
\vspace{5pt}
% fig.width=8>>=
<<semi.sensitivity.density.2016, fig.height=4.5, out.width='4.5in'>>=  
oldpar <- par()
par(mar = c(7.1, 3.1, 0, 0))
make.comparison.plot(
  c(list(base.model),
