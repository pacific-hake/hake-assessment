...
\begin{columns}
  \begin{column}{0.38\textwidth}
    \bi
      ...
      \smallskip
      \bc {\bf \Sexpr{fmt0(median(forecasts[[7]]$outputs$ForeCatch_2017))} t} \ec
      \smallskip
      \item 2.5\% and 97.5\% quantiles:\\ \Sexpr{fmt0(quantile(forecasts[[7]]$outputs$ForeCatch_2017, probs = 0.025))} and \Sexpr{fmt0(quantile(forecasts[[7]]$outputs$ForeCatch_2017, probs = 0.975))} t
    \ei
  \end{column}
  \begin{column}{0.59\textwidth}
