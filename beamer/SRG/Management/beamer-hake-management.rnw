...
\frame{\frametitle{Summary of forecasting}
  \bi
    ...
    \item Aging 2010 cohort declining due to fishing and natural mortality contributes to median spawning biomass declining with catch between 350,000~t and 410,000~t and above
