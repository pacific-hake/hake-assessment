...
\begin{columns}
  \begin{column}{0.38\textwidth}
    \bi
      \item Catch stream inbetween 180,000~t and 350,000~t results in stable spawning biomass relative to 2019
...
\frame{\frametitle{Decision Tables}
  \bi
    ...
    \bi
      ...
      \item \textcolor{gray}{d. Constant catch of 410,000 t}
      \item e. Constant catch of 597,500 t (2018 TAC)
