...
%%     make.comparison.plot.mcmc(c(list(base_model), sens.models.5),
%%                               subplots = 2,
...
P$(B_{\Sexpr{assess_yr+1}} < \Bforty)$ &
  ...
  \Sexpr{f( sens.models.2[[1]]$risks[[1]][1,paste0("Bratio_", end_yr + 1, "<0.40")])}\% \\
P$(B_{\Sexpr{assess_yr+2}} < \Bforty)$ &
  \Sexpr{f( base_model$risks[[2]][1, paste0("Bratio_", end_yr + 2, "<0.40")])}\% &
  \Sexpr{f( sens.models.2[[1]]$risks[[2]][1, paste0("Bratio_", end_yr + 2, "<0.40")])}\% \\
...
P$(B_{\Sexpr{assess_yr+1}} < \Bforty)$ &
  ...
  \Sexpr{f( sens.models.2[[1]]$risks[[1]][catch.actual.ind, paste0("Bratio_", end_yr + 1, "<0.40")])}\% \\
P$(B_{\Sexpr{assess_yr+2}} < \Bforty)$ &
  \Sexpr{f( base_model$risks[[2]][4, paste0("Bratio_", end_yr + 2, "<0.40")])}\% &
  \Sexpr{f( sens.models.2[[1]]$risks[[2]][catch.actual.ind, paste0("Bratio_", end_yr + 2, "<0.40")])}\% \\
\hline
\end{tabular}
\end{table}
...
%%       make.comparison.plot(c(list(base_model), list(sens.models.2[[1]])),
%%                      subplots = 2,
...
%% %    make.mcmc.diag.plot(sens.models.6, key_posteriors[2], key_posteriors_titles[2])
%% %    @
%% %   \end{column}
%% % \end{columns}
%% % }
