...
models.inds <- c(1, 2, 3, 5, catch.default.policy.ind)
...
\frame{\frametitle{Forecast methods}
  \bi
    ...
    \bi
      ...
      \item Average weight-at-age from \Sexpr{end.yr-5}--\Sexpr{end.yr-1} used in forecasts
...
\frame{\frametitle{Decision Tables}
  \bi
    ...
    \bi
      ...
      \item \textcolor{gray}{d. Constant catch (\Sexpr{catch_levels[[4]][[2]]})}
  ...
  \begin{column}{0.33\textwidth}
    \bi
      ...
      \item Median (50\%) decreases in \Sexpr{end.yr+1} and \Sexpr{end.yr+2}
        ...
        \bi
        \item Median is above $B_{40\%}$ for all examined 2021 catch levels, but goes below
          $B_{40\%}$ in 2022 in between 410,000~t and 500,000~t
        \ei
    \ei
  \end{column}
  \begin{column}{0.65\textwidth}
    ...
    \bi
      ...
      \bi
        \item Survey and model estimates suggest decline in numbers of age-1 hake in 2019
          relative to 2017
        \item Numbers of age-1 hake caught in the 2019 fishery much lower (1--2\%)
          than what was caught in 2017 and 2018
      \ei
    \ei
  \end{column}
  \begin{column}{0.59\textwidth}
...
\frame{\frametitle{Summary of forecasting}
  \bi
    ...
    \item There is a high (more than 80\%) chance that spawning biomass will decline from 2020 to 2021 at any catch level,
...
\frame{\frametitle{Consideration of age-1 survey}
  \bi
    \item Default harvest rule median catch limit for 2020 is \textbf{666,458~t (base model)} compared to
      \textcolor{red}{797,158~t (age-1 survey model)}
...
\frame{\frametitle{Consideration of adnuts package}
  \bi
    \item Default harvest rule median catch limit for 2020 is \textbf{666,458~t (base model)} compared to
      \textcolor{blue}{682,111~t (adnuts model)}
    \item Forecasts of spawning biomass using 2019 catch levels (410,000~t) result in higher stock levels
...
\begin{columns}
  \begin{column}{0.25\textwidth}
    \bi
      ...
      \item equilibrium recruitment is 2,496 millions of fish
    \ei
  \end{column}
...
\begin{columns}
  \begin{column}{0.25\textwidth}
    \bi
      ...
      \item equilibrium recruitment is 2,304 millions of fish
