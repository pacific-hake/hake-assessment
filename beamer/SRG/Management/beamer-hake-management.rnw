...
\begin{columns}
  \begin{column}{0.38\textwidth}
    \bi
      ...
      \smallskip
      \bc {\bf \Sexpr{f(median(base.model$mcmc[,paste0("ForeCatch_", assess.yr)]))} t} \ec
      \smallskip
      \item 2.5\% and 97.5\% quantiles:\\ \Sexpr{f(quantile(base.model$mcmc[,paste0("ForeCatch_", assess.yr)],probs=0.025))} and \Sexpr{f(quantile(base.model$mcmc[,paste0("ForeCatch_", assess.yr)],probs=0.975))} t
    \ei
  \end{column}
...
\begin{columns}
  ...
  \end{column}
  \begin{column}{0.59\textwidth}
    <<main.projected.catch.density.next.year, out.width='.95\\columnwidth'>>=
