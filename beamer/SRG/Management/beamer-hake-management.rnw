...
\section{Recruitment}
\subsection{}
\frame{\frametitle{Investigating management options \& relationship with recent recruitment}
  \begin{columns}
    \begin{column}{0.48\textwidth}
      \bi
...
\frame{\frametitle{Investigating management options for different options of recent recruitment}
  \bi
    \item 
    \item These are alternative investigations to help understand the outcomes of the base assessment model
    \bi
