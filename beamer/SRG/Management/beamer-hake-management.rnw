...
\frame{\frametitle{Past management: Performance}
  \begin{columns}
    ...
    <<main.phase, fig.height=5, fig.width=8,out.width='1.0\\columnwidth'>>=
      make.phase.plot(base.model, start_yr = start_yr, end_yr = end_yr)
    @
    \ec
    \end{column}
  \end{columns}
...
\begin{columns}
  ...
  \begin{column}{0.65\textwidth}
    <<main.projected.catch.density, out.width='.99\\columnwidth'>>=
      make.forecast.catch.posterior.plot(base.model, fore.yr = end_yr, xmax=3000)
      @
  \end{column}
\end{columns}
}
...
%%             ( Sexpr{round(cor(base.model$mcmc[paste0("ForeCatch_",end_yr)],
...
%%                               subplots = 2,
%%                               model.names = c(paste0("Base model ", end_yr), sens.model.names.5),
%%                               end_yr = end_yr+2,
...
P$(B_{\Sexpr{assess_yr+1}} < \Bforty)$ &
  \Sexpr{f( base.model$risks[[1]][1, paste0("Bratio_", end_yr + 1, "<0.40")])}\% &
  \Sexpr{f( sens.models.2[[1]]$risks[[1]][1,paste0("Bratio_", end_yr + 1, "<0.40")])}\% \\
P$(B_{\Sexpr{assess_yr+2}} < \Bforty)$ &
  \Sexpr{f( base.model$risks[[2]][1, paste0("Bratio_", end_yr + 2, "<0.40")])}\% &
...
P$(B_{\Sexpr{assess_yr+1}} < \Bforty)$ &
  \Sexpr{f( base.model$risks[[1]][catch.actual.ind, paste0("Bratio_", end_yr + 1, "<0.40")])}\% &
  \Sexpr{f( sens.models.2[[1]]$risks[[1]][catch.actual.ind, paste0("Bratio_", end_yr + 1, "<0.40")])}\% \\
P$(B_{\Sexpr{assess_yr+2}} < \Bforty)$ &
  \Sexpr{f( base.model$risks[[2]][4, paste0("Bratio_", end_yr + 2, "<0.40")])}\% &
...
%%                      subplots = 2,
%%                      model.names = c(base_model_name, sens.model.names.2[1]),
%%                      end_yr = end_yr,
%%                      legendloc = "topright")
%%     @
%%   \end{column}
