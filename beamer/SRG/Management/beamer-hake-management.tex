...
\includegraphics[width=0.7\columnwidth]{knitr-cache/main_phase-1} 
...
\begin{columns}
  \begin{column}{0.38\textwidth}
    \bi
    	\item Forecasted 2016 TAC is 804,399 t
      \bi
        \item 2.5\% and 97.5\% quantiles: 282,653 and 1,852,960
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=.95\columnwidth]{knitr-cache/main_projected_catch_density-1} 
