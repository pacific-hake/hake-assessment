...
\frame{\frametitle{Year in review}
  \bi
    ...
    \item U.S. and Canadian fisheries predominantly started in May and April, respectively.
    \item Second-highest coastwide catch ever, 11\% decrease from last year.
    \item A Canadian Joint-Venture fishery operated from August 21 to September 15.
    \item Highest proportion-at-age by sector
      \bi
        \item Age-2 fish in U.S. Catcher-Processor and U.S. Shoreside sectors;
        \item Age-4 fish in U.S. Mothership sectors; and
        \item Age-8 fish in Canadian sectors.
      \ei
    \item Bycatch avoidance was problematic for all sectors.
    \item At the JTC public meeting in Dec. - in general, all stakeholders reported good fishing conditions in \Sexpr{last.assess.yr}.
  ...
  \begin{column}{0.4\linewidth}
    \bi
      ...
      \bi
        ...
        \item Maturity schedule (NWFSC, 2017)
      \ei
    \ei
  \end{column}
...
\frame{\frametitle{Catches}
 \begin{figure}
 \centering
  <<catches, fig.height=4.8, fig.width=8, out.width='0.82\\columnwidth'>>=
...
\begin{figure}
 \centering
 ** More years than the U.S. Figure and not in colour
...
\bi
  \item All Canadian weight-at-age data were re-extracted using the R package \emph{GFPlot}
    developed by Sean Anderson (DFO). This package allows for reproducible, seamless data extraction
    and integration across several groundfish databases which contain Canadian data.
  \item Missing Canadian hake acoustic survey data were added. The following years were added:
    1992, 2005, 2007, 2014, and 2018. This resulted in 5,239 new weights-at-age added.
  \item Previously, there were no Canadian Joint-venture (JV) data included. The new routines
    added 136 weights-at-age for 1990.
...
%    \begin{column}[t]{0.5\linewidth}
      \bi
        ...
        \item Collected 90 testes from bottom trawl and acoustic surveys
        \item Most recent data have yet to be analyzed
      \ei
      \vspace{-3mm}
%    \end{column}
    %\begin{column}[t]{0.5\linewidth}
