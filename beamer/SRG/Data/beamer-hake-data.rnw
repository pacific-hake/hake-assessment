...
%        \item Age-\Sexpr{max.freezer.trawler.age.prop.age} fish in Canadian freezer-trawler sector, and
    ...
    \item Stakeholders reported good fishing in the U.S.A. and relatively few fish in Canada.
...
\Sexpr{last.year.can.landings} t, \Sexpr{paste0(last.year.can.attained, "\\%")} of the Canadian TAC
    ...
    \Sexpr{last.year.us.landings} t, \Sexpr{paste0(last.year.us.attained, "\\%")} of the U.S. TAC
          \bi
            ...
            \item Shore-Based         -- \Sexpr{f(last.year.us.shore.catch)} t, \Sexpr{paste0(last.year.us.shore.catch.percent, "\\%")} of shore-based allocation, includes \Sexpr{round(sum(subset(us.ti.catch.by.month,year == last.assess.yr)$catch), 0)} t of tribal catches
          \ei
    \end{column}
  \end{columns}
}
...
%  \includegraphics[width=\maxwidth, height=3in]{../../../doc/main-figures/hake_survey_1995-21_NASCTimeSeries_BiomassAtAgeHistograms_grayblue}
}
...
%  \includegraphics[height=2.9in]{../../../doc/main-figures/age1hake_03-21_sA_squareroot_bin_narrow-panel_grayblue}
\end{center}
}
...
%)
%@
\includegraphics{../../images/nocanagesfigure-1.eps}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
