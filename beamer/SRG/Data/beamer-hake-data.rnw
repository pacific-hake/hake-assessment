...
\frame{\frametitle{Year in review}
  ...
  @
  \bi
    \item \Sexpr{last.assess_yr} TAC, adjusted for carryovers, was \Sexpr{last.year.tac} t.
    ...
    \item No Canadian Joint-Venture Fishery and no ages from Freezer-Trawlers in \Sexpr{last.assess_yr}.
...
%    \item No new information from the survey in \Sexpr{last.assess_yr}.
...
\begin{columns}[t]
  ...
  \bi
      ...
      \bi
        \item Annual catch (\Sexpr{start_yr}--\Sexpr{end.yr - 1})
        \item Age compositions (1975--\Sexpr{end.yr - 1}; 1$^+$)
      \ei
      \item Acoustic survey (\Sexpr{survey.start_yr}--\Sexpr{survey.end.yr})
      \bi
        \item Biomass index age 2$^+$
        \item Age compositions (2$^+$)
        \item Numbers of age-1 fish
      \ei
      \item Weight-at-age (1975--\Sexpr{end.yr - 1})
...
\Sexpr{last.year.can.landings} t, \Sexpr{paste0(last.year.can.attained, "\\%")} of the Canadian TAC
    ...
    \Sexpr{last.year.us.landings} t, \Sexpr{paste0(last.year.us.attained, "\\%")} of the U.S. TAC
          \bi
            ...
            \item Shore-Based         -- \Sexpr{f(last.year.us.shore.catch)} t, \Sexpr{paste0(last.year.us.shore.catch.percent, "\\%")} of shore-based allocation, includes \Sexpr{f(round(sum(subset(us.ti.catch.by.month,year == last.assess_yr)$catch), 0))} t of tribal catches
          \ei
    \end{column}
  \end{columns}
}
...
\begin{center}
  <<survey.age.comps, out.height='85%', out.width='85%'>>=
    make_age_comp_bubble_plot(base.model,
                              ...
                              subplot = 2,
                              xlim = c(survey.start_yr, survey.end.yr))
  @
\end{center}
}
