...
\bi
  \item No weight-at-age data for the Freezer Trawlers in Canada due to lack of
    scales.
  \item U.S.~data collected prior to 1975 are irrelevant because they were collected from the Puget Sound.
...
%    \begin{column}[t]{0.5\linewidth}
      \bi
        ...
        \item Data from 2018 and 2019 have yet to be analyzed.
      \ei
      \vspace{-3mm}
%    \end{column}
    %\begin{column}[t]{0.5\linewidth}
