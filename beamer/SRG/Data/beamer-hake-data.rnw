      ...
      \bi
        \item Total U.S. catch -- \Sexpr{last.year.us.landings} t
          \bi
            ...
            \item Tribal (included in shore-based) -- 133 t
          \ei
...
\bi
  \item No weight-at-age data for Canadian Freezer-Trawler sector because scales are not available.
  \item Pre-1975 U.S.~weight-at-age data are not included because they were collected from the Puget Sound.
  \item Updates
    \begin{itemize}
      \item Pulled best information from Canadian databases rather than just pulling new information; **summarize briefly what this means as far as numbers**.
