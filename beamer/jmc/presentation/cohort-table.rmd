...
table_cohort_by_country(
  ...
  caption = paste0("The biomass by country was calculated by taking the ",
                   "survey biomass by country from Table 13 and the biomass-",
                   "at-age from Table 18 and multiplying. Some values are ",
                   "missing because the survey does not happen every year. ",
                   "The Canada and US biomass, when added together equal the ",
                   "Start biomass."),
  font_size = 9,
  header_font_size = 9,
  longtable = TRUE,
