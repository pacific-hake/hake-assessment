...
fi.inds <- c(1, 2, 4, 5, ct_default_policy_ind)
fi.names <- sapply(base_model$catch_levels, "[[", 2)[fi.inds]
@
...
\begin{columns}
  \begin{column}{0.4\textwidth}
      ...
      \bi
        ...
        \item Sum of unilateral TACs = \Sexpr{last_yr_tac} t
      \ei
...
\frame{\frametitle{Decision tables}
  \bi
    ...
    \bi
      ...
      \item b, c, d, g, i, k: Constant catches of \Sexpr{ct_levels[[2]][[2]]},
        \Sexpr{ct_levels[[3]][[2]]},
        \Sexpr{ct_levels[[4]][[2]]},
        \Sexpr{ct_levels[[7]][[2]]},
        \Sexpr{ct_levels[[9]][[2]]}, and
        \Sexpr{ct_levels[[11]][[2]]}.
      \item f. Constant catch of \Sexpr{ct_levels[[6]][[2]]},
      \item l. Constant catch of \Sexpr{ct_levels[[12]][[2]]},
      \item e, h, j: Annual reductions of 10\% from:
        \Sexpr{f(ct_levels[[5]][[1]][1])}~t,
        \Sexpr{f(ct_levels[[8]][[1]][1])}~t, and
        \Sexpr{f(ct_levels[[10]][[1]][1])}~t.
...
\begin{columns}
  \begin{column}{0.35\textwidth}
    ...
    \bi
    \item \Sexpr{fore_catch_prop$Age6}\% age-6 fish, \Sexpr{forecast_yrs[1] - 6} cohort,
    \item \Sexpr{fore_catch_prop$Age2}\% age-2 fish, \Sexpr{forecast_yrs[1] - 2} cohort,
    \item \Sexpr{fore_catch_prop$Age8}\% age-8 fish, \Sexpr{forecast_yrs[1] - 8} cohort,
    \item \Sexpr{fore_catch_prop$Age5}\% age-5 fish, \Sexpr{forecast_yrs[1] - 5} cohort,
    % \Sexpr{fore_catch_prop$Age4}\% age-4 fish from the \Sexpr{forecast_yrs[1] - 4} cohort,
    % \Sexpr{fore_catch_prop$Age7}\% age-7 fish from the \Sexpr{forecast_yrs[1] - 7} cohort
    \item \Sexpr{fore_catch_prop$Age12}\% age-12 fish from the huge \Sexpr{forecast_yrs[1] - 12} cohort
...
\frame{\frametitle{Key metrics}
  \bi
    ...
    \item Based on the default harvest rule, the estimated median catch limit for \Sexpr{min(forecast_yrs)} is \Sexpr{ct_limit_quantiles["median"]}~t (with 95\% interval from \Sexpr{ct_limit_quantiles["lower"]} to \Sexpr{ct_limit_quantiles["upper"]}~t).
