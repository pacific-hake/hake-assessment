    ...
    \begin{column}{0.5\textwidth}
      \bi
        ...
        \item Includes an average of
          ...
          \Sexpr{start.yr}--\Sexpr{start.yr.age.comps - 1} and forecast years
          \Sexpr{forecast_yrs[1]}--\Sexpr{forecast_yrs[length(forecast_yrs)]}.
      \ei
  \vspace{5pt}
    \end{column}
    \begin{column}{0.5\textwidth}
...
%   \begin{column}{0.38\textwidth}
%     \bi
%       \item Catch streams less than 350,000~t results in increasing spawning biomass relative to 2019.
%       \item Catch streams 350,000~t and above result in decreasing spawning biomass relative to 2019.
...
%       \item Median decreases in \Sexpr{end.yr+1} and \Sexpr{end.yr+2} for catches above 350,000~t
...
%     \item There is a 50\% chance that spawning biomass will decline from 2019 to
%       2020 at a catch level between 180,000~t and 350,000~t (around 280,000~t),
%       partly due to mortality on ageing 2010 cohort (Figure j)
%     \item Maintaining a constant catch of 597,500~t (i.e., 2017 and 2018 TAC) results
%     in a higher risk of falling below $B_{40\%}$ in 2 years time than predicted in
%     last year's assessment (40\% compared to 36\%) (Table j)
%   \ei
% }
%
%
