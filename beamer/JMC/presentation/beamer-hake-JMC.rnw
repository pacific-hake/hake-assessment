...
\bc
<<compare.3.yr.models.biomass, fig.height=3.5, fig.width=7, out.width='0.9\\columnwidth'>>=
  ...
  make.comparison.plot(c(list(base.model), list(last.yr.base.model), list(model_2019)),
                     subplots = 2,
