...
\begin{frame}
  ...
  \bi
    ...
    \bi
      ...
      \item 2018, 2019, and 2020 cohort estimated to be below average
...
\frame{\frametitle{Probability table definitions}
  ...
  \bi
    ...
    \item P(relative FI > 100\% target): Probability that relative fishing intensity in the catch
      year is greater than the $\Fforty$ fishing intensity rate
  \ei
}
