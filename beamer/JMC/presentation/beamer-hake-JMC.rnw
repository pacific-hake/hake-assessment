...
\begin{columns}
  \begin{column}{0.3\textwidth}
    \bi
      ...
      \item \alert<1>{2021 biomass only once}
      \item \alert<2>{Consequence of a catch shown on same row}
      \item \alert<3>{To show three years requires \emph{three} years of projections}
      \item \alert<4>{Less cluttered -- removal of \% signs and 25\% and 75\% quantiles}
    \ei
  \end{column}
...
\begin{tabularx}{\textwidth}{|ccc|cYYY|}
  % had to take out "Resulting" before "Relative spanwing biomass" to fit on slide
   ...
   Catch year & Catch (t) & \alert<1>{Start 2021} & \alert<1>{0.27} & \alert<1>{0.58} & \alert<1>{1.20} \\  \hline  a: & 2021 &       0 & Start 2022 & 0.28 & 0.58 & 1.23 \\
   & 2022 &       0 & Start 2023 & 0.29 & 0.61 & 1.46 \\
   & 2023 &       0 & Start 2024 & 0.33 & 0.69 & 1.67 \\
    \hline b: & \alert<2>{2021} & \alert<2>{180,000} & \alert<2>{Start 2022} & \alert<2>{0.24} & \alert<2>{0.53} & \alert<2>{1.17} \\
