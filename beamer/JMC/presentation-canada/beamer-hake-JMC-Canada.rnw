...
\begin{frame}
  ...
  \bi
    ...
    \item 2016 cohort estimated to be large but not as large as the 2014 cohort.
...
%----------------------------------------------------------
\frame{\frametitle{Risk based on fixed \Sexpr{end.yr + 1} and \Sexpr{end.yr + 2} catch}
