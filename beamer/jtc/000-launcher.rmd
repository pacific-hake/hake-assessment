...
date: "JTC meeting -- December `r rmarkdown::metadata$project_variables$assess_yr - 1`"
output:
  hake_beamer:
    theme: Singapore
    slide_level: 2
