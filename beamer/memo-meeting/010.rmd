...
Response Andy: *This comment arises from Figure 63 showing summaries of
historical assessment estimates of spawning biomass (presumably????TODO).*

- *Note that historical estimates shown ignore uncertainty. Numbers below are medians*

- *2010-2011 (presumably???TODO): the subsequent assessments greatly reduce the absolute size of the
  stock, but still show an increase, likely due to the change in model used
  in 2012. Would have to go back to 2012 assessment to understand why.*
...
- *2022-2023 (presumably???TODO) increase from each assessment is:*
  - 2023 base model: increase of 486,000 t
  - 2024 base model: increase of 549,000 t

So the increases are actually larger in subsequent assessments, not smaller.
...
data presented at SRG meeting when time).*
