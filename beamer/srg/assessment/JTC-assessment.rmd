...
library(here)
res <- knitr::knit_child(here("doc/001-load-packages.rmd"))
cat(res, sep = "\n")
res <- knitr::knit_child(here("doc/002-load-globals.rmd"))
cat(res, sep = "\n")
res <- knitr::knit_child(here("doc/003-load-models.rmd"))
cat(res, sep = "\n")
res <- knitr::knit_child(here("doc/004-load-project-variables.rmd"))
cat(res, sep = "\n")
