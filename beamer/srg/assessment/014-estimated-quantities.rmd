...
table_yearly_model_compare(last_yr_base_model,
                           ...
                           font_size = 10)
```
* While the median estimate of *B*~`r assess_yr` has decreased from last
  year's assessment, partly due to the 2023 survey biomass and time-varying
  fecundity delaying maturity in recent years
* The credible interval overlaps that from last year's assessment
