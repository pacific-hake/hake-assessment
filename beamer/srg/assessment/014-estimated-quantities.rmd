...
* **Prior** for natural mortality looks to be
  influencing \textcolor{red}{median} of \textcolor{blue}{posterior}
...
cohorts <- sort(c(large_cohorts, 2017, 2021))
...
::: {.column width="60%"}
```{r main-numbers-at-age, fig.height = 4, out.height = "75%"}
...
```{r survey-pearson-test, fig.height = 4, fig.width = 6, out.height = "65%"}
plot_pearson_bubbles(base_model,
                     type = "survey",
                     alpha = 0.7)
```
While the median estimate of B2022 has increased from last year's assessment, partly due
to increases in weight-at-age, the credible interval mostly overlaps that from last
year's assessment.
...
## Fishing Intensity
```{r main-fish-inten, fig.height = 4, out.height = "80%"}
