...
Synthesis because estimates of
...
Future work should include estimation properties of age-based $M$ deviations along with
time-varying selectivity and recruitment deviations to better understand interactions and
estimation tradoffs.
...
time-variation into stock assessment models, including the estimation of $\sigma_R$.
...
to reduce to 2-year forecasts (instead of the current 3-year).
