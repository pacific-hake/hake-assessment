...
# Right
plot_rel_biomass(list(model_age_8),
                 ylim = c(0, 2.5),
                 alpha = 0.2,
                 leg_pos = "none") |>
  suppressWarnings()
...
# Left
plot_biomass(list(model_age_10),
             ylim = c(0, 5),
             point_shape = ts_single_model_pointshape,
             leg_pos = "none")
```
...
# Right
plot_rel_biomass(list(model_age_10),
                 ylim = c(0, 2.5),
                 alpha = 0.2,
                 leg_pos = "none") |>
  suppressWarnings()
...
# Left
plot_biomass(list(model_age_12),
             ylim = c(0, 5),
             point_shape = ts_single_model_pointshape,
             leg_pos = "none")
```
...
# Right
plot_rel_biomass(list(model_age_12),
                 ylim = c(0, 2.5),
                 alpha = 0.2,
                 leg_pos = "none") |>
  suppressWarnings()
...
plot_recdevs(list(model_age_10),
             line_color = ts_single_line_color,
             leg_pos = "none")
```
...
plot_recdevs(list(model_age_12),
             line_color = ts_single_line_color,
             leg_pos = "none")
```
