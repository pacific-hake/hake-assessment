...
models.inds <- c(1, 2, 6, 12, ct_default_policy_ind)
models.names <- sapply(base_model$catch_levels, "[[", 2)[models.inds] # pretty catch level name
@
...
plot_management_catch_vs_tac(catch_targets_df, connect_vars = TRUE,
                             ...
                             leg_pos = c(0.12, 0.87),
                             leg_font_size = 10)
def_med_hr_tac <- filter(catch_targets_df,
...
\begin{columns}
  \begin{column}{0.45\textwidth}
      ...
      \bi
        ...
        \item Sum of unilateral TACs is \Sexpr{last_yr_tac}~t
      \ei
  ...
  \begin{columns}
    \begin{column}{0.25\textwidth}
      \bi
        ...
        \item Joint probability of both is \Sexpr{joint_percent_prob_above_below}\%
...
\begin{columns}
  \begin{column}{0.38\textwidth}
    \bi
      ...
      \smallskip
      \item 2.5\% and 97.5\% quantiles:\\ \Sexpr{ct_limit_quantiles["lower"]} and \Sexpr{ct_limit_quantiles["upper"]}~t
    \ei
  \end{column}
...
\begin{columns}
  \begin{column}{0.35\textwidth}
    ...
    \bi
    \item \Sexpr{fore_catch_prop$Age13}\% age-13 fish, \Sexpr{forecast_yrs[1] - 13} cohort
    \item \Sexpr{fore_catch_prop$Age9}\% age-9 fish, \Sexpr{forecast_yrs[1] - 9} cohort
    \item \Sexpr{fore_catch_prop$Age8}\% age-8 fish, \Sexpr{forecast_yrs[1] - 8} cohort
    \item \Sexpr{fore_catch_prop$Age7}\% age-7 fish, \Sexpr{forecast_yrs[1] - 7} cohort
    ...
    \item \Sexpr{fore_catch_prop$Age4}\% age-4 fish, \Sexpr{forecast_yrs[1] - 4} cohort
    \item \Sexpr{fore_catch_prop$Age3}\% age-3 fish, \Sexpr{forecast_yrs[1] - 3} cohort
...
\frame{\frametitle{Decision Tables}
  \bi
    ...
    \bi
      ...
      \item f. Constant catch equal to \Sexpr{ct_levels[[6]][[2]]},
      \item l. Constant catch equal to \Sexpr{ct_levels[[12]][[2]]},
      \item e, h, j: Annual reductions of 10\% from:
        \Sexpr{f(ct_levels[[5]][[1]][1])}~t,
        \Sexpr{f(ct_levels[[8]][[1]][1])}~t, and
        \Sexpr{f(ct_levels[[10]][[1]][1])}~t.
%      \item \textcolor{gray}{c. Constant catch of \Sexpr{ct_levels[[3]][[2]]}}
%      \item d. Constant catch (\Sexpr{ct_levels[[4]][[2]]})
%      \item e. Constant catch (\Sexpr{ct_levels[[5]][[2]]})
%      \item \textcolor{gray}{f. Constant catch (\Sexpr{ct_levels[[6]][[2]]})}
%      \item \textcolor{gray}{m. Constant catch (\Sexpr{ct_levels[[7]][[2]]})}
