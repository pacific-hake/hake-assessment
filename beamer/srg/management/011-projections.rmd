...
:::::: {.columns}
::: {.column width="38%"}
- No fishing results in a 1-year increase in biomass followed by a flat
  relative spawning biomass from `r end_yr + 1` to `r end_yr + 3`

- Positive catch options less than 350,000 t result in a 1-year increase
  in biomass followed by continuous decline through to start of 2027
