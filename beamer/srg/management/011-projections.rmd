...
::: {.column width="62%"}
```{r main-projected-catch-density, out.height = "75%"}
...
::: {.column width="62%"}
```{r main-forecast-depletion-comparison-plot, out.height = "75%"}
...
* `r fore_catch_prop$Age13`% age-13 fish, `r forecast_yrs[1] - 13` cohort
* `r fore_catch_prop$Age9`% age-9 fish, `r forecast_yrs[1] - 9` cohort
* `r fore_catch_prop$Age8`% age-8 fish, `r forecast_yrs[1] - 8` cohort
* `r fore_catch_prop$Age7`% age-7 fish, `r forecast_yrs[1] - 7` cohort
* `r fore_catch_prop$Age6`% age-6 fish, `r forecast_yrs[1] - 6` cohort
* `r fore_catch_prop$Age5`% age-5 fish, `r forecast_yrs[1] - 5` cohort
* `r fore_catch_prop$Age4`% age-4 fish, `r forecast_yrs[1] - 4` cohort
* `r fore_catch_prop$Age3`% age-3 fish, `r forecast_yrs[1] - 3` cohort
* `r fore_catch_prop$Age2`% age-2 fish, `r forecast_yrs[1] - 2` cohort
:::

::: {.column width="62%"}
```{r main-age-comp-forecast, fig.height = 3.5, fig.width = 5.5}
