...
```{r tac-vs-realized-catch-ts, fig.height = 3.5, fig.width = 7.5, out.height = "75%"}
...
::: {.column width="55%"}
```{r tac-vs-realized-catch, fig.height = 3.5, fig.width = 7.5, out.height = "60%"}
