...
:::::: {.columns}
::: {.column width="25%"}
* P(B_`r assess_yr`_ / B_0_ < 0.4) = `r probs_curr_below_b40`$
...
::: {.column width="75%"}
```{r main-phase, fig.height = 5, fig.width = 8,out.width = "1.0\\columnwidth"}
