...
## Maturity-at-age GLMM
### Model
* $P(mature) \sim temperature + temperature^2 + GMRF() + GMRF(age) + GMRF(age^2)$
...
* Temperature-based model predicted lower maturity than the model without
  temperature in 2016.
...
* Getting temperature data for current year was not doable.
